...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Entity,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Control, id_mysql >::controlled_tag>::
  table_name[] = "`controlled_Entity`";

  struct access::object_traits_impl< ::UniPAX::Control, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< controller_traits > controller;
  ...
  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::controller_traits::
  select_statement[] =
  "SELECT "
  "`Control_controller`.`index`, "
  "`Control_controller`.`value` "
  "FROM `Control_controller` "
  "WHERE `Control_controller`.`object_id`=? ORDER BY `Control_controller`.`index`";

  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::controller_traits::
  insert_statement[] =
  "INSERT INTO `Control_controller` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::controller_traits::
  delete_statement[] =
  "DELETE FROM `Control_controller` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Control, id_mysql >::controller_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Control, id_mysql >::controller_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::Control, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.controlType_value.capacity (i.controlType_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::Control, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.controlType_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.controlType_value.capacity ());
    b[n].length = &i.controlType_size;
    b[n].is_null = &i.controlType_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.controlled_value;
    b[n].is_null = &i.controlled_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.controlType_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.controlType_null = is_null;
      i.controlType_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.controlType_value.capacity ());
    }

    // controlled
    //
    {
      ::boost::shared_ptr< ::UniPAX::Entity > const& v =
        o.controlled;

      typedef object_traits< ::UniPAX::Entity > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::Entity > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
            obj_traits::id_type,
            mysql::id_ulonglong >::set_image (
          i.controlled_value, is_null, id);
        i.controlled_null = is_null;
      }
      else
        i.controlled_null = 1;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::Entity >& v =
        o.controlled;

      typedef object_traits< ::UniPAX::Entity > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::Entity > > ptr_traits;

      if (i.controlled_null)
        v = ptr_traits::pointer_type ();
      else
      {
        obj_traits::id_type id;
  ...
  const access::object_traits_impl< ::UniPAX::Control, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Control, id_mysql >::info (
    typeid (::UniPAX::Control),
    &object_traits_impl< ::UniPAX::Interaction, id_mysql >::info,
    0,
    "UniPAX::Control",
    &odb::create_impl< ::UniPAX::Control >,
    &odb::dispatch_impl< ::UniPAX::Control, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Control, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Control;

  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::persist_statement[] =
  "INSERT INTO `Control` "
  "(`unipaxId`, "
  "`controlType`, "
  "`controlled`) "
  ...
  const char* const access::object_traits_impl< ::UniPAX::Control, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Control`.`controlType`, "
    "`Control`.`controlled`, "
    ...
    "`Entity`.`dataSource` "
    "FROM `Control` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Control`.`unipaxId` "
    "WHERE `Control`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Control, id_mysql >::find_column_counts[] =
  {
    10UL,
    2UL,
    2UL
  ...
  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::update_statement[] =
  "UPDATE `Control` "
  "SET "
  "`controlType`=?, "
  "`controlled`=? "
  ...
  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::erase_statement[] =
  "DELETE FROM `Control` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Control`.`controlType`,\n"
  "`Control`.`controlled`,\n"
  "`Entity`.`unipaxId`,\n"
  ...
  "`Entity`.`dataSource`\n"
  "FROM `Control`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`Control`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Control`.`unipaxId`\n"
  "LEFT JOIN `Entity` AS `controlled_Entity` ON `controlled_Entity`.`unipaxId`=`Control`.`controlled`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Control`";

  const char access::object_traits_impl< ::UniPAX::Control, id_mysql >::table_name[] =
  "`Control`";
  ...
  access::object_traits_impl< ::UniPAX::Control, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Control, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Control, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Control, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Control, id_mysql >::
