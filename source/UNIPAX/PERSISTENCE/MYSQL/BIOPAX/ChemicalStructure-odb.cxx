...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`ChemicalStructure_comment`.`index`, "
  "`ChemicalStructure_comment`.`value` "
  "FROM `ChemicalStructure_comment` "
  "WHERE `ChemicalStructure_comment`.`object_id`=? ORDER BY `ChemicalStructure_comment`.`index`";
  ...
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ...
    if (t[3UL])
    {
      i.structureData_value.capacity (i.structureData_size);
      grew = true;
    }
    ...
    if (t[4UL])
    {
      i.structureFormat_value.capacity (i.structureFormat_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.structureData_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.structureData_value.capacity ());
    b[n].length = &i.structureData_size;
    b[n].is_null = &i.structureData_null;
    n++;

    // structureFormat
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.structureFormat_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.structureFormat_value.capacity ());
    b[n].length = &i.structureFormat_size;
    b[n].is_null = &i.structureFormat_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.structureData_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        ...
        is_null,
        v);
      i.structureData_null = is_null;
      i.structureData_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.structureData_value.capacity ());
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.structureFormat_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        ...
        is_null,
        v);
      i.structureFormat_null = is_null;
      i.structureFormat_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.structureFormat_value.capacity ());
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.structureFormat_null);
    }
  }

  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::info (
    typeid (::UniPAX::ChemicalStructure),
    0,
    0,
    "UniPAX::ChemicalStructure",
    &odb::create_impl< ::UniPAX::ChemicalStructure >,
    &odb::dispatch_impl< ::UniPAX::ChemicalStructure, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_ChemicalStructure;

  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::find_statement[] =
  "SELECT "
  "`ChemicalStructure`.`unipaxId`, "
  "`ChemicalStructure`.`unipaxSource`, "
  "`ChemicalStructure`.`typeid`, "
  "`ChemicalStructure`.`structureData`, "
  "`ChemicalStructure`.`structureFormat` "
  "FROM `ChemicalStructure` "
  "WHERE `ChemicalStructure`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::update_statement[] =
  "UPDATE `ChemicalStructure` "
  "SET "
  "`unipaxSource`=?, "
  "`structureData`=?, "
  "`structureFormat`=? "
  ...
  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::erase_statement[] =
  "DELETE FROM `ChemicalStructure` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ChemicalStructure`.`unipaxId`,\n"
  "`ChemicalStructure`.`unipaxSource`,\n"
  "`ChemicalStructure`.`typeid`,\n"
  ...
  "`ChemicalStructure`.`structureFormat`\n"
  "FROM `ChemicalStructure`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`ChemicalStructure`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::erase_query_statement[] =
  "DELETE FROM `ChemicalStructure`";

  const char access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::table_name[] =
  "`ChemicalStructure`";
  ...
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >::
