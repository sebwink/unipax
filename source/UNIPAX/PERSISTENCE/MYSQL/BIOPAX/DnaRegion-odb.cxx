...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entityReference_traits::
  select_statement[] =
  "SELECT "
  "`DnaRegion_entityReference`.`index`, "
  "`DnaRegion_entityReference`.`value` "
  "FROM `DnaRegion_entityReference` "
  "WHERE `DnaRegion_entityReference`.`object_id`=? ORDER BY `DnaRegion_entityReference`.`index`";

  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entityReference_traits::
  insert_statement[] =
  "INSERT INTO `DnaRegion_entityReference` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entityReference_traits::
  delete_statement[] =
  "DELETE FROM `DnaRegion_entityReference` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entityReference_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entityReference_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::info (
    typeid (::UniPAX::DnaRegion),
    &object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >::info,
    0,
    "UniPAX::DnaRegion",
    &odb::create_impl< ::UniPAX::DnaRegion >,
    &odb::dispatch_impl< ::UniPAX::DnaRegion, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_DnaRegion;

  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::persist_statement[] =
  "INSERT INTO `DnaRegion` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `DnaRegion` "
    "LEFT JOIN `PhysicalEntity` ON `PhysicalEntity`.`unipaxId`=`DnaRegion`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`DnaRegion`.`unipaxId` "
    "WHERE `DnaRegion`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::erase_statement[] =
  "DELETE FROM `DnaRegion` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhysicalEntity`.`cellularLocation`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::erase_query_statement[] =
  "DELETE FROM `DnaRegion`";

  const char access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::table_name[] =
  "`DnaRegion`";
  ...
  access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::DnaRegion, id_mysql >::
