...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Entity,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::physicalEntity_tag>::
  table_name[] = "`physicalEntity_Entity`";

  const char alias_traits<  ::UniPAX::PhysicalEntity,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::physicalEntity_tag>::
  table_name[] = "`physicalEntity_PhysicalEntity`";

  struct access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`Stoichiometry_comment`.`index`, "
  "`Stoichiometry_comment`.`value` "
  "FROM `Stoichiometry_comment` "
  "WHERE `Stoichiometry_comment`.`object_id`=? ORDER BY `Stoichiometry_comment`.`index`";
  ...
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.stoichiometricCoefficient_null;
    n++;
    ...
    b[n].is_unsigned = 1;
    b[n].buffer = &i.physicalEntity_value;
    b[n].is_null = &i.physicalEntity_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.stoichiometricCoefficient_value, is_null, v);
      i.stoichiometricCoefficient_null = is_null;
    }
    ...
    //
    {
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
          ...
          i.physicalEntity_value, is_null, id);
        i.physicalEntity_null = is_null;
      }
      else
        i.physicalEntity_null = 1;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.stoichiometricCoefficient_null);
    }
    ...
    //
    {
      ...
      else
      {
        ...
        mysql::value_traits<
          ...
          id,
          i.physicalEntity_value,
          i.physicalEntity_null);
  ...
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::info (
    typeid (::UniPAX::Stoichiometry),
    0,
    0,
    "UniPAX::Stoichiometry",
    &odb::create_impl< ::UniPAX::Stoichiometry >,
    &odb::dispatch_impl< ::UniPAX::Stoichiometry, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Stoichiometry;

  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::find_statement[] =
  "SELECT "
  "`Stoichiometry`.`unipaxId`, "
  "`Stoichiometry`.`unipaxSource`, "
  "`Stoichiometry`.`typeid`, "
  "`Stoichiometry`.`stoichiometricCoefficient`, "
  "`Stoichiometry`.`physicalEntity` "
  "FROM `Stoichiometry` "
  "WHERE `Stoichiometry`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::erase_statement[] =
  "DELETE FROM `Stoichiometry` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Stoichiometry`.`unipaxId`,\n"
  "`Stoichiometry`.`unipaxSource`,\n"
  "`Stoichiometry`.`typeid`,\n"
  ...
  "`Stoichiometry`.`physicalEntity`\n"
  "FROM `Stoichiometry`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Stoichiometry`.`unipaxSource`\n"
  "LEFT JOIN `PhysicalEntity` AS `physicalEntity_PhysicalEntity` ON `physicalEntity_PhysicalEntity`.`unipaxId`=`Stoichiometry`.`physicalEntity`\n"
  "LEFT JOIN `Entity` AS `physicalEntity_Entity` ON `physicalEntity_Entity`.`unipaxId`=`physicalEntity_PhysicalEntity`.`unipaxId`";

  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Stoichiometry`";

  const char access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::table_name[] =
  "`Stoichiometry`";
  ...
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::
