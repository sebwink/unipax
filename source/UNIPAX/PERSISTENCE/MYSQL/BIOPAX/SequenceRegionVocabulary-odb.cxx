...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::info (
    typeid (::UniPAX::SequenceRegionVocabulary),
    &object_traits_impl< ::UniPAX::ControlledVocabulary, id_mysql >::info,
    0,
    "UniPAX::SequenceRegionVocabulary",
    &odb::create_impl< ::UniPAX::SequenceRegionVocabulary >,
    &odb::dispatch_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_SequenceRegionVocabulary;

  const char access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::persist_statement[] =
  "INSERT INTO `SequenceRegionVocabulary` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `ControlledVocabulary` ON `ControlledVocabulary`.`unipaxId`=`SequenceRegionVocabulary`.`unipaxId` "
    "WHERE `SequenceRegionVocabulary`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::find_column_counts[] =
  {
    4UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::erase_statement[] =
  "DELETE FROM `SequenceRegionVocabulary` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ControlledVocabulary`.`unipaxId`,\n"
  "`ControlledVocabulary`.`unipaxSource`,\n"
  "`ControlledVocabulary`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::erase_query_statement[] =
  "DELETE FROM `SequenceRegionVocabulary`";

  const char access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::table_name[] =
  "`SequenceRegionVocabulary`";
  ...
  access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >::
