...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Protein, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entityReference_traits::
  select_statement[] =
  "SELECT "
  "`Protein_entityReference`.`index`, "
  "`Protein_entityReference`.`value` "
  "FROM `Protein_entityReference` "
  "WHERE `Protein_entityReference`.`object_id`=? ORDER BY `Protein_entityReference`.`index`";

  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entityReference_traits::
  insert_statement[] =
  "INSERT INTO `Protein_entityReference` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entityReference_traits::
  delete_statement[] =
  "DELETE FROM `Protein_entityReference` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entityReference_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entityReference_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::Protein, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Protein, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::Protein, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Protein, id_mysql >::info (
    typeid (::UniPAX::Protein),
    &object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >::info,
    0,
    "UniPAX::Protein",
    &odb::create_impl< ::UniPAX::Protein >,
    &odb::dispatch_impl< ::UniPAX::Protein, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Protein, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Protein;

  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::persist_statement[] =
  "INSERT INTO `Protein` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Protein, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `Protein` "
    "LEFT JOIN `PhysicalEntity` ON `PhysicalEntity`.`unipaxId`=`Protein`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Protein`.`unipaxId` "
    "WHERE `Protein`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Protein, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::erase_statement[] =
  "DELETE FROM `Protein` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhysicalEntity`.`cellularLocation`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Protein`";

  const char access::object_traits_impl< ::UniPAX::Protein, id_mysql >::table_name[] =
  "`Protein`";
  ...
  access::object_traits_impl< ::UniPAX::Protein, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Protein, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Protein, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Protein, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Protein, id_mysql >::
