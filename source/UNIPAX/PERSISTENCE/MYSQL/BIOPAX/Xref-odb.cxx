...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Xref, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`Xref_comment`.`index`, "
  "`Xref_comment`.`value` "
  "FROM `Xref_comment` "
  "WHERE `Xref_comment`.`object_id`=? ORDER BY `Xref_comment`.`index`";
  ...
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ...
    if (t[3UL])
    {
      i.idVersion_value.capacity (i.idVersion_size);
      grew = true;
    }
    ...
    if (t[5UL])
    {
      i.dbVersion_value.capacity (i.dbVersion_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.idVersion_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.idVersion_value.capacity ());
    b[n].length = &i.idVersion_size;
    b[n].is_null = &i.idVersion_null;
    n++;
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.dbVersion_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.dbVersion_value.capacity ());
    b[n].length = &i.dbVersion_size;
    b[n].is_null = &i.dbVersion_null;
    n++;

    // db
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.db_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.db_value.capacity ());
    b[n].length = &i.db_size;
    b[n].is_null = &i.db_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.idVersion_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.idVersion_value,
        ...
        is_null,
        v);
      i.idVersion_null = is_null;
      i.idVersion_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.idVersion_value.capacity ());
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.dbVersion_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.dbVersion_value,
        ...
        is_null,
        v);
      i.dbVersion_null = is_null;
      i.dbVersion_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.dbVersion_value.capacity ());
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.db_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.db_value,
        ...
        v);
      i.db_null = is_null;
      i.db_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.db_value.capacity ());
    }
  ...
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Xref, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::info (
    typeid (::UniPAX::Xref),
    0,
    0,
    "UniPAX::Xref",
    &odb::create_impl< ::UniPAX::Xref >,
    &odb::dispatch_impl< ::UniPAX::Xref, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Xref, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Xref;

  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::persist_statement[] =
  "INSERT INTO `Xref` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`typeid`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::find_statement[] =
  "SELECT "
  "`Xref`.`unipaxId`, "
  "`Xref`.`unipaxSource`, "
  "`Xref`.`typeid`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::update_statement[] =
  "UPDATE `Xref` "
  "SET "
  "`unipaxSource`=?, "
  "`idVersion`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::erase_statement[] =
  "DELETE FROM `Xref` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Xref`.`unipaxId`,\n"
  "`Xref`.`unipaxSource`,\n"
  "`Xref`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Xref`";

  const char access::object_traits_impl< ::UniPAX::Xref, id_mysql >::table_name[] =
  "`Xref`";
  ...
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Xref, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Xref, id_mysql >::
