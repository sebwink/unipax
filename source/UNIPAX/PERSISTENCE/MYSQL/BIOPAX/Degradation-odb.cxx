...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::info (
    typeid (::UniPAX::Degradation),
    &object_traits_impl< ::UniPAX::Conversion, id_mysql >::info,
    0,
    "UniPAX::Degradation",
    &odb::create_impl< ::UniPAX::Degradation >,
    &odb::dispatch_impl< ::UniPAX::Degradation, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Degradation;

  const char access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::persist_statement[] =
  "INSERT INTO `Degradation` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `Degradation` "
    "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`Degradation`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Degradation`.`unipaxId` "
    "WHERE `Degradation`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::find_column_counts[] =
  {
    11UL,
    3UL,
    3UL,
  ...
  const char access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::erase_statement[] =
  "DELETE FROM `Degradation` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Conversion`.`conversionDirection`,\n"
  "`Conversion`.`spontaneous`,\n"
  "`Conversion`.`kineticLaw`,\n"
  ...
  "FROM `Degradation`\n"
  "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`Degradation`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`Degradation`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Degradation`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Degradation`";

  const char access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::table_name[] =
  "`Degradation`";
  ...
  access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Degradation, id_mysql >::
