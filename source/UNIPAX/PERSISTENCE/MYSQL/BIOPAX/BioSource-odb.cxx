...
namespace odb
{
  ...
  table_name[] = "`tissue_ControlledVocabulary`";

  const char alias_traits<  ::UniPAX::TissueVocabulary,
    id_mysql,
    access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::tissue_tag>::
  table_name[] = "`tissue_TissueVocabulary`";

  struct access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< comment_traits > comment;
    mysql::container_statements_impl< cellType_traits > cellType;
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`BioSource_comment`.`index`, "
  "`BioSource_comment`.`value` "
  "FROM `BioSource_comment` "
  "WHERE `BioSource_comment`.`object_id`=? ORDER BY `BioSource_comment`.`index`";
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::cellType_traits::
  select_statement[] =
  "SELECT "
  "`BioSource_cellType`.`index`, "
  "`BioSource_cellType`.`value` "
  "FROM `BioSource_cellType` "
  "WHERE `BioSource_cellType`.`object_id`=? ORDER BY `BioSource_cellType`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::cellType_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::cellType_traits::
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::xref_traits::
  select_statement[] =
  "SELECT "
  "`BioSource_xref`.`index`, "
  "`BioSource_xref`.`value` "
  "FROM `BioSource_xref` "
  "WHERE `BioSource_xref`.`object_id`=? ORDER BY `BioSource_xref`.`index`";

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::xref_traits::
  insert_statement[] =
  "INSERT INTO `BioSource_xref` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::xref_traits::
  delete_statement[] =
  "DELETE FROM `BioSource_xref` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::xref_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::xref_traits::
  select (index_type& i, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::name_traits::
  select_statement[] =
  "SELECT "
  "`BioSource_name`.`index`, "
  "`BioSource_name`.`value` "
  "FROM `BioSource_name` "
  "WHERE `BioSource_name`.`object_id`=? ORDER BY `BioSource_name`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::name_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::name_traits::
  select (index_type& i, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::TissueVocabulary > const& v =
        o.tissue;

      typedef object_traits< ::UniPAX::TissueVocabulary > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::TissueVocabulary > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
            obj_traits::id_type,
            mysql::id_ulonglong >::set_image (
          i.tissue_value, is_null, id);
        i.tissue_null = is_null;
      }
      else
        i.tissue_null = 1;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::TissueVocabulary >& v =
        o.tissue;
  ...
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::info (
    typeid (::UniPAX::BioSource),
    0,
    0,
    "UniPAX::BioSource",
    &odb::create_impl< ::UniPAX::BioSource >,
    &odb::dispatch_impl< ::UniPAX::BioSource, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_BioSource;

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::find_statement[] =
  "SELECT "
  "`BioSource`.`unipaxId`, "
  ...
  "FROM `BioSource` "
  "WHERE `BioSource`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::update_statement[] =
  "UPDATE `BioSource` "
  "SET "
  "`unipaxSource`=?, "
  "`tissue`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::erase_statement[] =
  "DELETE FROM `BioSource` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::query_statement[] =
  "SELECT\n"
  "`BioSource`.`unipaxId`,\n"
  "`BioSource`.`unipaxSource`,\n"
  "`BioSource`.`typeid`,\n"
  ...
  "`BioSource`.`displayName`\n"
  "FROM `BioSource`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`BioSource`.`unipaxSource`\n"
  "LEFT JOIN `TissueVocabulary` AS `tissue_TissueVocabulary` ON `tissue_TissueVocabulary`.`unipaxId`=`BioSource`.`tissue`\n"
  "LEFT JOIN `ControlledVocabulary` AS `tissue_ControlledVocabulary` ON `tissue_ControlledVocabulary`.`unipaxId`=`tissue_TissueVocabulary`.`unipaxId`";

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::erase_query_statement[] =
  "DELETE FROM `BioSource`";

  const char access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::table_name[] =
  "`BioSource`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::CellVocabulary > > const& v =
        obj.cellType;
  ...
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
         ...
         bool reload)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::CellVocabulary > >& v =
        obj.cellType;
  ...
  result< access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::BioSource, id_mysql >::
