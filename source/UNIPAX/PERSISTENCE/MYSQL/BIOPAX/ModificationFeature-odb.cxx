...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::ControlledVocabulary,
    id_mysql,
    access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::modificationType_tag>::
  ...
  struct access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::info (
    typeid (::UniPAX::ModificationFeature),
    &object_traits_impl< ::UniPAX::EntityFeature, id_mysql >::info,
    0,
    "UniPAX::ModificationFeature",
    &odb::create_impl< ::UniPAX::ModificationFeature >,
    &odb::dispatch_impl< ::UniPAX::ModificationFeature, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_ModificationFeature;

  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`ModificationFeature`.`unipaxId` "
    "WHERE `ModificationFeature`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::find_column_counts[] =
  {
    4UL,
    1UL
  };

  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::update_statement[] =
  "UPDATE `ModificationFeature` "
  "SET "
  "`modificationType`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::erase_statement[] =
  "DELETE FROM `ModificationFeature` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ModificationFeature`.`modificationType`,\n"
  "`EntityFeature`.`unipaxId`,\n"
  "`EntityFeature`.`unipaxSource`,\n"
  ...
  "FROM `ModificationFeature`\n"
  "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`ModificationFeature`.`unipaxId`\n"
  "LEFT JOIN `SequenceModificationVocabulary` AS `modificationType_SequenceModificationVocabulary` ON `modificationType_SequenceModificationVocabulary`.`unipaxId`=`ModificationFeature`.`modificationType`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::erase_query_statement[] =
  "DELETE FROM `ModificationFeature`";

  const char access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::table_name[] =
  "`ModificationFeature`";
  ...
  access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >::
