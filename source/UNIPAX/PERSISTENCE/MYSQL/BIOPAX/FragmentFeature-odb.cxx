...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::info (
    typeid (::UniPAX::FragmentFeature),
    &object_traits_impl< ::UniPAX::EntityFeature, id_mysql >::info,
    0,
    "UniPAX::FragmentFeature",
    &odb::create_impl< ::UniPAX::FragmentFeature >,
    &odb::dispatch_impl< ::UniPAX::FragmentFeature, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_FragmentFeature;

  const char access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::persist_statement[] =
  "INSERT INTO `FragmentFeature` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`FragmentFeature`.`unipaxId` "
    "WHERE `FragmentFeature`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::find_column_counts[] =
  {
    3UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::erase_statement[] =
  "DELETE FROM `FragmentFeature` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::query_statement[] =
  "SELECT\n"
  "`EntityFeature`.`unipaxId`,\n"
  "`EntityFeature`.`unipaxSource`,\n"
  "`EntityFeature`.`typeid`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::erase_query_statement[] =
  "DELETE FROM `FragmentFeature`";

  const char access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::table_name[] =
  "`FragmentFeature`";
  ...
  access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >::
