...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`Provenance_comment`.`index`, "
  "`Provenance_comment`.`value` "
  "FROM `Provenance_comment` "
  "WHERE `Provenance_comment`.`object_id`=? ORDER BY `Provenance_comment`.`index`";
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::xref_traits::
  select_statement[] =
  "SELECT "
  "`Provenance_xref`.`index`, "
  "`Provenance_xref`.`value` "
  "FROM `Provenance_xref` "
  "WHERE `Provenance_xref`.`object_id`=? ORDER BY `Provenance_xref`.`index`";

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::xref_traits::
  insert_statement[] =
  "INSERT INTO `Provenance_xref` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::xref_traits::
  delete_statement[] =
  "DELETE FROM `Provenance_xref` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::xref_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::xref_traits::
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::name_traits::
  select_statement[] =
  "SELECT "
  "`Provenance_name`.`index`, "
  "`Provenance_name`.`value` "
  "FROM `Provenance_name` "
  "WHERE `Provenance_name`.`object_id`=? ORDER BY `Provenance_name`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::name_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::name_traits::
  select (index_type& i, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::discriminator_type
  ...
  bool access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::info (
    typeid (::UniPAX::Provenance),
    0,
    0,
    "UniPAX::Provenance",
    &odb::create_impl< ::UniPAX::Provenance >,
    &odb::dispatch_impl< ::UniPAX::Provenance, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Provenance;

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::find_statement[] =
  "SELECT "
  "`Provenance`.`unipaxId`, "
  ...
  "FROM `Provenance` "
  "WHERE `Provenance`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::update_statement[] =
  "UPDATE `Provenance` "
  "SET "
  "`unipaxSource`=?, "
  "`standardName`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::erase_statement[] =
  "DELETE FROM `Provenance` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Provenance`.`unipaxId`,\n"
  "`Provenance`.`unipaxSource`,\n"
  "`Provenance`.`typeid`,\n"
  ...
  "`Provenance`.`displayName`\n"
  "FROM `Provenance`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Provenance`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Provenance`";

  const char access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::table_name[] =
  "`Provenance`";
  ...
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Provenance, id_mysql >::
