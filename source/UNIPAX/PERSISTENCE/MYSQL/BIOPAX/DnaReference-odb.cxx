...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::EntityReference,
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::subRegion_tag>::
  table_name[] = "`subRegion_EntityReference`";

  const char alias_traits<  ::UniPAX::BioSource,
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::organism_tag>::
  table_name[] = "`organism_BioSource`";

  struct access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::info (
    typeid (::UniPAX::DnaReference),
    &object_traits_impl< ::UniPAX::EntityReference, id_mysql >::info,
    0,
    "UniPAX::DnaReference",
    &odb::create_impl< ::UniPAX::DnaReference >,
    &odb::dispatch_impl< ::UniPAX::DnaReference, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_DnaReference;

  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`DnaReference`.`sequence`, "
    "`DnaReference`.`subRegion`, "
    ...
    "FROM `DnaReference` "
    "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`DnaReference`.`unipaxId` "
    "WHERE `DnaReference`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::find_column_counts[] =
  {
    10UL,
    3UL
  };

  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::update_statement[] =
  "UPDATE `DnaReference` "
  "SET "
  "`sequence`=?, "
  "`subRegion`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::erase_statement[] =
  "DELETE FROM `DnaReference` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::query_statement[] =
  "SELECT\n"
  "`DnaReference`.`sequence`,\n"
  "`DnaReference`.`subRegion`,\n"
  "`DnaReference`.`organism`,\n"
  ...
  "FROM `DnaReference`\n"
  "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`DnaReference`.`unipaxId`\n"
  "LEFT JOIN `EntityReference` AS `subRegion_EntityReference` ON `subRegion_EntityReference`.`unipaxId`=`DnaReference`.`subRegion`\n"
  "LEFT JOIN `BioSource` AS `organism_BioSource` ON `organism_BioSource`.`unipaxId`=`DnaReference`.`organism`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::erase_query_statement[] =
  "DELETE FROM `DnaReference`";

  const char access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::table_name[] =
  "`DnaReference`";
  ...
  access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::DnaReference, id_mysql >::
