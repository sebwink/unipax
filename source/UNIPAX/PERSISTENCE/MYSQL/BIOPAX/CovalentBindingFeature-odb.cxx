...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::ControlledVocabulary,
    id_mysql,
    access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::modificationType_tag>::
  table_name[] = "`modificationType_ControlledVocabulary`";

  const char alias_traits<  ::UniPAX::SequenceModificationVocabulary,
    id_mysql,
    access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::modificationType_tag>::
  table_name[] = "`modificationType_SequenceModificationVocabulary`";

  struct access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.modificationType_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::SequenceModificationVocabulary > const& v =
        o.modificationType;

      typedef object_traits< ::UniPAX::SequenceModificationVocabulary > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::SequenceModificationVocabulary > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
          ...
          i.modificationType_value, is_null, id);
        i.modificationType_null = is_null;
      }
      else
        i.modificationType_null = 1;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::SequenceModificationVocabulary >& v =
        o.modificationType;

      typedef object_traits< ::UniPAX::SequenceModificationVocabulary > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::SequenceModificationVocabulary > > ptr_traits;

      if (i.modificationType_null)
  ...
  const access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::info (
    typeid (::UniPAX::CovalentBindingFeature),
    &object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::info,
    0,
    "UniPAX::CovalentBindingFeature",
    &odb::create_impl< ::UniPAX::CovalentBindingFeature >,
    &odb::dispatch_impl< ::UniPAX::CovalentBindingFeature, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_CovalentBindingFeature;

  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`CovalentBindingFeature`.`modificationType`, "
    ...
    "LEFT JOIN `BindingFeature` ON `BindingFeature`.`unipaxId`=`CovalentBindingFeature`.`unipaxId` "
    "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`CovalentBindingFeature`.`unipaxId` "
    "WHERE `CovalentBindingFeature`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::find_column_counts[] =
  {
    5UL,
    2UL,
    1UL
  ...
  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::update_statement[] =
  "UPDATE `CovalentBindingFeature` "
  "SET "
  "`modificationType`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::erase_statement[] =
  "DELETE FROM `CovalentBindingFeature` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::query_statement[] =
  "SELECT\n"
  "`CovalentBindingFeature`.`modificationType`,\n"
  "`BindingFeature`.`intraMolecular`,\n"
  "`EntityFeature`.`unipaxId`,\n"
  ...
  "LEFT JOIN `BindingFeature` ON `BindingFeature`.`unipaxId`=`CovalentBindingFeature`.`unipaxId`\n"
  "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`CovalentBindingFeature`.`unipaxId`\n"
  "LEFT JOIN `SequenceModificationVocabulary` AS `modificationType_SequenceModificationVocabulary` ON `modificationType_SequenceModificationVocabulary`.`unipaxId`=`CovalentBindingFeature`.`modificationType`\n"
  "LEFT JOIN `ControlledVocabulary` AS `modificationType_ControlledVocabulary` ON `modificationType_ControlledVocabulary`.`unipaxId`=`modificationType_SequenceModificationVocabulary`.`unipaxId`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`EntityFeature`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::erase_query_statement[] =
  "DELETE FROM `CovalentBindingFeature`";

  const char access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::table_name[] =
  "`CovalentBindingFeature`";
  ...
  access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::
