...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::info (
    typeid (::UniPAX::ProteinReference),
    &object_traits_impl< ::UniPAX::EntityReference, id_mysql >::info,
    0,
    "UniPAX::ProteinReference",
    &odb::create_impl< ::UniPAX::ProteinReference >,
    &odb::dispatch_impl< ::UniPAX::ProteinReference, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_ProteinReference;

  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`ProteinReference`.`unipaxId` "
    "WHERE `ProteinReference`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::find_column_counts[] =
  {
    9UL,
    2UL
  };

  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::update_statement[] =
  "UPDATE `ProteinReference` "
  "SET "
  "`sequence`=?, "
  "`organism`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::erase_statement[] =
  "DELETE FROM `ProteinReference` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ProteinReference`.`sequence`,\n"
  "`ProteinReference`.`organism`,\n"
  "`EntityReference`.`unipaxId`,\n"
  ...
  "FROM `ProteinReference`\n"
  "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`ProteinReference`.`unipaxId`\n"
  "LEFT JOIN `BioSource` AS `organism_BioSource` ON `organism_BioSource`.`unipaxId`=`ProteinReference`.`organism`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::erase_query_statement[] =
  "DELETE FROM `ProteinReference`";

  const char access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::table_name[] =
  "`ProteinReference`";
  ...
  access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::ProteinReference, id_mysql >::
