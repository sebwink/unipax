...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Dna, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entityReference_traits::
  select_statement[] =
  "SELECT "
  "`Dna_entityReference`.`index`, "
  "`Dna_entityReference`.`value` "
  "FROM `Dna_entityReference` "
  "WHERE `Dna_entityReference`.`object_id`=? ORDER BY `Dna_entityReference`.`index`";

  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entityReference_traits::
  insert_statement[] =
  "INSERT INTO `Dna_entityReference` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entityReference_traits::
  delete_statement[] =
  "DELETE FROM `Dna_entityReference` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entityReference_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entityReference_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::Dna, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Dna, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::Dna, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Dna, id_mysql >::info (
    typeid (::UniPAX::Dna),
    &object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >::info,
    0,
    "UniPAX::Dna",
    &odb::create_impl< ::UniPAX::Dna >,
    &odb::dispatch_impl< ::UniPAX::Dna, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Dna, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Dna;

  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::persist_statement[] =
  "INSERT INTO `Dna` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Dna, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `Dna` "
    "LEFT JOIN `PhysicalEntity` ON `PhysicalEntity`.`unipaxId`=`Dna`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Dna`.`unipaxId` "
    "WHERE `Dna`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Dna, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::erase_statement[] =
  "DELETE FROM `Dna` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhysicalEntity`.`cellularLocation`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Dna`";

  const char access::object_traits_impl< ::UniPAX::Dna, id_mysql >::table_name[] =
  "`Dna`";
  ...
  access::object_traits_impl< ::UniPAX::Dna, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Dna, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Dna, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Dna, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Dna, id_mysql >::
