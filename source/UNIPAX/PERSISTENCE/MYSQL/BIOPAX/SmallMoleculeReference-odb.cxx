...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::ChemicalStructure,
    id_mysql,
    access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::structure_tag>::
  table_name[] = "`structure_ChemicalStructure`";

  struct access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.chemicalFormula_value.capacity (i.chemicalFormula_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.chemicalFormula_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.chemicalFormula_value.capacity ());
    b[n].length = &i.chemicalFormula_size;
    b[n].is_null = &i.chemicalFormula_null;
    n++;
    ...
    b[n].is_null = &i.molecularWeight_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.chemicalFormula_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.chemicalFormula_null = is_null;
      i.chemicalFormula_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.chemicalFormula_value.capacity ());
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.molecularWeight_value, is_null, v);
      i.molecularWeight_null = is_null;
    }

    // structure
    //
    {
      ::boost::shared_ptr< ::UniPAX::ChemicalStructure > const& v =
        o.structure;

      typedef object_traits< ::UniPAX::ChemicalStructure > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::ChemicalStructure > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
          ...
          i.structure_value, is_null, id);
        i.structure_null = is_null;
      }
      else
        i.structure_null = 1;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.molecularWeight_null);
    }

    // structure
    //
    {
      ::boost::shared_ptr< ::UniPAX::ChemicalStructure >& v =
        o.structure;
  ...
  const access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::info (
    typeid (::UniPAX::SmallMoleculeReference),
    &object_traits_impl< ::UniPAX::EntityReference, id_mysql >::info,
    0,
    "UniPAX::SmallMoleculeReference",
    &odb::create_impl< ::UniPAX::SmallMoleculeReference >,
    &odb::dispatch_impl< ::UniPAX::SmallMoleculeReference, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_SmallMoleculeReference;

  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`SmallMoleculeReference`.`unipaxId` "
    "WHERE `SmallMoleculeReference`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::find_column_counts[] =
  {
    10UL,
    3UL
  };

  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::update_statement[] =
  "UPDATE `SmallMoleculeReference` "
  "SET "
  "`chemicalFormula`=?, "
  "`molecularWeight`=?, "
  "`structure`=? "
  ...
  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::erase_statement[] =
  "DELETE FROM `SmallMoleculeReference` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::query_statement[] =
  "SELECT\n"
  "`SmallMoleculeReference`.`chemicalFormula`,\n"
  "`SmallMoleculeReference`.`molecularWeight`,\n"
  "`SmallMoleculeReference`.`structure`,\n"
  ...
  "FROM `SmallMoleculeReference`\n"
  "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`SmallMoleculeReference`.`unipaxId`\n"
  "LEFT JOIN `ChemicalStructure` AS `structure_ChemicalStructure` ON `structure_ChemicalStructure`.`unipaxId`=`SmallMoleculeReference`.`structure`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::erase_query_statement[] =
  "DELETE FROM `SmallMoleculeReference`";

  const char access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::table_name[] =
  "`SmallMoleculeReference`";
  ...
  access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >::
