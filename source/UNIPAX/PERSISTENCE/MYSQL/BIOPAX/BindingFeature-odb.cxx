...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< bindsTo_traits > bindsTo;
  ...
  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::bindsTo_traits::
  select_statement[] =
  "SELECT "
  "`BindingFeature_bindsTo`.`index`, "
  "`BindingFeature_bindsTo`.`value` "
  "FROM `BindingFeature_bindsTo` "
  "WHERE `BindingFeature_bindsTo`.`object_id`=? ORDER BY `BindingFeature_bindsTo`.`index`";

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::bindsTo_traits::
  insert_statement[] =
  "INSERT INTO `BindingFeature_bindsTo` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::bindsTo_traits::
  delete_statement[] =
  "DELETE FROM `BindingFeature_bindsTo` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::bindsTo_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
        ...
        const value_type& v)
  {
    ...
    //
    {
      typedef object_traits< ::UniPAX::BindingFeature > obj_traits;
  ...
  bool access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::bindsTo_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.intraMolecular_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.intraMolecular_value, is_null, v);
      i.intraMolecular_null = is_null;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.intraMolecular_null);
    }
  }

  const access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::info (
    typeid (::UniPAX::BindingFeature),
    &object_traits_impl< ::UniPAX::EntityFeature, id_mysql >::info,
    0,
    "UniPAX::BindingFeature",
    &odb::create_impl< ::UniPAX::BindingFeature >,
    &odb::dispatch_impl< ::UniPAX::BindingFeature, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_BindingFeature;

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "FROM `BindingFeature` "
    "LEFT JOIN `EntityFeature` ON `EntityFeature`.`unipaxId`=`BindingFeature`.`unipaxId` "
    "WHERE `BindingFeature`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::find_column_counts[] =
  {
    4UL,
    1UL
  };

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::update_statement[] =
  "UPDATE `BindingFeature` "
  "SET "
  "`intraMolecular`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::erase_statement[] =
  "DELETE FROM `BindingFeature` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::query_statement[] =
  "SELECT\n"
  "`BindingFeature`.`intraMolecular`,\n"
  "`EntityFeature`.`unipaxId`,\n"
  "`EntityFeature`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::erase_query_statement[] =
  "DELETE FROM `BindingFeature`";

  const char access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::table_name[] =
  "`BindingFeature`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::BindingFeature > > const& v =
        obj.bindsTo;

      bindsTo_traits::persist (
        v,
        esc.bindsTo);
    }
  ...
  access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::
         ...
         std::size_t d)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::BindingFeature > >& v =
        obj.bindsTo;
  ...
  result< access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >::
