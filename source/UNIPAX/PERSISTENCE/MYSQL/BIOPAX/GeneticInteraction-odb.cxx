...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< phenotype_traits > phenotype;
    mysql::container_statements_impl< interactionScore_traits > interactionScore;
  ...
  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::phenotype_traits::
  select_statement[] =
  "SELECT "
  "`GeneticInteraction_phenotype`.`index`, "
  "`GeneticInteraction_phenotype`.`value` "
  "FROM `GeneticInteraction_phenotype` "
  "WHERE `GeneticInteraction_phenotype`.`object_id`=? ORDER BY `GeneticInteraction_phenotype`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::phenotype_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::phenotype_traits::
  ...
  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::interactionScore_traits::
  select_statement[] =
  "SELECT "
  "`GeneticInteraction_score`.`index`, "
  "`GeneticInteraction_score`.`value` "
  "FROM `GeneticInteraction_score` "
  "WHERE `GeneticInteraction_score`.`object_id`=? ORDER BY `GeneticInteraction_score`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::interactionScore_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::interactionScore_traits::
  select (index_type& i, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  bool access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::info (
    typeid (::UniPAX::GeneticInteraction),
    &object_traits_impl< ::UniPAX::Interaction, id_mysql >::info,
    0,
    "UniPAX::GeneticInteraction",
    &odb::create_impl< ::UniPAX::GeneticInteraction >,
    &odb::dispatch_impl< ::UniPAX::GeneticInteraction, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_GeneticInteraction;

  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::persist_statement[] =
  "INSERT INTO `GeneticInteraction` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Entity`.`unipaxId`, "
    "`Entity`.`unipaxSource`, "
    ...
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`GeneticInteraction`.`unipaxId` "
    "WHERE `GeneticInteraction`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::find_column_counts[] =
  {
    8UL,
    0UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::erase_statement[] =
  "DELETE FROM `GeneticInteraction` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  "`Entity`.`typeid`,\n"
  ...
  "`Entity`.`dataSource`\n"
  "FROM `GeneticInteraction`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`GeneticInteraction`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`GeneticInteraction`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::erase_query_statement[] =
  "DELETE FROM `GeneticInteraction`";

  const char access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::table_name[] =
  "`GeneticInteraction`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::PhenotypeVocabulary > > const& v =
        obj.phenotype;
  ...
  access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::
         ...
         std::size_t d)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::PhenotypeVocabulary > >& v =
        obj.phenotype;
  ...
  result< access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >::
