...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::info (
    typeid (::UniPAX::TemplateReactionRegulation),
    &object_traits_impl< ::UniPAX::Control, id_mysql >::info,
    0,
    "UniPAX::TemplateReactionRegulation",
    &odb::create_impl< ::UniPAX::TemplateReactionRegulation >,
    &odb::dispatch_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_TemplateReactionRegulation;

  const char access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::persist_statement[] =
  "INSERT INTO `TemplateReactionRegulation` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Control`.`controlType`, "
    "`Control`.`controlled`, "
    ...
    "LEFT JOIN `Control` ON `Control`.`unipaxId`=`TemplateReactionRegulation`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TemplateReactionRegulation`.`unipaxId` "
    "WHERE `TemplateReactionRegulation`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::find_column_counts[] =
  {
    10UL,
    2UL,
    2UL,
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::erase_statement[] =
  "DELETE FROM `TemplateReactionRegulation` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Control`.`controlType`,\n"
  "`Control`.`controlled`,\n"
  "`Entity`.`unipaxId`,\n"
  ...
  "FROM `TemplateReactionRegulation`\n"
  "LEFT JOIN `Control` ON `Control`.`unipaxId`=`TemplateReactionRegulation`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`TemplateReactionRegulation`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TemplateReactionRegulation`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::erase_query_statement[] =
  "DELETE FROM `TemplateReactionRegulation`";

  const char access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::table_name[] =
  "`TemplateReactionRegulation`";
  ...
  access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::TemplateReactionRegulation, id_mysql >::
