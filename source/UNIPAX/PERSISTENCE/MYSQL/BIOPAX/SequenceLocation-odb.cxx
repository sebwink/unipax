...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`SequenceLocation_comment`.`index`, "
  "`SequenceLocation_comment`.`value` "
  "FROM `SequenceLocation_comment` "
  "WHERE `SequenceLocation_comment`.`object_id`=? ORDER BY `SequenceLocation_comment`.`index`";

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::comment_traits::
  insert_statement[] =
  "INSERT INTO `SequenceLocation_comment` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::comment_traits::
  delete_statement[] =
  "DELETE FROM `SequenceLocation_comment` "
  "WHERE `object_id`=?";

  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::info (
    typeid (::UniPAX::SequenceLocation),
    0,
    0,
    "UniPAX::SequenceLocation",
    &odb::create_impl< ::UniPAX::SequenceLocation >,
    &odb::dispatch_impl< ::UniPAX::SequenceLocation, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_SequenceLocation;

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::persist_statement[] =
  "INSERT INTO `SequenceLocation` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`typeid`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::find_statement[] =
  "SELECT "
  "`SequenceLocation`.`unipaxId`, "
  "`SequenceLocation`.`unipaxSource`, "
  "`SequenceLocation`.`typeid` "
  "FROM `SequenceLocation` "
  "WHERE `SequenceLocation`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::update_statement[] =
  "UPDATE `SequenceLocation` "
  "SET "
  "`unipaxSource`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::erase_statement[] =
  "DELETE FROM `SequenceLocation` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::query_statement[] =
  "SELECT\n"
  "`SequenceLocation`.`unipaxId`,\n"
  "`SequenceLocation`.`unipaxSource`,\n"
  "`SequenceLocation`.`typeid`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::erase_query_statement[] =
  "DELETE FROM `SequenceLocation`";

  const char access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::table_name[] =
  "`SequenceLocation`";
  ...
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::
