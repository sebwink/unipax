...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.positionStatus_value.capacity (i.positionStatus_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.positionStatus_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.positionStatus_value.capacity ());
    b[n].length = &i.positionStatus_size;
    b[n].is_null = &i.positionStatus_null;
    n++;
    ...
    b[n].is_null = &i.sequencePosition_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.positionStatus_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.positionStatus_null = is_null;
      i.positionStatus_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.positionStatus_value.capacity ());
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.sequencePosition_value, is_null, v);
      i.sequencePosition_null = is_null;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.sequencePosition_null);
    }
  }

  const access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::info (
    typeid (::UniPAX::SequenceSite),
    &object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >::info,
    0,
    "UniPAX::SequenceSite",
    &odb::create_impl< ::UniPAX::SequenceSite >,
    &odb::dispatch_impl< ::UniPAX::SequenceSite, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_SequenceSite;

  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "FROM `SequenceSite` "
    "LEFT JOIN `SequenceLocation` ON `SequenceLocation`.`unipaxId`=`SequenceSite`.`unipaxId` "
    "WHERE `SequenceSite`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::find_column_counts[] =
  {
    5UL,
    2UL
  };

  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::update_statement[] =
  "UPDATE `SequenceSite` "
  "SET "
  "`positionStatus`=?, "
  "`sequencePosition`=? "
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::erase_statement[] =
  "DELETE FROM `SequenceSite` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::query_statement[] =
  "SELECT\n"
  "`SequenceSite`.`positionStatus`,\n"
  "`SequenceSite`.`sequencePosition`,\n"
  "`SequenceLocation`.`unipaxId`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::erase_query_statement[] =
  "DELETE FROM `SequenceSite`";

  const char access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::table_name[] =
  "`SequenceSite`";
  ...
  access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >::
