...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Rna, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entityReference_traits::
  select_statement[] =
  "SELECT "
  "`Rna_entityReference`.`index`, "
  "`Rna_entityReference`.`value` "
  "FROM `Rna_entityReference` "
  "WHERE `Rna_entityReference`.`object_id`=? ORDER BY `Rna_entityReference`.`index`";

  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entityReference_traits::
  insert_statement[] =
  "INSERT INTO `Rna_entityReference` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entityReference_traits::
  delete_statement[] =
  "DELETE FROM `Rna_entityReference` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entityReference_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entityReference_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::Rna, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Rna, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::Rna, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Rna, id_mysql >::info (
    typeid (::UniPAX::Rna),
    &object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >::info,
    0,
    "UniPAX::Rna",
    &odb::create_impl< ::UniPAX::Rna >,
    &odb::dispatch_impl< ::UniPAX::Rna, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Rna, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Rna;

  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::persist_statement[] =
  "INSERT INTO `Rna` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Rna, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `Rna` "
    "LEFT JOIN `PhysicalEntity` ON `PhysicalEntity`.`unipaxId`=`Rna`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Rna`.`unipaxId` "
    "WHERE `Rna`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Rna, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::erase_statement[] =
  "DELETE FROM `Rna` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhysicalEntity`.`cellularLocation`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Rna`";

  const char access::object_traits_impl< ::UniPAX::Rna, id_mysql >::table_name[] =
  "`Rna`";
  ...
  access::object_traits_impl< ::UniPAX::Rna, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Rna, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Rna, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Rna, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Rna, id_mysql >::
