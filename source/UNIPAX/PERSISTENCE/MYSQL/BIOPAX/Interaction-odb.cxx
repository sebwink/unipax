...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< participant_traits > participant;
    mysql::container_statements_impl< interactionType_traits > interactionType;
  ...
  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::participant_traits::
  select_statement[] =
  "SELECT "
  "`Interaction_participant`.`index`, "
  "`Interaction_participant`.`value` "
  "FROM `Interaction_participant` "
  "WHERE `Interaction_participant`.`object_id`=? ORDER BY `Interaction_participant`.`index`";
  ...
  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::participant_traits::
  delete_statement[] =
  "DELETE FROM `Interaction_participant` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::participant_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::participant_traits::
  ...
  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::interactionType_traits::
  select_statement[] =
  "SELECT "
  "`Interaction_interactionType`.`index`, "
  "`Interaction_interactionType`.`value` "
  "FROM `Interaction_interactionType` "
  "WHERE `Interaction_interactionType`.`object_id`=? ORDER BY `Interaction_interactionType`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::interactionType_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::interactionType_traits::
  select (index_type& i, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  bool access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::info (
    typeid (::UniPAX::Interaction),
    &object_traits_impl< ::UniPAX::Entity, id_mysql >::info,
    0,
    "UniPAX::Interaction",
    &odb::create_impl< ::UniPAX::Interaction >,
    &odb::dispatch_impl< ::UniPAX::Interaction, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Interaction;

  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::persist_statement[] =
  "INSERT INTO `Interaction` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Entity`.`unipaxId`, "
    "`Entity`.`unipaxSource`, "
    ...
    "`Entity`.`dataSource` "
    "FROM `Interaction` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Interaction`.`unipaxId` "
    "WHERE `Interaction`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::find_column_counts[] =
  {
    8UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::erase_statement[] =
  "DELETE FROM `Interaction` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  "`Entity`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Interaction`";

  const char access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::table_name[] =
  "`Interaction`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::InteractionVocabulary > > const& v =
        obj.interactionType;
  ...
  access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::
         ...
         std::size_t d)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::InteractionVocabulary > >& v =
        obj.interactionType;
  ...
  result< access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Interaction, id_mysql >::
