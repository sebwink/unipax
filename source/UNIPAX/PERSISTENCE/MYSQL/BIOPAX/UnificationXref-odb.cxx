...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::info (
    typeid (::UniPAX::UnificationXref),
    &object_traits_impl< ::UniPAX::Xref, id_mysql >::info,
    0,
    "UniPAX::UnificationXref",
    &odb::create_impl< ::UniPAX::UnificationXref >,
    &odb::dispatch_impl< ::UniPAX::UnificationXref, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_UnificationXref;

  const char access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::persist_statement[] =
  "INSERT INTO `UnificationXref` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Xref`.`unipaxId`, "
    "`Xref`.`unipaxSource`, "
    ...
    "LEFT JOIN `Xref` ON `Xref`.`unipaxId`=`UnificationXref`.`unipaxId` "
    "WHERE `UnificationXref`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::find_column_counts[] =
  {
    7UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::erase_statement[] =
  "DELETE FROM `UnificationXref` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Xref`.`unipaxId`,\n"
  "`Xref`.`unipaxSource`,\n"
  "`Xref`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::erase_query_statement[] =
  "DELETE FROM `UnificationXref`";

  const char access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::table_name[] =
  "`UnificationXref`";
  ...
  access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >::
