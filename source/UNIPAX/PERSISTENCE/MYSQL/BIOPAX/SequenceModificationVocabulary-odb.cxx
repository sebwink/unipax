...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::extra_statement_cache_type
  {
  ...
  const access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::info (
    typeid (::UniPAX::SequenceModificationVocabulary),
    &object_traits_impl< ::UniPAX::ControlledVocabulary, id_mysql >::info,
    0,
    "UniPAX::SequenceModificationVocabulary",
    &odb::create_impl< ::UniPAX::SequenceModificationVocabulary >,
    &odb::dispatch_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_SequenceModificationVocabulary;

  const char access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::persist_statement[] =
  "INSERT INTO `SequenceModificationVocabulary` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `ControlledVocabulary` ON `ControlledVocabulary`.`unipaxId`=`SequenceModificationVocabulary`.`unipaxId` "
    "WHERE `SequenceModificationVocabulary`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::find_column_counts[] =
  {
    4UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::erase_statement[] =
  "DELETE FROM `SequenceModificationVocabulary` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ControlledVocabulary`.`unipaxId`,\n"
  "`ControlledVocabulary`.`unipaxSource`,\n"
  "`ControlledVocabulary`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::erase_query_statement[] =
  "DELETE FROM `SequenceModificationVocabulary`";

  const char access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::table_name[] =
  "`SequenceModificationVocabulary`";
  ...
  access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >::
