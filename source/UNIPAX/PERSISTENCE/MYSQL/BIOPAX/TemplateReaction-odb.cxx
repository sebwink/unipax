...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Entity,
    id_mysql,
    access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::templateEntity_tag>::
  table_name[] = "`templateEntity_Entity`";

  const char alias_traits<  ::UniPAX::PhysicalEntity,
    id_mysql,
    access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::templateEntity_tag>::
  table_name[] = "`templateEntity_PhysicalEntity`";

  struct access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< product_traits > product;
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::product_traits::
  select_statement[] =
  "SELECT "
  "`TemplateReaction_product`.`index`, "
  "`TemplateReaction_product`.`value` "
  "FROM `TemplateReaction_product` "
  "WHERE `TemplateReaction_product`.`object_id`=? ORDER BY `TemplateReaction_product`.`index`";

  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::product_traits::
  insert_statement[] =
  "INSERT INTO `TemplateReaction_product` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::product_traits::
  delete_statement[] =
  "DELETE FROM `TemplateReaction_product` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::product_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::product_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.templateDirection_value.capacity (i.templateDirection_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.templateDirection_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.templateDirection_value.capacity ());
    b[n].length = &i.templateDirection_size;
    b[n].is_null = &i.templateDirection_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.templateEntity_value;
    b[n].is_null = &i.templateEntity_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.templateDirection_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.templateDirection_null = is_null;
      i.templateDirection_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.templateDirection_value.capacity ());
    }

    // templateEntity
    //
    {
      ::boost::shared_ptr< ::UniPAX::PhysicalEntity > const& v =
        o.templateEntity;

      typedef object_traits< ::UniPAX::PhysicalEntity > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::PhysicalEntity > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
            obj_traits::id_type,
            mysql::id_ulonglong >::set_image (
          i.templateEntity_value, is_null, id);
        i.templateEntity_null = is_null;
      }
      else
        i.templateEntity_null = 1;
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.templateDirection_null);
    }

    // templateEntity
    //
    {
      ::boost::shared_ptr< ::UniPAX::PhysicalEntity >& v =
        o.templateEntity;

      typedef object_traits< ::UniPAX::PhysicalEntity > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::PhysicalEntity > > ptr_traits;

      if (i.templateEntity_null)
        v = ptr_traits::pointer_type ();
      else
      {
        obj_traits::id_type id;
        mysql::value_traits<
            ...
            mysql::id_ulonglong >::set_value (
          id,
          i.templateEntity_value,
          i.templateEntity_null);
  ...
  const access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::info (
    typeid (::UniPAX::TemplateReaction),
    &object_traits_impl< ::UniPAX::Interaction, id_mysql >::info,
    0,
    "UniPAX::TemplateReaction",
    &odb::create_impl< ::UniPAX::TemplateReaction >,
    &odb::dispatch_impl< ::UniPAX::TemplateReaction, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_TemplateReaction;

  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`TemplateReaction`.`templateDirection`, "
    "`TemplateReaction`.`templateEntity`, "
    "`Entity`.`unipaxId`, "
    "`Entity`.`unipaxSource`, "
    "`Entity`.`typeid`, "
    "`Entity`.`availability`, "
    ...
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TemplateReaction`.`unipaxId` "
    "WHERE `TemplateReaction`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::find_column_counts[] =
  {
    10UL,
    2UL,
    2UL
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::update_statement[] =
  "UPDATE `TemplateReaction` "
  "SET "
  "`templateDirection`=?, "
  "`templateEntity`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::erase_statement[] =
  "DELETE FROM `TemplateReaction` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::query_statement[] =
  "SELECT\n"
  "`TemplateReaction`.`templateDirection`,\n"
  "`TemplateReaction`.`templateEntity`,\n"
  "`Entity`.`unipaxId`,\n"
  ...
  "`Entity`.`dataSource`\n"
  "FROM `TemplateReaction`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`TemplateReaction`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TemplateReaction`.`unipaxId`\n"
  "LEFT JOIN `PhysicalEntity` AS `templateEntity_PhysicalEntity` ON `templateEntity_PhysicalEntity`.`unipaxId`=`TemplateReaction`.`templateEntity`\n"
  "LEFT JOIN `Entity` AS `templateEntity_Entity` ON `templateEntity_Entity`.`unipaxId`=`templateEntity_PhysicalEntity`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::erase_query_statement[] =
  "DELETE FROM `TemplateReaction`";

  const char access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::table_name[] =
  "`TemplateReaction`";
  ...
  access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::TemplateReaction, id_mysql >::
