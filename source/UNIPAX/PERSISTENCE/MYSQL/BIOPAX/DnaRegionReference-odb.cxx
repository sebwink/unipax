...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::info (
    typeid (::UniPAX::DnaRegionReference),
    &object_traits_impl< ::UniPAX::EntityReference, id_mysql >::info,
    0,
    "UniPAX::DnaRegionReference",
    &odb::create_impl< ::UniPAX::DnaRegionReference >,
    &odb::dispatch_impl< ::UniPAX::DnaRegionReference, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_DnaRegionReference;

  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`DnaRegionReference`.`sequence`, "
    "`DnaRegionReference`.`subRegion`, "
    "`DnaRegionReference`.`regionType`, "
    "`DnaRegionReference`.`organism`, "
    "`DnaRegionReference`.`absoluteRegion`, "
    ...
    "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`DnaRegionReference`.`unipaxId` "
    "WHERE `DnaRegionReference`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::find_column_counts[] =
  {
    12UL,
    5UL
  };

  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::update_statement[] =
  "UPDATE `DnaRegionReference` "
  "SET "
  "`sequence`=?, "
  "`subRegion`=?, "
  "`regionType`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::erase_statement[] =
  "DELETE FROM `DnaRegionReference` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::query_statement[] =
  "SELECT\n"
  "`DnaRegionReference`.`sequence`,\n"
  "`DnaRegionReference`.`subRegion`,\n"
  "`DnaRegionReference`.`regionType`,\n"
  ...
  "FROM `DnaRegionReference`\n"
  "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`DnaRegionReference`.`unipaxId`\n"
  "LEFT JOIN `EntityReference` AS `subRegion_EntityReference` ON `subRegion_EntityReference`.`unipaxId`=`DnaRegionReference`.`subRegion`\n"
  "LEFT JOIN `SequenceRegionVocabulary` AS `regionType_SequenceRegionVocabulary` ON `regionType_SequenceRegionVocabulary`.`unipaxId`=`DnaRegionReference`.`regionType`\n"
  ...
  "LEFT JOIN `BioSource` AS `organism_BioSource` ON `organism_BioSource`.`unipaxId`=`DnaRegionReference`.`organism`\n"
  "LEFT JOIN `SequenceLocation` AS `absoluteRegion_SequenceLocation` ON `absoluteRegion_SequenceLocation`.`unipaxId`=`DnaRegionReference`.`absoluteRegion`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::erase_query_statement[] =
  "DELETE FROM `DnaRegionReference`";

  const char access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::table_name[] =
  "`DnaRegionReference`";
  ...
  access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::
