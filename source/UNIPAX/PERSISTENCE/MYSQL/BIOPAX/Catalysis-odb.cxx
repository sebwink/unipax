...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< cofactor_traits > cofactor;
  ...
  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::cofactor_traits::
  select_statement[] =
  "SELECT "
  "`Catalysis_cofactor`.`index`, "
  "`Catalysis_cofactor`.`value` "
  "FROM `Catalysis_cofactor` "
  "WHERE `Catalysis_cofactor`.`object_id`=? ORDER BY `Catalysis_cofactor`.`index`";

  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::cofactor_traits::
  insert_statement[] =
  "INSERT INTO `Catalysis_cofactor` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::cofactor_traits::
  delete_statement[] =
  "DELETE FROM `Catalysis_cofactor` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::cofactor_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::cofactor_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.catalysisDirection_value.capacity (i.catalysisDirection_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.catalysisDirection_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.catalysisDirection_value.capacity ());
    b[n].length = &i.catalysisDirection_size;
    b[n].is_null = &i.catalysisDirection_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.catalysisDirection_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.catalysisDirection_null = is_null;
      i.catalysisDirection_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.catalysisDirection_value.capacity ());
    }
        ...
        std::size_t d)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.catalysisDirection_null);
    }
  }

  const access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::info (
    typeid (::UniPAX::Catalysis),
    &object_traits_impl< ::UniPAX::Control, id_mysql >::info,
    0,
    "UniPAX::Catalysis",
    &odb::create_impl< ::UniPAX::Catalysis >,
    &odb::dispatch_impl< ::UniPAX::Catalysis, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Catalysis;

  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `Catalysis` "
    "LEFT JOIN `Control` ON `Control`.`unipaxId`=`Catalysis`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Catalysis`.`unipaxId` "
    "WHERE `Catalysis`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::find_column_counts[] =
  {
    11UL,
    3UL,
    3UL,
  ...
  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::update_statement[] =
  "UPDATE `Catalysis` "
  "SET "
  "`catalysisDirection`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::erase_statement[] =
  "DELETE FROM `Catalysis` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Catalysis`.`catalysisDirection`,\n"
  "`Control`.`controlType`,\n"
  "`Control`.`controlled`,\n"
  ...
  "FROM `Catalysis`\n"
  "LEFT JOIN `Control` ON `Control`.`unipaxId`=`Catalysis`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`Catalysis`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Catalysis`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Catalysis`";

  const char access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::table_name[] =
  "`Catalysis`";
  ...
  access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Catalysis, id_mysql >::
