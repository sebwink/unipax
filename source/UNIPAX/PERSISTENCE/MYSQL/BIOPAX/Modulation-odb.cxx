...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::extra_statement_cache_type
  {
  ...
  const access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::info (
    typeid (::UniPAX::Modulation),
    &object_traits_impl< ::UniPAX::Control, id_mysql >::info,
    0,
    "UniPAX::Modulation",
    &odb::create_impl< ::UniPAX::Modulation >,
    &odb::dispatch_impl< ::UniPAX::Modulation, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Modulation;

  const char access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::persist_statement[] =
  "INSERT INTO `Modulation` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Control`.`controlType`, "
    "`Control`.`controlled`, "
    ...
    "`Entity`.`dataSource` "
    "FROM `Modulation` "
    "LEFT JOIN `Control` ON `Control`.`unipaxId`=`Modulation`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Modulation`.`unipaxId` "
    "WHERE `Modulation`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::find_column_counts[] =
  {
    10UL,
    2UL,
    2UL,
  ...
  const char access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::erase_statement[] =
  "DELETE FROM `Modulation` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Control`.`controlType`,\n"
  "`Control`.`controlled`,\n"
  "`Entity`.`unipaxId`,\n"
  ...
  "FROM `Modulation`\n"
  "LEFT JOIN `Control` ON `Control`.`unipaxId`=`Modulation`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`Modulation`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Modulation`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Modulation`";

  const char access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::table_name[] =
  "`Modulation`";
  ...
  access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Modulation, id_mysql >::
