...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entityReference_traits::
  select_statement[] =
  "SELECT "
  "`RnaRegion_entityReference`.`index`, "
  "`RnaRegion_entityReference`.`value` "
  "FROM `RnaRegion_entityReference` "
  "WHERE `RnaRegion_entityReference`.`object_id`=? ORDER BY `RnaRegion_entityReference`.`index`";

  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entityReference_traits::
  insert_statement[] =
  "INSERT INTO `RnaRegion_entityReference` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entityReference_traits::
  delete_statement[] =
  "DELETE FROM `RnaRegion_entityReference` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entityReference_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entityReference_traits::
  ...
  bool access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::info (
    typeid (::UniPAX::RnaRegion),
    &object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >::info,
    0,
    "UniPAX::RnaRegion",
    &odb::create_impl< ::UniPAX::RnaRegion >,
    &odb::dispatch_impl< ::UniPAX::RnaRegion, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_RnaRegion;

  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::persist_statement[] =
  "INSERT INTO `RnaRegion` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Entity`.`dataSource` "
    "FROM `RnaRegion` "
    "LEFT JOIN `PhysicalEntity` ON `PhysicalEntity`.`unipaxId`=`RnaRegion`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`RnaRegion`.`unipaxId` "
    "WHERE `RnaRegion`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::erase_statement[] =
  "DELETE FROM `RnaRegion` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhysicalEntity`.`cellularLocation`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::erase_query_statement[] =
  "DELETE FROM `RnaRegion`";

  const char access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::table_name[] =
  "`RnaRegion`";
  ...
  access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::RnaRegion, id_mysql >::
