...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::info (
    typeid (::UniPAX::MolecularInteraction),
    &object_traits_impl< ::UniPAX::Interaction, id_mysql >::info,
    0,
    "UniPAX::MolecularInteraction",
    &odb::create_impl< ::UniPAX::MolecularInteraction >,
    &odb::dispatch_impl< ::UniPAX::MolecularInteraction, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_MolecularInteraction;

  const char access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::persist_statement[] =
  "INSERT INTO `MolecularInteraction` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Entity`.`unipaxId`, "
    "`Entity`.`unipaxSource`, "
    ...
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`MolecularInteraction`.`unipaxId` "
    "WHERE `MolecularInteraction`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::find_column_counts[] =
  {
    8UL,
    0UL,
    0UL
  ...
  const char access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::erase_statement[] =
  "DELETE FROM `MolecularInteraction` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  "`Entity`.`typeid`,\n"
  ...
  "`Entity`.`dataSource`\n"
  "FROM `MolecularInteraction`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`MolecularInteraction`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`MolecularInteraction`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::erase_query_statement[] =
  "DELETE FROM `MolecularInteraction`";

  const char access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::table_name[] =
  "`MolecularInteraction`";
  ...
  access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::MolecularInteraction, id_mysql >::
