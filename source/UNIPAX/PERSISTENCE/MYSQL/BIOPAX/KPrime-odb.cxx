...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`KPrime_comment`.`index`, "
  "`KPrime_comment`.`value` "
  "FROM `KPrime_comment` "
  "WHERE `KPrime_comment`.`object_id`=? ORDER BY `KPrime_comment`.`index`";
  ...
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.ionicStrength_null;
    n++;
    ...
    b[n].is_null = &i.temperature_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.ionicStrength_value, is_null, v);
      i.ionicStrength_null = is_null;
    }
    ...
    //
    {
      ...
      mysql::value_traits<
          double,
          mysql::id_double >::set_image (
        i.kPrime_value, is_null, v);
      i.kPrime_null = is_null;
    }
    ...
    //
    {
      ...
      mysql::value_traits<
          double,
          mysql::id_double >::set_image (
        i.temperature_value, is_null, v);
      i.temperature_null = is_null;
    }
  ...
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::info (
    typeid (::UniPAX::KPrime),
    0,
    0,
    "UniPAX::KPrime",
    &odb::create_impl< ::UniPAX::KPrime >,
    &odb::dispatch_impl< ::UniPAX::KPrime, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_KPrime;

  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::persist_statement[] =
  "INSERT INTO `KPrime` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`typeid`, "
  ...
  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::find_statement[] =
  "SELECT "
  "`KPrime`.`unipaxId`, "
  "`KPrime`.`unipaxSource`, "
  "`KPrime`.`typeid`, "
  ...
  "`KPrime`.`temperature` "
  "FROM `KPrime` "
  "WHERE `KPrime`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::update_statement[] =
  "UPDATE `KPrime` "
  "SET "
  "`unipaxSource`=?, "
  "`ionicStrength`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::erase_statement[] =
  "DELETE FROM `KPrime` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::query_statement[] =
  "SELECT\n"
  "`KPrime`.`unipaxId`,\n"
  "`KPrime`.`unipaxSource`,\n"
  "`KPrime`.`typeid`,\n"
  ...
  "`KPrime`.`temperature`\n"
  "FROM `KPrime`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`KPrime`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::erase_query_statement[] =
  "DELETE FROM `KPrime`";

  const char access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::table_name[] =
  "`KPrime`";
  ...
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::KPrime, id_mysql >::
