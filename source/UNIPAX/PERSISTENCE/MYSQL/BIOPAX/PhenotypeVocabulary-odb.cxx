...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.patoData_value.capacity (i.patoData_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.patoData_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.patoData_value.capacity ());
    b[n].length = &i.patoData_size;
    b[n].is_null = &i.patoData_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.patoData_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.patoData_null = is_null;
      i.patoData_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.patoData_value.capacity ());
    }
  ...
  const access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::info (
    typeid (::UniPAX::PhenotypeVocabulary),
    &object_traits_impl< ::UniPAX::ControlledVocabulary, id_mysql >::info,
    0,
    "UniPAX::PhenotypeVocabulary",
    &odb::create_impl< ::UniPAX::PhenotypeVocabulary >,
    &odb::dispatch_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_PhenotypeVocabulary;

  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `ControlledVocabulary` ON `ControlledVocabulary`.`unipaxId`=`PhenotypeVocabulary`.`unipaxId` "
    "WHERE `PhenotypeVocabulary`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::find_column_counts[] =
  {
    5UL,
    1UL
  };

  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::update_statement[] =
  "UPDATE `PhenotypeVocabulary` "
  "SET "
  "`patoData`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::erase_statement[] =
  "DELETE FROM `PhenotypeVocabulary` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::query_statement[] =
  "SELECT\n"
  "`PhenotypeVocabulary`.`patoData`,\n"
  "`ControlledVocabulary`.`unipaxId`,\n"
  "`ControlledVocabulary`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::erase_query_statement[] =
  "DELETE FROM `PhenotypeVocabulary`";

  const char access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::table_name[] =
  "`PhenotypeVocabulary`";
  ...
  access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >::
