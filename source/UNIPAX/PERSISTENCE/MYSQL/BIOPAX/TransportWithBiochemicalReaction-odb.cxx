...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::info (
    typeid (::UniPAX::TransportWithBiochemicalReaction),
    &object_traits_impl< ::UniPAX::BiochemicalReaction, id_mysql >::info,
    0,
    "UniPAX::TransportWithBiochemicalReaction",
    &odb::create_impl< ::UniPAX::TransportWithBiochemicalReaction >,
    &odb::dispatch_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_TransportWithBiochemicalReaction;

  const char access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::persist_statement[] =
  "INSERT INTO `TransportWithBiochemicalReaction` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `BiochemicalReaction` ON `BiochemicalReaction`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId` "
    "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId` "
    "WHERE `TransportWithBiochemicalReaction`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::find_column_counts[] =
  {
    14UL,
    6UL,
    6UL,
  ...
  const char access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::erase_statement[] =
  "DELETE FROM `TransportWithBiochemicalReaction` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::query_statement[] =
  "SELECT\n"
  "`BiochemicalReaction`.`deltaH`,\n"
  "`BiochemicalReaction`.`deltaS`,\n"
  "`BiochemicalReaction`.`eCNumber`,\n"
  ...
  "LEFT JOIN `BiochemicalReaction` ON `BiochemicalReaction`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId`\n"
  "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`TransportWithBiochemicalReaction`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::erase_query_statement[] =
  "DELETE FROM `TransportWithBiochemicalReaction`";

  const char access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::table_name[] =
  "`TransportWithBiochemicalReaction`";
  ...
  access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >::
