...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< relationshipType_traits > relationshipType;
  ...
  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::relationshipType_traits::
  select_statement[] =
  "SELECT "
  "`RelationshipXref_relationshipType`.`index`, "
  "`RelationshipXref_relationshipType`.`value` "
  "FROM `RelationshipXref_relationshipType` "
  "WHERE `RelationshipXref_relationshipType`.`object_id`=? ORDER BY `RelationshipXref_relationshipType`.`index`";

  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::relationshipType_traits::
  insert_statement[] =
  "INSERT INTO `RelationshipXref_relationshipType` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::relationshipType_traits::
  delete_statement[] =
  "DELETE FROM `RelationshipXref_relationshipType` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::relationshipType_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::relationshipType_traits::
  ...
  const access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::info (
    typeid (::UniPAX::RelationshipXref),
    &object_traits_impl< ::UniPAX::Xref, id_mysql >::info,
    0,
    "UniPAX::RelationshipXref",
    &odb::create_impl< ::UniPAX::RelationshipXref >,
    &odb::dispatch_impl< ::UniPAX::RelationshipXref, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_RelationshipXref;

  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::persist_statement[] =
  "INSERT INTO `RelationshipXref` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Xref`.`unipaxId`, "
    "`Xref`.`unipaxSource`, "
    ...
    "LEFT JOIN `Xref` ON `Xref`.`unipaxId`=`RelationshipXref`.`unipaxId` "
    "WHERE `RelationshipXref`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::find_column_counts[] =
  {
    7UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::erase_statement[] =
  "DELETE FROM `RelationshipXref` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Xref`.`unipaxId`,\n"
  "`Xref`.`unipaxSource`,\n"
  "`Xref`.`typeid`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::erase_query_statement[] =
  "DELETE FROM `RelationshipXref`";

  const char access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::table_name[] =
  "`RelationshipXref`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::RelationshipTypeVocabulary > > const& v =
        obj.relationshipType;

      relationshipType_traits::persist (
        v,
        esc.relationshipType);
    }
  ...
  access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::
         ...
         std::size_t d)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::RelationshipTypeVocabulary > >& v =
        obj.relationshipType;
  ...
  result< access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::RelationshipXref, id_mysql >::
