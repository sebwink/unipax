...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::info (
    typeid (::UniPAX::ComplexAssembly),
    &object_traits_impl< ::UniPAX::Conversion, id_mysql >::info,
    0,
    "UniPAX::ComplexAssembly",
    &odb::create_impl< ::UniPAX::ComplexAssembly >,
    &odb::dispatch_impl< ::UniPAX::ComplexAssembly, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_ComplexAssembly;

  const char access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::persist_statement[] =
  "INSERT INTO `ComplexAssembly` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`ComplexAssembly`.`unipaxId` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`ComplexAssembly`.`unipaxId` "
    "WHERE `ComplexAssembly`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::find_column_counts[] =
  {
    11UL,
    3UL,
    3UL,
  ...
  const char access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::erase_statement[] =
  "DELETE FROM `ComplexAssembly` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Conversion`.`conversionDirection`,\n"
  "`Conversion`.`spontaneous`,\n"
  "`Conversion`.`kineticLaw`,\n"
  ...
  "FROM `ComplexAssembly`\n"
  "LEFT JOIN `Conversion` ON `Conversion`.`unipaxId`=`ComplexAssembly`.`unipaxId`\n"
  "LEFT JOIN `Interaction` ON `Interaction`.`unipaxId`=`ComplexAssembly`.`unipaxId`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`ComplexAssembly`.`unipaxId`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::erase_query_statement[] =
  "DELETE FROM `ComplexAssembly`";

  const char access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::table_name[] =
  "`ComplexAssembly`";
  ...
  access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::ComplexAssembly, id_mysql >::
