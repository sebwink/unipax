...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::comment_traits::
  select_statement[] =
  "SELECT "
  "`DeltaG_comment`.`index`, "
  "`DeltaG_comment`.`value` "
  "FROM `DeltaG_comment` "
  "WHERE `DeltaG_comment`.`object_id`=? ORDER BY `DeltaG_comment`.`index`";
  ...
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::discriminator_type
  ...
  bool access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.deltaGPrime0_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.deltaGPrime0_value, is_null, v);
      i.deltaGPrime0_null = is_null;
    }
  ...
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::info (
    typeid (::UniPAX::DeltaG),
    0,
    0,
    "UniPAX::DeltaG",
    &odb::create_impl< ::UniPAX::DeltaG >,
    &odb::dispatch_impl< ::UniPAX::DeltaG, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_DeltaG;

  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::persist_statement[] =
  "INSERT INTO `DeltaG` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`typeid`, "
  ...
  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::find_statement[] =
  "SELECT "
  "`DeltaG`.`unipaxId`, "
  "`DeltaG`.`unipaxSource`, "
  "`DeltaG`.`typeid`, "
  ...
  "`DeltaG`.`temperature` "
  "FROM `DeltaG` "
  "WHERE `DeltaG`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::update_statement[] =
  "UPDATE `DeltaG` "
  "SET "
  "`unipaxSource`=?, "
  "`deltaGPrime0`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::erase_statement[] =
  "DELETE FROM `DeltaG` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::query_statement[] =
  "SELECT\n"
  "`DeltaG`.`unipaxId`,\n"
  "`DeltaG`.`unipaxSource`,\n"
  "`DeltaG`.`typeid`,\n"
  ...
  "`DeltaG`.`temperature`\n"
  "FROM `DeltaG`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`DeltaG`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::erase_query_statement[] =
  "DELETE FROM `DeltaG`";

  const char access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::table_name[] =
  "`DeltaG`";
  ...
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::DeltaG, id_mysql >::
