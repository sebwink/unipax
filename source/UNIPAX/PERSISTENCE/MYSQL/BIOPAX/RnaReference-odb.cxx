...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::EntityReference,
    id_mysql,
    access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::subRegion_tag>::
  table_name[] = "`subRegion_EntityReference`";

  const char alias_traits<  ::UniPAX::BioSource,
    id_mysql,
    access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::organism_tag>::
  table_name[] = "`organism_BioSource`";

  struct access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::info (
    typeid (::UniPAX::RnaReference),
    &object_traits_impl< ::UniPAX::EntityReference, id_mysql >::info,
    0,
    "UniPAX::RnaReference",
    &odb::create_impl< ::UniPAX::RnaReference >,
    &odb::dispatch_impl< ::UniPAX::RnaReference, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_RnaReference;

  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`RnaReference`.`sequence`, "
    "`RnaReference`.`subRegion`, "
    ...
    "FROM `RnaReference` "
    "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`RnaReference`.`unipaxId` "
    "WHERE `RnaReference`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::find_column_counts[] =
  {
    10UL,
    3UL
  };

  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::update_statement[] =
  "UPDATE `RnaReference` "
  "SET "
  "`sequence`=?, "
  "`subRegion`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::erase_statement[] =
  "DELETE FROM `RnaReference` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::query_statement[] =
  "SELECT\n"
  "`RnaReference`.`sequence`,\n"
  "`RnaReference`.`subRegion`,\n"
  "`RnaReference`.`organism`,\n"
  ...
  "FROM `RnaReference`\n"
  "LEFT JOIN `EntityReference` ON `EntityReference`.`unipaxId`=`RnaReference`.`unipaxId`\n"
  "LEFT JOIN `EntityReference` AS `subRegion_EntityReference` ON `subRegion_EntityReference`.`unipaxId`=`RnaReference`.`subRegion`\n"
  "LEFT JOIN `BioSource` AS `organism_BioSource` ON `organism_BioSource`.`unipaxId`=`RnaReference`.`organism`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::erase_query_statement[] =
  "DELETE FROM `RnaReference`";

  const char access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::table_name[] =
  "`RnaReference`";
  ...
  access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >::
