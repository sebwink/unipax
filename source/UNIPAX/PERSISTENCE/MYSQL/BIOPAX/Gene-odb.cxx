...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::BioSource,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Gene, id_mysql >::organism_tag>::
  table_name[] = "`organism_BioSource`";

  struct access::object_traits_impl< ::UniPAX::Gene, id_mysql >::extra_statement_cache_type
  {
  ...
  const access::object_traits_impl< ::UniPAX::Gene, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Gene, id_mysql >::info (
    typeid (::UniPAX::Gene),
    &object_traits_impl< ::UniPAX::Entity, id_mysql >::info,
    0,
    "UniPAX::Gene",
    &odb::create_impl< ::UniPAX::Gene >,
    &odb::dispatch_impl< ::UniPAX::Gene, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::Gene, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Gene;

  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::persist_statement[] =
  "INSERT INTO `Gene` "
  "(`unipaxId`, "
  "`organism`) "
  "VALUES "
  ...
  const char* const access::object_traits_impl< ::UniPAX::Gene, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Gene`.`organism`, "
    "`Entity`.`unipaxId`, "
    ...
    "`Entity`.`dataSource` "
    "FROM `Gene` "
    "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Gene`.`unipaxId` "
    "WHERE `Gene`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::Gene, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL
  };

  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::update_statement[] =
  "UPDATE `Gene` "
  "SET "
  "`organism`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::erase_statement[] =
  "DELETE FROM `Gene` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Gene`.`organism`,\n"
  "`Entity`.`unipaxId`,\n"
  "`Entity`.`unipaxSource`,\n"
  ...
  "FROM `Gene`\n"
  "LEFT JOIN `Entity` ON `Entity`.`unipaxId`=`Gene`.`unipaxId`\n"
  "LEFT JOIN `BioSource` AS `organism_BioSource` ON `organism_BioSource`.`unipaxId`=`Gene`.`organism`\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Gene`";

  const char access::object_traits_impl< ::UniPAX::Gene, id_mysql >::table_name[] =
  "`Gene`";
  ...
  access::object_traits_impl< ::UniPAX::Gene, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Gene, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Gene, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Gene, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Gene, id_mysql >::
