...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::Math, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ...
    if (t[2UL])
    {
      i.mathML_value.capacity (i.mathML_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.mathML_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.mathML_value.capacity ());
    b[n].length = &i.mathML_size;
    b[n].is_null = &i.mathML_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.mathML_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.mathML_value,
        ...
        is_null,
        v);
      i.mathML_null = is_null;
      i.mathML_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.mathML_value.capacity ());
    }
  ...
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Math, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::info (
    typeid (::UniPAX::Math),
    0,
    0,
    "UniPAX::Math",
    &odb::create_impl< ::UniPAX::Math >,
    &odb::dispatch_impl< ::UniPAX::Math, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Math, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Math;

  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::persist_statement[] =
  "INSERT INTO `Math` "
  "(`unipaxId`, "
  "`typeid`, "
  "`mathML`) "
  ...
  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::find_statement[] =
  "SELECT "
  "`Math`.`unipaxId`, "
  "`Math`.`typeid`, "
  "`Math`.`mathML` "
  ...
  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::update_statement[] =
  "UPDATE `Math` "
  "SET "
  "`mathML`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::erase_statement[] =
  "DELETE FROM `Math` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::query_statement[] =
  "SELECT "
  "`Math`.`unipaxId`, "
  "`Math`.`typeid`, "
  "`Math`.`mathML` "
  ...
  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Math`";

  const char access::object_traits_impl< ::UniPAX::Math, id_mysql >::table_name[] =
  "`Math`";
  ...
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Math, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Math, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Math, id_mysql >::
