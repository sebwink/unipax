...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::discriminator_type
  ...
  bool access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer_length = static_cast<unsigned long> (
      i.message_value.capacity ());
    b[n].length = &i.message_size;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      i.message_size = static_cast<unsigned long> (size);
  ...
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::info (
    typeid (::UniPAX::Constraint),
    0,
    0,
    "UniPAX::Constraint",
    &odb::create_impl< ::UniPAX::Constraint >,
    &odb::dispatch_impl< ::UniPAX::Constraint, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Constraint;

  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::find_statement[] =
  "SELECT "
  "`Constraint`.`unipaxId`, "
  "`Constraint`.`unipaxSource`, "
  "`Constraint`.`metaId`, "
  "`Constraint`.`sboTerm`, "
  "`Constraint`.`notes`, "
  ...
  "`Constraint`.`message` "
  "FROM `Constraint` "
  "WHERE `Constraint`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::update_statement[] =
  "UPDATE `Constraint` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::erase_statement[] =
  "DELETE FROM `Constraint` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Constraint`.`unipaxId`,\n"
  "`Constraint`.`unipaxSource`,\n"
  "`Constraint`.`metaId`,\n"
  ...
  "`Constraint`.`message`\n"
  "FROM `Constraint`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Constraint`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`Constraint`.`math`";

  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Constraint`";

  const char access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::table_name[] =
  "`Constraint`";
  ...
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Constraint, id_mysql >::
