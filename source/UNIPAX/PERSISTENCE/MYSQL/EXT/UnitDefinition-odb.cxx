...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< unit_traits > unit;
  ...
  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::unit_traits::
  select_statement[] =
  "SELECT "
  "`UnitDefinition_unit`.`index`, "
  "`UnitDefinition_unit`.`value` "
  "FROM `UnitDefinition_unit` "
  "WHERE `UnitDefinition_unit`.`object_id`=? ORDER BY `UnitDefinition_unit`.`index`";
  ...
  void access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::unit_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::unit_traits::
  ...
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::info (
    typeid (::UniPAX::UnitDefinition),
    0,
    0,
    "UniPAX::UnitDefinition",
    &odb::create_impl< ::UniPAX::UnitDefinition >,
    &odb::dispatch_impl< ::UniPAX::UnitDefinition, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_UnitDefinition;

  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::find_statement[] =
  "SELECT "
  ...
  "`UnitDefinition`.`typeid`, "
  "`UnitDefinition`.`id`, "
  "`UnitDefinition`.`name` "
  "FROM `UnitDefinition` "
  "WHERE `UnitDefinition`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::erase_statement[] =
  "DELETE FROM `UnitDefinition` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::query_statement[] =
  "SELECT\n"
  "`UnitDefinition`.`unipaxId`,\n"
  "`UnitDefinition`.`unipaxSource`,\n"
  "`UnitDefinition`.`metaId`,\n"
  ...
  "`UnitDefinition`.`name`\n"
  "FROM `UnitDefinition`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`UnitDefinition`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::erase_query_statement[] =
  "DELETE FROM `UnitDefinition`";

  const char access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::table_name[] =
  "`UnitDefinition`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::Unit > > const& v =
        obj.unit;
  ...
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
         ...
         bool reload)
  {
    ...
    //
    {
      ::std::vector< ::boost::shared_ptr< ::UniPAX::Unit > >& v =
        obj.unit;
  ...
  result< access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::UnitDefinition, id_mysql >::
