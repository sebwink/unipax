...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = &i.initialValue_value;
    b[n].is_null = &i.initialValue_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.initialValue_value, is_null, v);
      i.initialValue_null = is_null;
    }
  ...
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::info (
    typeid (::UniPAX::Trigger),
    0,
    0,
    "UniPAX::Trigger",
    &odb::create_impl< ::UniPAX::Trigger >,
    &odb::dispatch_impl< ::UniPAX::Trigger, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Trigger;

  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::persist_statement[] =
  "INSERT INTO `Trigger` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::find_statement[] =
  "SELECT "
  "`Trigger`.`unipaxId`, "
  "`Trigger`.`unipaxSource`, "
  "`Trigger`.`metaId`, "
  "`Trigger`.`sboTerm`, "
  "`Trigger`.`notes`, "
  "`Trigger`.`annotation`, "
  ...
  "`Trigger`.`math` "
  "FROM `Trigger` "
  "WHERE `Trigger`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::update_statement[] =
  "UPDATE `Trigger` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::erase_statement[] =
  "DELETE FROM `Trigger` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Trigger`.`unipaxId`,\n"
  "`Trigger`.`unipaxSource`,\n"
  "`Trigger`.`metaId`,\n"
  ...
  "`Trigger`.`math`\n"
  "FROM `Trigger`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Trigger`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`Trigger`.`math`";

  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Trigger`";

  const char access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::table_name[] =
  "`Trigger`";
  ...
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Trigger, id_mysql >::
