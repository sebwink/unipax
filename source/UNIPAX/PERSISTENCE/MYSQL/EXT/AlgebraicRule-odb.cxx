...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::info (
    typeid (::UniPAX::AlgebraicRule),
    &object_traits_impl< ::UniPAX::Rule, id_mysql >::info,
    0,
    "UniPAX::AlgebraicRule",
    &odb::create_impl< ::UniPAX::AlgebraicRule >,
    &odb::dispatch_impl< ::UniPAX::AlgebraicRule, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_AlgebraicRule;

  const char access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::persist_statement[] =
  "INSERT INTO `AlgebraicRule` "
  "(`unipaxId`) "
  "VALUES "
  "(?)";

  const char* const access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::find_statements[] =
  {
    "SELECT "
    "`Rule`.`unipaxId`, "
    "`Rule`.`unipaxSource`, "
    ...
    "`Rule`.`math` "
    "FROM `AlgebraicRule` "
    "LEFT JOIN `Rule` ON `Rule`.`unipaxId`=`AlgebraicRule`.`unipaxId` "
    "WHERE `AlgebraicRule`.`unipaxId`=?",

    ""
  };

  const std::size_t access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::find_column_counts[] =
  {
    8UL,
    0UL
  };

  const char access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::erase_statement[] =
  "DELETE FROM `AlgebraicRule` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Rule`.`unipaxId`,\n"
  "`Rule`.`unipaxSource`,\n"
  "`Rule`.`metaId`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::erase_query_statement[] =
  "DELETE FROM `AlgebraicRule`";

  const char access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::table_name[] =
  "`AlgebraicRule`";
  ...
  access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >::
