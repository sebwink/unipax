...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Priority, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::Priority, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Priority, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::info (
    typeid (::UniPAX::Priority),
    0,
    0,
    "UniPAX::Priority",
    &odb::create_impl< ::UniPAX::Priority >,
    &odb::dispatch_impl< ::UniPAX::Priority, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Priority, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Priority;

  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::find_statement[] =
  "SELECT "
  "`Priority`.`unipaxId`, "
  "`Priority`.`unipaxSource`, "
  "`Priority`.`metaId`, "
  "`Priority`.`sboTerm`, "
  "`Priority`.`notes`, "
  "`Priority`.`annotation`, "
  ...
  "`Priority`.`math` "
  "FROM `Priority` "
  "WHERE `Priority`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::update_statement[] =
  "UPDATE `Priority` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::erase_statement[] =
  "DELETE FROM `Priority` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Priority`.`unipaxId`,\n"
  "`Priority`.`unipaxSource`,\n"
  "`Priority`.`metaId`,\n"
  ...
  "`Priority`.`math`\n"
  "FROM `Priority`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Priority`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`Priority`.`math`";

  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Priority`";

  const char access::object_traits_impl< ::UniPAX::Priority, id_mysql >::table_name[] =
  "`Priority`";
  ...
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Priority, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Priority, id_mysql >::
