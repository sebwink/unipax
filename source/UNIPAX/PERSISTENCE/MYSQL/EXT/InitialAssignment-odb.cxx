...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::info (
    typeid (::UniPAX::InitialAssignment),
    0,
    0,
    "UniPAX::InitialAssignment",
    &odb::create_impl< ::UniPAX::InitialAssignment >,
    &odb::dispatch_impl< ::UniPAX::InitialAssignment, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_InitialAssignment;

  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::find_statement[] =
  "SELECT "
  ...
  "`InitialAssignment`.`typeid`, "
  "`InitialAssignment`.`symbol`, "
  "`InitialAssignment`.`math` "
  "FROM `InitialAssignment` "
  "WHERE `InitialAssignment`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::update_statement[] =
  "UPDATE `InitialAssignment` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  "`sboTerm`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::erase_statement[] =
  "DELETE FROM `InitialAssignment` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::query_statement[] =
  "SELECT\n"
  "`InitialAssignment`.`unipaxId`,\n"
  "`InitialAssignment`.`unipaxSource`,\n"
  "`InitialAssignment`.`metaId`,\n"
  ...
  "`InitialAssignment`.`math`\n"
  "FROM `InitialAssignment`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`InitialAssignment`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`InitialAssignment`.`math`";

  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::erase_query_statement[] =
  "DELETE FROM `InitialAssignment`";

  const char access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::table_name[] =
  "`InitialAssignment`";
  ...
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::InitialAssignment, id_mysql >::
