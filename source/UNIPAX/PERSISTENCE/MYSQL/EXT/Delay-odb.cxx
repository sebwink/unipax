...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Delay, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::Delay, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Delay, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::info (
    typeid (::UniPAX::Delay),
    0,
    0,
    "UniPAX::Delay",
    &odb::create_impl< ::UniPAX::Delay >,
    &odb::dispatch_impl< ::UniPAX::Delay, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Delay, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Delay;

  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::persist_statement[] =
  "INSERT INTO `Delay` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::find_statement[] =
  "SELECT "
  "`Delay`.`unipaxId`, "
  "`Delay`.`unipaxSource`, "
  "`Delay`.`metaId`, "
  ...
  "`Delay`.`math` "
  "FROM `Delay` "
  "WHERE `Delay`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::update_statement[] =
  "UPDATE `Delay` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::erase_statement[] =
  "DELETE FROM `Delay` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Delay`.`unipaxId`,\n"
  "`Delay`.`unipaxSource`,\n"
  "`Delay`.`metaId`,\n"
  ...
  "`Delay`.`math`\n"
  "FROM `Delay`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Delay`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`Delay`.`math`";

  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Delay`";

  const char access::object_traits_impl< ::UniPAX::Delay, id_mysql >::table_name[] =
  "`Delay`";
  ...
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Delay, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Delay, id_mysql >::
