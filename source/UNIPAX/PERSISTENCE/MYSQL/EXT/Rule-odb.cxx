...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Rule, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::Rule, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Rule, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::info (
    typeid (::UniPAX::Rule),
    0,
    0,
    "UniPAX::Rule",
    &odb::create_impl< ::UniPAX::Rule >,
    &odb::dispatch_impl< ::UniPAX::Rule, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Rule, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Rule;

  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::persist_statement[] =
  "INSERT INTO `Rule` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::find_statement[] =
  "SELECT "
  "`Rule`.`unipaxId`, "
  "`Rule`.`unipaxSource`, "
  "`Rule`.`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::update_statement[] =
  "UPDATE `Rule` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::erase_statement[] =
  "DELETE FROM `Rule` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Rule`.`unipaxId`,\n"
  "`Rule`.`unipaxSource`,\n"
  "`Rule`.`metaId`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Rule`";

  const char access::object_traits_impl< ::UniPAX::Rule, id_mysql >::table_name[] =
  "`Rule`";
  ...
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Rule, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Rule, id_mysql >::
