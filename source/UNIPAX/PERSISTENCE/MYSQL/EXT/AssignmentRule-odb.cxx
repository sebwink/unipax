...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  void access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
  ...
  const access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::info (
    typeid (::UniPAX::AssignmentRule),
    &object_traits_impl< ::UniPAX::Rule, id_mysql >::info,
    0,
    "UniPAX::AssignmentRule",
    &odb::create_impl< ::UniPAX::AssignmentRule >,
    &odb::dispatch_impl< ::UniPAX::AssignmentRule, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_AssignmentRule;

  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::persist_statement[] =
  ...
  const char* const access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::find_statements[] =
  {
    "SELECT "
    ...
    "`Rule`.`math` "
    "FROM `AssignmentRule` "
    "LEFT JOIN `Rule` ON `Rule`.`unipaxId`=`AssignmentRule`.`unipaxId` "
    "WHERE `AssignmentRule`.`unipaxId`=?",
  ...
  const std::size_t access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::find_column_counts[] =
  {
    9UL,
    1UL
  };

  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::update_statement[] =
  "UPDATE `AssignmentRule` "
  "SET "
  "`variable`=? "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::erase_statement[] =
  "DELETE FROM `AssignmentRule` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::query_statement[] =
  "SELECT\n"
  "`AssignmentRule`.`variable`,\n"
  "`Rule`.`unipaxId`,\n"
  "`Rule`.`unipaxSource`,\n"
  ...
  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::erase_query_statement[] =
  "DELETE FROM `AssignmentRule`";

  const char access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::table_name[] =
  "`AssignmentRule`";
  ...
  access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >::
