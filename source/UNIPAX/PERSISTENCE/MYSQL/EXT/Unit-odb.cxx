...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::UnitDefinition,
    id_mysql,
    access::object_traits_impl< ::UniPAX::Unit, id_mysql >::unitDefinition_tag>::
  table_name[] = "`unitDefinition_UnitDefinition`";

  struct access::object_traits_impl< ::UniPAX::Unit, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ...
    if (t[8UL])
    {
      i.kind_value.capacity (i.kind_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].is_null = &i.exponent_null;
    n++;

    // kind
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.kind_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.kind_value.capacity ());
    b[n].length = &i.kind_size;
    b[n].is_null = &i.kind_null;
    n++;
    ...
    b[n].is_null = &i.unitDefinition_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.exponent_value, is_null, v);
      i.exponent_null = is_null;
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.kind_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.kind_value,
        ...
        v);
      i.kind_null = is_null;
      i.kind_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.kind_value.capacity ());
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.multiplier_value, is_null, v);
      i.multiplier_null = is_null;
    }
    ...
    //
    {
      ...
      mysql::value_traits<
          double,
          mysql::id_double >::set_image (
        i.scale_value, is_null, v);
      i.scale_null = is_null;
    }

    // unitDefinition
    //
    {
      ::boost::shared_ptr< ::UniPAX::UnitDefinition > const& v =
        o.unitDefinition;

      typedef object_traits< ::UniPAX::UnitDefinition > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::UnitDefinition > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
          ...
          i.unitDefinition_value, is_null, id);
        i.unitDefinition_null = is_null;
      }
      else
        i.unitDefinition_null = 1;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::UnitDefinition >& v =
        o.unitDefinition;

      typedef object_traits< ::UniPAX::UnitDefinition > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::UnitDefinition > > ptr_traits;

      if (i.unitDefinition_null)
  ...
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::Unit, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::info (
    typeid (::UniPAX::Unit),
    0,
    0,
    "UniPAX::Unit",
    &odb::create_impl< ::UniPAX::Unit >,
    &odb::dispatch_impl< ::UniPAX::Unit, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::Unit, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_Unit;

  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::persist_statement[] =
  "INSERT INTO `Unit` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::find_statement[] =
  "SELECT "
  "`Unit`.`unipaxId`, "
  "`Unit`.`unipaxSource`, "
  "`Unit`.`metaId`, "
  ...
  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::update_statement[] =
  "UPDATE `Unit` "
  "SET "
  "`unipaxSource`=?, "
  "`metaId`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::erase_statement[] =
  "DELETE FROM `Unit` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::query_statement[] =
  "SELECT\n"
  "`Unit`.`unipaxId`,\n"
  "`Unit`.`unipaxSource`,\n"
  "`Unit`.`metaId`,\n"
  ...
  "`Unit`.`unitDefinition`\n"
  "FROM `Unit`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`Unit`.`unipaxSource`\n"
  "LEFT JOIN `UnitDefinition` AS `unitDefinition_UnitDefinition` ON `unitDefinition_UnitDefinition`.`unipaxId`=`Unit`.`unitDefinition`";

  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Unit`";

  const char access::object_traits_impl< ::UniPAX::Unit, id_mysql >::table_name[] =
  "`Unit`";
  ...
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::Unit, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::Unit, id_mysql >::
