...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Series,
    id_mysql,
    access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::data_series_tag>::
  table_name[] = "`data_series`";

  struct access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::extra_statement_cache_type
  {
    mysql::container_statements_impl< object_ids_blobs_traits > object_ids_blobs;
  ...
  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_ids_blobs_traits::
  select_statement[] =
  "SELECT "
  "`ResultObject_object_ids_blobs`.`index`, "
  "`ResultObject_object_ids_blobs`.`value` "
  "FROM `ResultObject_object_ids_blobs` "
  "WHERE `ResultObject_object_ids_blobs`.`object_id`=? ORDER BY `ResultObject_object_ids_blobs`.`index`";

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_ids_blobs_traits::
  insert_statement[] =
  "INSERT INTO `ResultObject_object_ids_blobs` "
  "(`object_id`, "
  "`index`, "
  "`value`) "
  "VALUES "
  ...
  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_ids_blobs_traits::
  delete_statement[] =
  "DELETE FROM `ResultObject_object_ids_blobs` "
  "WHERE `object_id`=?";

  void access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_ids_blobs_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_ids_blobs_traits::
  ...
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ...
    if (t[3UL])
    {
      i.constituting_query_value.capacity (i.constituting_query_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.constituting_query_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.constituting_query_value.capacity ());
    b[n].length = &i.constituting_query_size;
    b[n].is_null = &i.constituting_query_null;
    n++;

    // creation_time
    //
    b[n].buffer_type = MYSQL_TYPE_TIMESTAMP;
    b[n].buffer = &i.creation_time_value;
    b[n].is_null = &i.creation_time_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.data_series_value;
    b[n].is_null = &i.data_series_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    {
      ::std::string const& v =
        o.constituting_query;

      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.constituting_query_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.constituting_query_value,
        size,
        is_null,
        v);
      i.constituting_query_null = is_null;
      i.constituting_query_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.constituting_query_value.capacity ());
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i.creation_time_value, is_null, v);
      i.creation_time_null = is_null;
    }

    // data_series
    //
    {
      ::boost::shared_ptr< ::UniPAX::Series > const& v =
        o.data_series;

      typedef object_traits< ::UniPAX::Series > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::Series > > ptr_traits;
      ...
      if (!is_null)
      {
        ...
        mysql::value_traits<
            obj_traits::id_type,
            mysql::id_ulonglong >::set_image (
          i.data_series_value, is_null, id);
        i.data_series_null = is_null;
      }
      else
        i.data_series_null = 1;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        v,
        i.constituting_query_value,
        i.constituting_query_size,
        i.constituting_query_null);
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        v,
        i.creation_time_value,
        i.creation_time_null);
    }

    // data_series
    //
    {
      ::boost::shared_ptr< ::UniPAX::Series >& v =
        o.data_series;

      typedef object_traits< ::UniPAX::Series > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::Series > > ptr_traits;

      if (i.data_series_null)
  ...
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::info (
    typeid (::UniPAX::ResultObject),
    0,
    0,
    "UniPAX::ResultObject",
    &odb::create_impl< ::UniPAX::ResultObject >,
    &odb::dispatch_impl< ::UniPAX::ResultObject, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_ResultObject;

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::persist_statement[] =
  "INSERT INTO `ResultObject` "
  "(`unipaxId`, "
  "`typeid`, "
  "`description`, "
  "`constituting_query`, "
  ...
  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::find_statement[] =
  "SELECT "
  "`ResultObject`.`unipaxId`, "
  "`ResultObject`.`typeid`, "
  "`ResultObject`.`description`, "
  "`ResultObject`.`constituting_query`, "
  "`ResultObject`.`creation_time`, "
  "`ResultObject`.`data_series`, "
  "`ResultObject`.`size` "
  "FROM `ResultObject` "
  "WHERE `ResultObject`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::update_statement[] =
  "UPDATE `ResultObject` "
  "SET "
  "`description`=?, "
  "`constituting_query`=?, "
  ...
  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::erase_statement[] =
  "DELETE FROM `ResultObject` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::query_statement[] =
  "SELECT\n"
  "`ResultObject`.`unipaxId`,\n"
  "`ResultObject`.`typeid`,\n"
  "`ResultObject`.`description`,\n"
  ...
  "`ResultObject`.`size`\n"
  "FROM `ResultObject`\n"
  "LEFT JOIN `Series` AS `data_series` ON `data_series`.`unipaxId`=`ResultObject`.`data_series`";

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::erase_query_statement[] =
  "DELETE FROM `ResultObject`";

  const char access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::table_name[] =
  "`ResultObject`";
  ...
  persist (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ::std::vector< ::std::vector< char > > const& v =
        obj.object_ids_blobs;

      object_ids_blobs_traits::persist (
        v,
        esc.object_ids_blobs);
    }
  ...
  update (database& db, const object_type& obj, bool top, bool dyn)
  {
    ...
    //
    {
      ...
      object_ids_blobs_traits::update (
        v,
        esc.object_ids_blobs);
    }
  ...
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::ResultObject, id_mysql >::
