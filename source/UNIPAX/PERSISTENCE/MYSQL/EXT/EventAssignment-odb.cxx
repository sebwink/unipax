...
namespace odb
{
  ...
  const char alias_traits<  ::UniPAX::Math,
    id_mysql,
    access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::math_tag>::
  table_name[] = "`math_Math`";

  struct access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::Math > const& v =
        o.math;

      typedef object_traits< ::UniPAX::Math > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::UniPAX::Math > > ptr_traits;
        ...
        database* db)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::UniPAX::Math >& v =
        o.math;
  ...
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::info (
    typeid (::UniPAX::EventAssignment),
    0,
    0,
    "UniPAX::EventAssignment",
    &odb::create_impl< ::UniPAX::EventAssignment >,
    &odb::dispatch_impl< ::UniPAX::EventAssignment, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_EventAssignment;

  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::persist_statement[] =
  "INSERT INTO `EventAssignment` "
  "(`unipaxId`, "
  "`unipaxSource`, "
  "`metaId`, "
  "`sboTerm`, "
  ...
  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::find_statement[] =
  "SELECT "
  "`EventAssignment`.`unipaxId`, "
  "`EventAssignment`.`unipaxSource`, "
  "`EventAssignment`.`metaId`, "
  "`EventAssignment`.`sboTerm`, "
  "`EventAssignment`.`notes`, "
  "`EventAssignment`.`annotation`, "
  "`EventAssignment`.`typeid`, "
  "`EventAssignment`.`variable`, "
  "`EventAssignment`.`math` "
  "FROM `EventAssignment` "
  "WHERE `EventAssignment`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::erase_statement[] =
  "DELETE FROM `EventAssignment` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::query_statement[] =
  "SELECT\n"
  "`EventAssignment`.`unipaxId`,\n"
  "`EventAssignment`.`unipaxSource`,\n"
  "`EventAssignment`.`metaId`,\n"
  ...
  "`EventAssignment`.`math`\n"
  "FROM `EventAssignment`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`EventAssignment`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`EventAssignment`.`math`";

  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::erase_query_statement[] =
  "DELETE FROM `EventAssignment`";

  const char access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::table_name[] =
  "`EventAssignment`";
  ...
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >::
