...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::info (
    typeid (::UniPAX::LocalParameter),
    0,
    0,
    "UniPAX::LocalParameter",
    &odb::create_impl< ::UniPAX::LocalParameter >,
    &odb::dispatch_impl< ::UniPAX::LocalParameter, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_LocalParameter;

  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::find_statement[] =
  "SELECT "
  ...
  "`LocalParameter`.`typeid`, "
  "`LocalParameter`.`id`, "
  "`LocalParameter`.`name`, "
  "`LocalParameter`.`value`, "
  "`LocalParameter`.`unit` "
  "FROM `LocalParameter` "
  "WHERE `LocalParameter`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::erase_statement[] =
  "DELETE FROM `LocalParameter` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::query_statement[] =
  "SELECT\n"
  "`LocalParameter`.`unipaxId`,\n"
  "`LocalParameter`.`unipaxSource`,\n"
  "`LocalParameter`.`metaId`,\n"
  ...
  "`LocalParameter`.`unit`\n"
  "FROM `LocalParameter`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`LocalParameter`.`unipaxSource`";

  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::erase_query_statement[] =
  "DELETE FROM `LocalParameter`";

  const char access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::table_name[] =
  "`LocalParameter`";
  ...
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >::
