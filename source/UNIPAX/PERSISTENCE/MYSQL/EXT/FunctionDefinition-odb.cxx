...
namespace odb
{
  ...
  struct access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::discriminator_type
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  ...
  bool access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::map_type*
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::map;

  const access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::info_type
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::info (
    typeid (::UniPAX::FunctionDefinition),
    0,
    0,
    "UniPAX::FunctionDefinition",
    &odb::create_impl< ::UniPAX::FunctionDefinition >,
    &odb::dispatch_impl< ::UniPAX::FunctionDefinition, id_mysql >,
    0);

  static const access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::entry_type
  polymorphic_entry_for_UniPAX_FunctionDefinition;

  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::find_statement[] =
  "SELECT "
  ...
  "`FunctionDefinition`.`typeid`, "
  "`FunctionDefinition`.`id`, "
  "`FunctionDefinition`.`name`, "
  "`FunctionDefinition`.`math` "
  "FROM `FunctionDefinition` "
  "WHERE `FunctionDefinition`.`unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  ...
  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::erase_statement[] =
  "DELETE FROM `FunctionDefinition` "
  "WHERE `unipaxId`=?";

  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::query_statement[] =
  "SELECT\n"
  "`FunctionDefinition`.`unipaxId`,\n"
  "`FunctionDefinition`.`unipaxSource`,\n"
  "`FunctionDefinition`.`metaId`,\n"
  ...
  "`FunctionDefinition`.`math`\n"
  "FROM `FunctionDefinition`\n"
  "LEFT JOIN `ImportSource` AS `unipaxSource_ImportSource` ON `unipaxSource_ImportSource`.`unipaxId`=`FunctionDefinition`.`unipaxSource`\n"
  "LEFT JOIN `Math` AS `math_Math` ON `math_Math`.`unipaxId`=`FunctionDefinition`.`math`";

  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::erase_query_statement[] =
  "DELETE FROM `FunctionDefinition`";

  const char access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::table_name[] =
  "`FunctionDefinition`";
  ...
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::pointer_type
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  ...
  result< access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::object_type >
  access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::UniPAX::FunctionDefinition, id_mysql >::
