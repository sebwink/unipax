...
namespace odb
{
  ...
  const char query_columns_base< ::UniPAX::EventAssignment >::math_alias_[] = "\"math\"";

  void access::object_traits< ::UniPAX::EventAssignment >::
  ...
  bool access::object_traits< ::UniPAX::EventAssignment >::
  ...
  struct access::object_traits< ::UniPAX::EventAssignment >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::EventAssignment >::persist_statement[] =
  ...
  const char access::object_traits< ::UniPAX::EventAssignment >::find_statement[] =
  "SELECT "
  ...
  " WHERE \"EventAssignment\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::EventAssignment >::update_statement[] =
  "UPDATE \"EventAssignment\" SET "
  "\"unipaxSource\"=:1,"
  "\"metaId\"=:2,"
  "\"sboTerm\"=:3,"
  "\"notes\"=:4,"
  ...
  const char access::object_traits< ::UniPAX::EventAssignment >::erase_statement[] =
  "DELETE FROM \"EventAssignment\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::EventAssignment >::query_statement[] =
  "SELECT "
  "\"EventAssignment\".\"unipaxId\","
  "\"EventAssignment\".\"unipaxSource\","
  "\"EventAssignment\".\"metaId\","
  ...
  "\"EventAssignment\".\"math\""
  " FROM \"EventAssignment\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"EventAssignment\".\"unipaxSource\""
  " LEFT JOIN \"Math\" \"math\" ON \"math\".\"unipaxId\" = \"EventAssignment\".\"math\""
  " ";

  const char access::object_traits< ::UniPAX::EventAssignment >::erase_query_statement[] =
  "DELETE FROM \"EventAssignment\""
  " ";

  const char access::object_traits< ::UniPAX::EventAssignment >::table_name[] =
  "\"EventAssignment\"";
  ...
  access::object_traits< ::UniPAX::EventAssignment >::pointer_type
  access::object_traits< ::UniPAX::EventAssignment >::
  ...
  result< access::object_traits< ::UniPAX::EventAssignment >::object_type >
  access::object_traits< ::UniPAX::EventAssignment >::
  ...
  unsigned long long access::object_traits< ::UniPAX::EventAssignment >::
