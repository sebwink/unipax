...
namespace odb
{
  ...
  const char query_columns_base< ::UniPAX::Delay >::math_alias_[] = "\"math\"";
  ...
  bool access::object_traits< ::UniPAX::Delay >::
  ...
  struct access::object_traits< ::UniPAX::Delay >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::Delay >::persist_statement[] =
  "INSERT INTO \"Delay\" ("
  "\"unipaxId\","
  "\"unipaxSource\","
  "\"metaId\","
  ...
  const char access::object_traits< ::UniPAX::Delay >::find_statement[] =
  "SELECT "
  "\"Delay\".\"unipaxId\","
  "\"Delay\".\"unipaxSource\","
  "\"Delay\".\"metaId\","
  ...
  "\"Delay\".\"math\""
  " FROM \"Delay\""
  " WHERE \"Delay\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Delay >::update_statement[] =
  "UPDATE \"Delay\" SET "
  "\"unipaxSource\"=:1,"
  "\"metaId\"=:2,"
  "\"sboTerm\"=:3,"
  ...
  const char access::object_traits< ::UniPAX::Delay >::erase_statement[] =
  "DELETE FROM \"Delay\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Delay >::query_statement[] =
  "SELECT "
  "\"Delay\".\"unipaxId\","
  "\"Delay\".\"unipaxSource\","
  "\"Delay\".\"metaId\","
  ...
  "\"Delay\".\"math\""
  " FROM \"Delay\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"Delay\".\"unipaxSource\""
  " LEFT JOIN \"Math\" \"math\" ON \"math\".\"unipaxId\" = \"Delay\".\"math\""
  " ";

  const char access::object_traits< ::UniPAX::Delay >::erase_query_statement[] =
  "DELETE FROM \"Delay\""
  " ";

  const char access::object_traits< ::UniPAX::Delay >::table_name[] =
  "\"Delay\"";
  ...
  access::object_traits< ::UniPAX::Delay >::pointer_type
  ...
  result< access::object_traits< ::UniPAX::Delay >::object_type >
  access::object_traits< ::UniPAX::Delay >::
  ...
  unsigned long long access::object_traits< ::UniPAX::Delay >::
