...
namespace odb
{
  ...
  const char access::object_traits< ::UniPAX::KineticLaw >::localParameter_traits::select_all_statement[] =
  "SELECT "
  "\"KineticLaw_localParameter\".\"index\","
  "\"KineticLaw_localParameter\".\"value\""
  " FROM \"KineticLaw_localParameter\" WHERE \"KineticLaw_localParameter\".\"object_id\"=:1"
  " ORDER BY \"KineticLaw_localParameter\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::KineticLaw >::localParameter_traits::insert_one_statement[] =
  ...
  const char access::object_traits< ::UniPAX::KineticLaw >::localParameter_traits::delete_all_statement[] =
  "DELETE FROM \"KineticLaw_localParameter\""
  " WHERE \"object_id\"=:1";

  void access::object_traits< ::UniPAX::KineticLaw >::localParameter_traits::
  bind (oracle::bind* b,
  ...
  bool access::object_traits< ::UniPAX::KineticLaw >::localParameter_traits::
  ...
  bind (oracle::bind* b, image_type& i, oracle::statement_kind sk)
  {
    ...
    //
    b[n].type = oracle::bind::number;
    b[n].buffer = i.id_conversion_value;
    b[n].capacity = static_cast<ub4> (sizeof (i.id_conversion_value));
    b[n].size = &i.id_conversion_size;
    b[n].indicator = &i.id_conversion_indicator;
    n++;
  }

  bool access::object_traits< ::UniPAX::KineticLaw >::
  init (image_type& i, const object_type& o, oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
          ...
          oracle::id_big_int >::set_image (
        i.id_conversion_value,
        size,
        is_null,
        o.id_conversion);
      i.id_conversion_size = static_cast<ub2> (size);
      i.id_conversion_indicator = is_null ? -1 : 0;
    }
  ...
  init (object_type& o, const image_type& i, database& db)
  {
    ...
    oracle::value_traits<
      ...
      o.id_conversion,
      i.id_conversion_value,
      i.id_conversion_size,
      i.id_conversion_indicator == -1);
  }

  struct access::object_traits< ::UniPAX::KineticLaw >::container_statement_cache_type
  {
    oracle::container_statements_impl< localParameter_traits > localParameter;
  ...
  const char access::object_traits< ::UniPAX::KineticLaw >::persist_statement[] =
  ...
  const char access::object_traits< ::UniPAX::KineticLaw >::find_statement[] =
  "SELECT "
  "\"KineticLaw\".\"unipaxId\","
  ...
  "\"KineticLaw\".\"id_conversion\""
  " FROM \"KineticLaw\""
  " WHERE \"KineticLaw\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::KineticLaw >::update_statement[] =
  "UPDATE \"KineticLaw\" SET "
  "\"unipaxSource\"=:1,"
  "\"metaId\"=:2,"
  "\"sboTerm\"=:3,"
  "\"notes\"=:4,"
  ...
  const char access::object_traits< ::UniPAX::KineticLaw >::erase_statement[] =
  "DELETE FROM \"KineticLaw\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::KineticLaw >::query_statement[] =
  "SELECT "
  "\"KineticLaw\".\"unipaxId\","
  "\"KineticLaw\".\"unipaxSource\","
  "\"KineticLaw\".\"metaId\","
  ...
  "\"KineticLaw\".\"id_conversion\""
  " FROM \"KineticLaw\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"KineticLaw\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::KineticLaw >::erase_query_statement[] =
  "DELETE FROM \"KineticLaw\""
  " ";

  const char access::object_traits< ::UniPAX::KineticLaw >::table_name[] =
  "\"KineticLaw\"";
  ...
  persist (database&, const object_type& obj)
  {
    ...
    localParameter_traits::persist (
      obj.localParameter,
      idb,
      sts.container_statment_cache ().localParameter);
  }
  ...
  access::object_traits< ::UniPAX::KineticLaw >::pointer_type
  ...
  result< access::object_traits< ::UniPAX::KineticLaw >::object_type >
  access::object_traits< ::UniPAX::KineticLaw >::
  ...
  unsigned long long access::object_traits< ::UniPAX::KineticLaw >::
