...
namespace odb
{
  ...
  const char query_columns_base< ::UniPAX::Trigger >::math_alias_[] = "\"math\"";

  void access::object_traits< ::UniPAX::Trigger >::
  bind (oracle::bind* b, image_type& i, oracle::statement_kind sk)
  {
    ...
    b[n].capacity = 8;
    b[n].size = 0;
    b[n].indicator = &i.initialValue_indicator;
    n++;
    ...
    b[n].capacity = 4;
    b[n].size = 0;
    b[n].indicator = &i.persistent_indicator;
    n++;
  ...
  bool access::object_traits< ::UniPAX::Trigger >::
  init (image_type& i, const object_type& o, oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        i.initialValue_value, is_null, o.initialValue);
      i.initialValue_indicator = is_null ? -1 : 0;
    }
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        i.persistent_value, is_null, o.persistent);
      i.persistent_indicator = is_null ? -1 : 0;
    }
  ...
  struct access::object_traits< ::UniPAX::Trigger >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::Trigger >::persist_statement[] =
  "INSERT INTO \"Trigger\" ("
  "\"unipaxId\","
  "\"unipaxSource\","
  "\"metaId\","
  ...
  const char access::object_traits< ::UniPAX::Trigger >::find_statement[] =
  "SELECT "
  "\"Trigger\".\"unipaxId\","
  ...
  "\"Trigger\".\"math\""
  " FROM \"Trigger\""
  " WHERE \"Trigger\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Trigger >::update_statement[] =
  "UPDATE \"Trigger\" SET "
  "\"unipaxSource\"=:1,"
  "\"metaId\"=:2,"
  "\"sboTerm\"=:3,"
  ...
  const char access::object_traits< ::UniPAX::Trigger >::erase_statement[] =
  "DELETE FROM \"Trigger\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Trigger >::query_statement[] =
  "SELECT "
  "\"Trigger\".\"unipaxId\","
  "\"Trigger\".\"unipaxSource\","
  "\"Trigger\".\"metaId\","
  ...
  "\"Trigger\".\"math\""
  " FROM \"Trigger\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"Trigger\".\"unipaxSource\""
  " LEFT JOIN \"Math\" \"math\" ON \"math\".\"unipaxId\" = \"Trigger\".\"math\""
  " ";

  const char access::object_traits< ::UniPAX::Trigger >::erase_query_statement[] =
  "DELETE FROM \"Trigger\""
  " ";

  const char access::object_traits< ::UniPAX::Trigger >::table_name[] =
  "\"Trigger\"";
  ...
  access::object_traits< ::UniPAX::Trigger >::pointer_type
  access::object_traits< ::UniPAX::Trigger >::
  ...
  result< access::object_traits< ::UniPAX::Trigger >::object_type >
  access::object_traits< ::UniPAX::Trigger >::
  ...
  unsigned long long access::object_traits< ::UniPAX::Trigger >::
