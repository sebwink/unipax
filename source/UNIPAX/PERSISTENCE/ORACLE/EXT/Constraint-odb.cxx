...
namespace odb
{
  ...
  const char query_columns_base< ::UniPAX::Constraint >::math_alias_[] = "\"math\"";
  ...
  bind (oracle::bind* b, image_type& i, oracle::statement_kind sk)
  {
    ...
    b[n].buffer = i.message_value;
    b[n].capacity = static_cast<ub4> (sizeof (i.message_value));
    b[n].size = &i.message_size;
    b[n].indicator = &i.message_indicator;
    n++;
  }

  bool access::object_traits< ::UniPAX::Constraint >::
  init (image_type& i, const object_type& o, oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        i.message_value,
        sizeof (i.message_value),
        size,
        is_null,
        o.message);
      i.message_size = static_cast<ub2> (size);
      i.message_indicator = is_null ? -1 : 0;
    }
  ...
  init (object_type& o, const image_type& i, database& db)
  {
    ...
    oracle::value_traits<
      ...
      i.message_value,
      i.message_size,
      i.message_indicator == -1);
  }

  struct access::object_traits< ::UniPAX::Constraint >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::Constraint >::persist_statement[] =
  ...
  const char access::object_traits< ::UniPAX::Constraint >::find_statement[] =
  "SELECT "
  "\"Constraint\".\"unipaxId\","
  ...
  "\"Constraint\".\"message\""
  " FROM \"Constraint\""
  " WHERE \"Constraint\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Constraint >::update_statement[] =
  ...
  const char access::object_traits< ::UniPAX::Constraint >::erase_statement[] =
  "DELETE FROM \"Constraint\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Constraint >::query_statement[] =
  "SELECT "
  "\"Constraint\".\"unipaxId\","
  "\"Constraint\".\"unipaxSource\","
  "\"Constraint\".\"metaId\","
  ...
  "\"Constraint\".\"message\""
  " FROM \"Constraint\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"Constraint\".\"unipaxSource\""
  " LEFT JOIN \"Math\" \"math\" ON \"math\".\"unipaxId\" = \"Constraint\".\"math\""
  " ";

  const char access::object_traits< ::UniPAX::Constraint >::erase_query_statement[] =
  "DELETE FROM \"Constraint\""
  " ";

  const char access::object_traits< ::UniPAX::Constraint >::table_name[] =
  "\"Constraint\"";
  ...
  access::object_traits< ::UniPAX::Constraint >::pointer_type
  ...
  result< access::object_traits< ::UniPAX::Constraint >::object_type >
  access::object_traits< ::UniPAX::Constraint >::
  ...
  unsigned long long access::object_traits< ::UniPAX::Constraint >::
