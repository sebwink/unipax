...
namespace odb
{
  ...
  bind (oracle::bind* b, image_type& i, oracle::statement_kind sk)
  {
    ...
    b[n].capacity = 4;
    b[n].size = 0;
    b[n].indicator = &i.constant_indicator;
    n++;
    ...
    //
    b[n].type = oracle::bind::string;
    b[n].buffer = i.units_value;
    b[n].capacity = static_cast<ub4> (sizeof (i.units_value));
    b[n].size = &i.units_size;
    b[n].indicator = &i.units_indicator;
    n++;
  }

  bool access::object_traits< ::UniPAX::Parameter >::
  init (image_type& i, const object_type& o, oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        i.constant_value, is_null, o.constant);
      i.constant_indicator = is_null ? -1 : 0;
    }
    ...
    //
    {
      ...
      oracle::value_traits<
          ...
          oracle::id_string >::set_image (
        i.units_value,
        sizeof (i.units_value),
        size,
        is_null,
        o.units);
      i.units_size = static_cast<ub2> (size);
      i.units_indicator = is_null ? -1 : 0;
    }
  ...
  struct access::object_traits< ::UniPAX::Parameter >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::Parameter >::persist_statement[] =
  ...
  const char access::object_traits< ::UniPAX::Parameter >::find_statement[] =
  "SELECT "
  "\"Parameter\".\"unipaxId\","
  ...
  "\"Parameter\".\"units\""
  " FROM \"Parameter\""
  " WHERE \"Parameter\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Parameter >::update_statement[] =
  ...
  const char access::object_traits< ::UniPAX::Parameter >::erase_statement[] =
  "DELETE FROM \"Parameter\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::Parameter >::query_statement[] =
  "SELECT "
  "\"Parameter\".\"unipaxId\","
  "\"Parameter\".\"unipaxSource\","
  "\"Parameter\".\"metaId\","
  ...
  "\"Parameter\".\"units\""
  " FROM \"Parameter\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"Parameter\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::Parameter >::erase_query_statement[] =
  "DELETE FROM \"Parameter\""
  " ";

  const char access::object_traits< ::UniPAX::Parameter >::table_name[] =
  "\"Parameter\"";
  ...
  access::object_traits< ::UniPAX::Parameter >::pointer_type
  ...
  result< access::object_traits< ::UniPAX::Parameter >::object_type >
  access::object_traits< ::UniPAX::Parameter >::
  ...
  unsigned long long access::object_traits< ::UniPAX::Parameter >::
