...
namespace odb
{
  ...
  const char access::object_traits< ::UniPAX::SequenceLocation >::comment_traits::select_all_statement[] =
  "SELECT "
  "\"SequenceLocation_comment\".\"index\","
  "\"SequenceLocation_comment\".\"value\""
  " FROM \"SequenceLocation_comment\" WHERE \"SequenceLocation_comment\".\"object_id\"=:1"
  " ORDER BY \"SequenceLocation_comment\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::SequenceLocation >::comment_traits::insert_one_statement[] =
  ...
  const char access::object_traits< ::UniPAX::SequenceLocation >::comment_traits::delete_all_statement[] =
  "DELETE FROM \"SequenceLocation_comment\""
  " WHERE \"object_id\"=:1";

  void access::object_traits< ::UniPAX::SequenceLocation >::
  ...
  bool access::object_traits< ::UniPAX::SequenceLocation >::
  ...
  struct access::object_traits< ::UniPAX::SequenceLocation >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::SequenceLocation >::persist_statement[] =
  "INSERT INTO \"SequenceLocation\" ("
  "\"unipaxId\","
  "\"unipaxSource\")"
  " VALUES (:1,:2)";

  const char access::object_traits< ::UniPAX::SequenceLocation >::find_statement[] =
  "SELECT "
  "\"SequenceLocation\".\"unipaxId\","
  "\"SequenceLocation\".\"unipaxSource\""
  " FROM \"SequenceLocation\""
  " WHERE \"SequenceLocation\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::SequenceLocation >::update_statement[] =
  "UPDATE \"SequenceLocation\" SET "
  "\"unipaxSource\"=:1"
  " WHERE \"unipaxId\"=:2";

  const char access::object_traits< ::UniPAX::SequenceLocation >::erase_statement[] =
  "DELETE FROM \"SequenceLocation\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::SequenceLocation >::query_statement[] =
  "SELECT "
  "\"SequenceLocation\".\"unipaxId\","
  "\"SequenceLocation\".\"unipaxSource\""
  " FROM \"SequenceLocation\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"SequenceLocation\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::SequenceLocation >::erase_query_statement[] =
  "DELETE FROM \"SequenceLocation\""
  " ";

  const char access::object_traits< ::UniPAX::SequenceLocation >::table_name[] =
  "\"SequenceLocation\"";
  ...
  access::object_traits< ::UniPAX::SequenceLocation >::pointer_type
  access::object_traits< ::UniPAX::SequenceLocation >::
  ...
  result< access::object_traits< ::UniPAX::SequenceLocation >::object_type >
  access::object_traits< ::UniPAX::SequenceLocation >::
  ...
  unsigned long long access::object_traits< ::UniPAX::SequenceLocation >::
