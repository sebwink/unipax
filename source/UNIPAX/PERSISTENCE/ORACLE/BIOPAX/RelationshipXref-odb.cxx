...
namespace odb
{
  ...
  const char access::object_traits< ::UniPAX::RelationshipXref >::comment_traits::select_all_statement[] =
  "SELECT "
  "\"RelationshipXref_comment\".\"index\","
  "\"RelationshipXref_comment\".\"value\""
  " FROM \"RelationshipXref_comment\" WHERE \"RelationshipXref_comment\".\"object_id\"=:1"
  " ORDER BY \"RelationshipXref_comment\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::RelationshipXref >::comment_traits::insert_one_statement[] =
  "INSERT INTO \"RelationshipXref_comment\" ("
  "\"object_id\","
  "\"index\","
  "\"value\")"
  " VALUES (:1,:2,:3)";

  const char access::object_traits< ::UniPAX::RelationshipXref >::comment_traits::delete_all_statement[] =
  "DELETE FROM \"RelationshipXref_comment\""
  " WHERE \"object_id\"=:1";

  // relationshipType
  //

  const char access::object_traits< ::UniPAX::RelationshipXref >::relationshipType_traits::select_all_statement[] =
  "SELECT "
  "\"RelationshipXref_relationshipT\".\"index\","
  "\"RelationshipXref_relationshipT\".\"value\""
  " FROM \"RelationshipXref_relationshipT\" WHERE \"RelationshipXref_relationshipT\".\"object_id\"=:1"
  " ORDER BY \"RelationshipXref_relationshipT\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::RelationshipXref >::relationshipType_traits::insert_one_statement[] =
  "INSERT INTO \"RelationshipXref_relationshipT\" ("
  "\"object_id\","
  "\"index\","
  "\"value\")"
  " VALUES (:1,:2,:3)";

  const char access::object_traits< ::UniPAX::RelationshipXref >::relationshipType_traits::delete_all_statement[] =
  "DELETE FROM \"RelationshipXref_relationshipT\""
  " WHERE \"object_id\"=:1";

  void access::object_traits< ::UniPAX::RelationshipXref >::relationshipType_traits::
  bind (oracle::bind* b,
  ...
  init (data_image_type& i, index_type j, const value_type& v)
  {
    ...
    //
    {
      typedef object_traits< ::UniPAX::RelationshipTypeVocabulary > obj_traits;
  ...
  bool access::object_traits< ::UniPAX::RelationshipXref >::relationshipType_traits::
  ...
  bool access::object_traits< ::UniPAX::RelationshipXref >::
  ...
  struct access::object_traits< ::UniPAX::RelationshipXref >::container_statement_cache_type
  {
    oracle::container_statements_impl< comment_traits > comment;
    oracle::container_statements_impl< relationshipType_traits > relationshipType;
  ...
  const char access::object_traits< ::UniPAX::RelationshipXref >::persist_statement[] =
  "INSERT INTO \"RelationshipXref\" ("
  "\"unipaxId\","
  "\"unipaxSource\","
  "\"idVersion\","
  "\"id\","
  ...
  const char access::object_traits< ::UniPAX::RelationshipXref >::find_statement[] =
  "SELECT "
  "\"RelationshipXref\".\"unipaxId\","
  "\"RelationshipXref\".\"unipaxSource\","
  "\"RelationshipXref\".\"idVersion\","
  "\"RelationshipXref\".\"id\","
  "\"RelationshipXref\".\"dbVersion\","
  "\"RelationshipXref\".\"db\""
  " FROM \"RelationshipXref\""
  " WHERE \"RelationshipXref\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::RelationshipXref >::update_statement[] =
  "UPDATE \"RelationshipXref\" SET "
  "\"unipaxSource\"=:1,"
  "\"idVersion\"=:2,"
  "\"id\"=:3,"
  "\"dbVersion\"=:4,"
  ...
  const char access::object_traits< ::UniPAX::RelationshipXref >::erase_statement[] =
  "DELETE FROM \"RelationshipXref\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::RelationshipXref >::query_statement[] =
  "SELECT "
  "\"RelationshipXref\".\"unipaxId\","
  "\"RelationshipXref\".\"unipaxSource\","
  "\"RelationshipXref\".\"idVersion\","
  ...
  "\"RelationshipXref\".\"db\""
  " FROM \"RelationshipXref\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"RelationshipXref\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::RelationshipXref >::erase_query_statement[] =
  "DELETE FROM \"RelationshipXref\""
  " ";

  const char access::object_traits< ::UniPAX::RelationshipXref >::table_name[] =
  "\"RelationshipXref\"";
  ...
  persist (database&, const object_type& obj)
  {
    ...
    relationshipType_traits::persist (
      obj.relationshipType,
      idb,
      sts.container_statment_cache ().relationshipType);
  }
  ...
  update (database&, const object_type& obj)
  {
    ...
    relationshipType_traits::update (
      obj.relationshipType,
      idb,
      sts.container_statment_cache ().relationshipType);
  }
  ...
  access::object_traits< ::UniPAX::RelationshipXref >::pointer_type
  ...
  load_ (oracle::object_statements< object_type >& sts, object_type& obj)
  {
    ...
    relationshipType_traits::load (
      obj.relationshipType,
      idb,
      sts.container_statment_cache ().relationshipType);
  }

  result< access::object_traits< ::UniPAX::RelationshipXref >::object_type >
  access::object_traits< ::UniPAX::RelationshipXref >::
  ...
  unsigned long long access::object_traits< ::UniPAX::RelationshipXref >::
