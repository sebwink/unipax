...
namespace odb
{
  ...
  const char access::object_traits< ::UniPAX::UtilityClass >::comment_traits::select_all_statement[] =
  "SELECT "
  "\"UtilityClass_comment\".\"index\","
  "\"UtilityClass_comment\".\"value\""
  " FROM \"UtilityClass_comment\" WHERE \"UtilityClass_comment\".\"object_id\"=:1"
  " ORDER BY \"UtilityClass_comment\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::UtilityClass >::comment_traits::insert_one_statement[] =
  "INSERT INTO \"UtilityClass_comment\" ("
  "\"object_id\","
  "\"index\","
  "\"value\")"
  " VALUES (:1,:2,:3)";

  const char access::object_traits< ::UniPAX::UtilityClass >::comment_traits::delete_all_statement[] =
  "DELETE FROM \"UtilityClass_comment\""
  " WHERE \"object_id\"=:1";

  void access::object_traits< ::UniPAX::UtilityClass >::comment_traits::
  bind (oracle::bind* b,
  ...
  bool access::object_traits< ::UniPAX::UtilityClass >::comment_traits::
  ...
  void access::object_traits< ::UniPAX::UtilityClass >::
  ...
  bool access::object_traits< ::UniPAX::UtilityClass >::
  ...
  struct access::object_traits< ::UniPAX::UtilityClass >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::UtilityClass >::persist_statement[] =
  "INSERT INTO \"UtilityClass\" ("
  "\"unipaxId\","
  "\"unipaxSource\")"
  " VALUES (:1,:2)";

  const char access::object_traits< ::UniPAX::UtilityClass >::find_statement[] =
  "SELECT "
  "\"UtilityClass\".\"unipaxId\","
  "\"UtilityClass\".\"unipaxSource\""
  " FROM \"UtilityClass\""
  " WHERE \"UtilityClass\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::UtilityClass >::update_statement[] =
  "UPDATE \"UtilityClass\" SET "
  "\"unipaxSource\"=:1"
  " WHERE \"unipaxId\"=:2";

  const char access::object_traits< ::UniPAX::UtilityClass >::erase_statement[] =
  "DELETE FROM \"UtilityClass\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::UtilityClass >::query_statement[] =
  "SELECT "
  "\"UtilityClass\".\"unipaxId\","
  "\"UtilityClass\".\"unipaxSource\""
  " FROM \"UtilityClass\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"UtilityClass\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::UtilityClass >::erase_query_statement[] =
  "DELETE FROM \"UtilityClass\""
  " ";

  const char access::object_traits< ::UniPAX::UtilityClass >::table_name[] =
  "\"UtilityClass\"";
  ...
  access::object_traits< ::UniPAX::UtilityClass >::pointer_type
  access::object_traits< ::UniPAX::UtilityClass >::
  ...
  result< access::object_traits< ::UniPAX::UtilityClass >::object_type >
  access::object_traits< ::UniPAX::UtilityClass >::
  ...
  unsigned long long access::object_traits< ::UniPAX::UtilityClass >::
