...
namespace odb
{
  ...
  const char access::object_traits< ::UniPAX::ControlledVocabulary >::comment_traits::select_all_statement[] =
  "SELECT "
  "\"ControlledVocabulary_comment\".\"index\","
  "\"ControlledVocabulary_comment\".\"value\""
  " FROM \"ControlledVocabulary_comment\" WHERE \"ControlledVocabulary_comment\".\"object_id\"=:1"
  " ORDER BY \"ControlledVocabulary_comment\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::comment_traits::insert_one_statement[] =
  ...
  const char access::object_traits< ::UniPAX::ControlledVocabulary >::comment_traits::delete_all_statement[] =
  ...
  const char access::object_traits< ::UniPAX::ControlledVocabulary >::id_xref_traits::select_all_statement[] =
  "SELECT "
  "\"ControlledVocabulary_id_xref\".\"index\","
  "\"ControlledVocabulary_id_xref\".\"value\""
  " FROM \"ControlledVocabulary_id_xref\" WHERE \"ControlledVocabulary_id_xref\".\"object_id\"=:1"
  " ORDER BY \"ControlledVocabulary_id_xref\".\"index\""
  ;

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::id_xref_traits::insert_one_statement[] =
  "INSERT INTO \"ControlledVocabulary_id_xref\" ("
  "\"object_id\","
  "\"index\","
  "\"value\")"
  " VALUES (:1,:2,:3)";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::id_xref_traits::delete_all_statement[] =
  "DELETE FROM \"ControlledVocabulary_id_xref\""
  " WHERE \"object_id\"=:1";

  void access::object_traits< ::UniPAX::ControlledVocabulary >::id_xref_traits::
  bind (oracle::bind* b,
  ...
  bool access::object_traits< ::UniPAX::ControlledVocabulary >::id_xref_traits::
  ...
  void access::object_traits< ::UniPAX::ControlledVocabulary >::
  bind (oracle::bind* b, image_type& i, oracle::statement_kind sk)
  {
    ...
    b[n].buffer = i.term_value;
    b[n].capacity = static_cast<ub4> (sizeof (i.term_value));
    b[n].size = &i.term_size;
    b[n].indicator = &i.term_indicator;
    n++;
  }

  bool access::object_traits< ::UniPAX::ControlledVocabulary >::
  init (image_type& i, const object_type& o, oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        is_null,
        o.term);
      i.term_size = static_cast<ub2> (size);
      i.term_indicator = is_null ? -1 : 0;
    }
  ...
  struct access::object_traits< ::UniPAX::ControlledVocabulary >::container_statement_cache_type
  {
  ...
  const char access::object_traits< ::UniPAX::ControlledVocabulary >::persist_statement[] =
  ...
  const char access::object_traits< ::UniPAX::ControlledVocabulary >::find_statement[] =
  "SELECT "
  "\"ControlledVocabulary\".\"unipaxId\","
  "\"ControlledVocabulary\".\"unipaxSource\","
  "\"ControlledVocabulary\".\"term\""
  " FROM \"ControlledVocabulary\""
  " WHERE \"ControlledVocabulary\".\"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::update_statement[] =
  "UPDATE \"ControlledVocabulary\" SET "
  "\"unipaxSource\"=:1,"
  "\"term\"=:2"
  " WHERE \"unipaxId\"=:3";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::erase_statement[] =
  "DELETE FROM \"ControlledVocabulary\""
  " WHERE \"unipaxId\"=:1";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::query_statement[] =
  "SELECT "
  "\"ControlledVocabulary\".\"unipaxId\","
  "\"ControlledVocabulary\".\"unipaxSource\","
  "\"ControlledVocabulary\".\"term\""
  " FROM \"ControlledVocabulary\""
  " LEFT JOIN \"ImportSource\" \"unipaxSource\" ON \"unipaxSource\".\"unipaxId\" = \"ControlledVocabulary\".\"unipaxSource\""
  " ";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::erase_query_statement[] =
  "DELETE FROM \"ControlledVocabulary\""
  " ";

  const char access::object_traits< ::UniPAX::ControlledVocabulary >::table_name[] =
  "\"ControlledVocabulary\"";
  ...
  access::object_traits< ::UniPAX::ControlledVocabulary >::pointer_type
  access::object_traits< ::UniPAX::ControlledVocabulary >::
  ...
  result< access::object_traits< ::UniPAX::ControlledVocabulary >::object_type >
  access::object_traits< ::UniPAX::ControlledVocabulary >::
  ...
  unsigned long long access::object_traits< ::UniPAX::ControlledVocabulary >::
