...
#include<set>
//Begin section for file Rna.cpp
//TODO: Add definitions that you want preserved
//End section for file Rna.cpp

UniPAX::Rna::Rna() : UniPAX::PhysicalEntity() {
    }

UniPAX::Rna::Rna(const Rna & arg) : UniPAX::PhysicalEntity(arg),
	entityReference(arg.entityReference)
//	id_entityReference(arg.id_entityReference)
{
    }

UniPAX::Rna & UniPAX::Rna::operator =(const Rna & arg)  {
...
bool UniPAX::Rna::merge(Rna& object)
{
	{
...
bool UniPAX::Rna::update(PersistenceManager& manager)
{
	{
...
const std::vector<boost::shared_ptr<UniPAX::EntityReference> > & UniPAX::Rna::getEntityReferences() const {
    return entityReference;
}

std::vector<boost::shared_ptr<UniPAX::EntityReference> > & UniPAX::Rna::getEntityReferences() {
	return entityReference;
}

void UniPAX::Rna::addEntityReference(boost::shared_ptr<UniPAX::EntityReference>  _entityReference) {
	entityReference.push_back(_entityReference);
}

void UniPAX::Rna::setEntityReferences(std::vector<boost::shared_ptr<UniPAX::EntityReference> > _entityReferences) {
	entityReference = _entityReferences;
}

bool UniPAX::Rna::setAttribute(std::string& attribute, std::string& value, PersistenceManager& manager) {
...
bool UniPAX::Rna::getAttribute(std::vector<std::pair<std::string,std::string> >& value, PersistenceManager& manager) {
...
//void UniPAX::Rna::init (odb::callback_event e, odb::database& db) const
//{
