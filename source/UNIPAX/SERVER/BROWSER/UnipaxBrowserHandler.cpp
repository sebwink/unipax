...
UniPAX::SERVER::UnipaxBrowserHandler::UnipaxBrowserHandler(QString name) : _options(name.toStdString()), _name(name), engine()
{
}


void UniPAX::SERVER::UnipaxBrowserHandler::respond(QHttpRequest *req, QHttpResponse *resp, std::set<UnipaxId> & ids, QString format)
{
