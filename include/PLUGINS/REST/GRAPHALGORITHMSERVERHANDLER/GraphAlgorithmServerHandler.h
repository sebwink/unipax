#ifndef GRAPHALGORITHMSERVERHANDLER_H_
#define GRAPHALGORITHMSERVERHANDLER_H_
...
class GraphAlgorithmServerHandler : public QObject, protected UniPAX::SERVER::RESTServerHandler
{
	Q_OBJECT
...
private:
	...
	static QRegExp minCostFlow, shortestPath;
	UniPAX::DBConnectorPtr dbc;
};


#endif /* GRAPHALGORITHMSERVERHANDLER_H_ */
