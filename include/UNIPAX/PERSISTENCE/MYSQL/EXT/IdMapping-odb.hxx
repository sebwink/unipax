...
#ifndef ID_MAPPING_ODB_HXX
#define ID_MAPPING_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::IdMapping >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::IdMapping >
  {
    public:
    typedef ::UniPAX::IdMapping object_type;
    typedef ::boost::shared_ptr< ::UniPAX::IdMapping > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::IdMapping root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::IdMapping, id_mysql, A >:
    query_columns< ::UniPAX::UPBase, id_mysql, A >
  {
    ...
    static const sample_index_type_ sample_index;
    ...
    static const db_name_type_ db_name;
    ...
    static const db_version_type_ db_version;
  };

  template <typename A>
  const typename query_columns< ::UniPAX::IdMapping, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::IdMapping, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::IdMapping, id_mysql, A >::sample_index_type_
  query_columns< ::UniPAX::IdMapping, id_mysql, A >::
  sample_index (A::table_name, "`sample_index`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::IdMapping, id_mysql, A >::db_name_type_
  query_columns< ::UniPAX::IdMapping, id_mysql, A >::
  db_name (A::table_name, "`db_name`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::IdMapping, id_mysql, A >::db_version_type_
  query_columns< ::UniPAX::IdMapping, id_mysql, A >::
  db_version (A::table_name, "`db_version`", 0);

  template <typename A>
  struct pointer_query_columns< ::UniPAX::IdMapping, id_mysql, A >:
    query_columns< ::UniPAX::IdMapping, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::UniPAX::IdMapping, id_mysql >:
    public access::object_traits< ::UniPAX::IdMapping >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UPBase, id_mysql >::image_type
    {
      ...
      my_bool sample_index_null;

      // db_name
      //
      details::buffer db_name_value;
      unsigned long db_name_size;
      my_bool db_name_null;

      // db_version
      //
      details::buffer db_version_value;
      unsigned long db_version_size;
      my_bool db_version_null;
    ...
    struct id_list_traits
    {
      ...
      typedef ::std::multimap< int, ::std::basic_string< char > > container_type;
      typedef
      ...
      typedef mysql::container_statements< id_list_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::IdMapping, id_common >:
    public access::object_traits_impl< ::UniPAX::IdMapping, id_mysql >
  {
  };
...
#include <UNIPAX/PERSISTENCE/MYSQL/EXT/IdMapping-odb.ixx>

#include <odb/post.hxx>

#endif // ID_MAPPING_ODB_HXX
