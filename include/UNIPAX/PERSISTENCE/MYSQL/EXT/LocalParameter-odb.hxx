...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::LocalParameter >
  {
    ...
    typedef ::UniPAX::LocalParameter root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::id_type_
  pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::name_type_
  pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  name (A::table_name, "`name`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::value_type_
  pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  value (A::table_name, "`value`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::unit_type_
  pointer_query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  unit (A::table_name, "`unit`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >:
    public access::object_traits< ::UniPAX::LocalParameter >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::LocalParameter, id_common >:
    public access::object_traits_impl< ::UniPAX::LocalParameter, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::LocalParameter, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::LocalParameter, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::LocalParameter, id_mysql, A >::id_type_
  query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::LocalParameter, id_mysql, A >::name_type_
  query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  name (A::table_name, "`name`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::LocalParameter, id_mysql, A >::value_type_
  query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  value (A::table_name, "`value`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::LocalParameter, id_mysql, A >::unit_type_
  query_columns< ::UniPAX::LocalParameter, id_mysql, A >::
  unit (A::table_name, "`unit`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/LocalParameter-odb.ixx>
