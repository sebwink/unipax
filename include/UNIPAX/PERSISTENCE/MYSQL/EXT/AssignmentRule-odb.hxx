...
#ifndef ASSIGNMENT_RULE_ODB_HXX
#define ASSIGNMENT_RULE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::AssignmentRule >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::AssignmentRule >
  {
    public:
    typedef ::UniPAX::AssignmentRule object_type;
    typedef ::boost::shared_ptr< ::UniPAX::AssignmentRule > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Rule root_type;
    typedef ::UniPAX::Rule base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::AssignmentRule, id_mysql, A >:
    pointer_query_columns< ::UniPAX::Rule, id_mysql, typename A::base_traits >
  {
    // Rule
    //
    typedef pointer_query_columns< ::UniPAX::Rule, id_mysql, typename A::base_traits > Rule;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::variable_type_
  pointer_query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >:
    public access::object_traits< ::UniPAX::AssignmentRule >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::AssignmentRule, id_common >:
    public access::object_traits_impl< ::UniPAX::AssignmentRule, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::AssignmentRule, id_mysql, A >:
    query_columns< ::UniPAX::Rule, id_mysql, typename A::base_traits >
  {
    // Rule
    //
    typedef query_columns< ::UniPAX::Rule, id_mysql, typename A::base_traits > Rule;
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::variable_type_
  query_columns< ::UniPAX::AssignmentRule, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/AssignmentRule-odb.ixx>

#include <odb/post.hxx>

#endif // ASSIGNMENT_RULE_ODB_HXX
