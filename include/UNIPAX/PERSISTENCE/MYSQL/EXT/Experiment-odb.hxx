...
#ifndef EXPERIMENT_ODB_HXX
#define EXPERIMENT_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Experiment >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Experiment >
  {
    public:
    typedef ::UniPAX::Experiment object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Experiment > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Experiment root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Experiment, id_mysql, A >:
    query_columns< ::UniPAX::UPBase, id_mysql, A >
  {
    ...
    static const experimentId_type_ experimentId;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_string >::query_type,
      mysql::id_string >
    shortDescription_type_;

    static const shortDescription_type_ shortDescription;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_long >::query_type,
      mysql::id_long >
    valuesPerSample_type_;

    static const valuesPerSample_type_ valuesPerSample;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_string >::query_type,
      mysql::id_string >
    defaultMapping_type_;

    static const defaultMapping_type_ defaultMapping;
  };

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::experimentId_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  experimentId (A::table_name, "`experimentId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::name_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  name (A::table_name, "`name`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::shortDescription_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  shortDescription (A::table_name, "`shortDescription`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::source_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  source (A::table_name, "`source`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::user_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  user (A::table_name, "`user`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::metaInfos_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  metaInfos (A::table_name, "`metaInfos`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::valuesPerSample_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  valuesPerSample (A::table_name, "`valuesPerSample`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Experiment, id_mysql, A >::defaultMapping_type_
  query_columns< ::UniPAX::Experiment, id_mysql, A >::
  defaultMapping (A::table_name, "`defaultMapping`", 0);

  template <typename A>
  struct pointer_query_columns< ::UniPAX::Experiment, id_mysql, A >:
    query_columns< ::UniPAX::Experiment, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::UniPAX::Experiment, id_mysql >:
    public access::object_traits< ::UniPAX::Experiment >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UPBase, id_mysql >::image_type
    {
      ...
      // experimentId
      //
      int experimentId_value;
      my_bool experimentId_null;
      ...
      // shortDescription
      //
      details::buffer shortDescription_value;
      unsigned long shortDescription_size;
      my_bool shortDescription_null;
      ...
      // metaInfos
      //
      details::buffer metaInfos_value;
      unsigned long metaInfos_size;
      my_bool metaInfos_null;

      // valuesPerSample
      //
      int valuesPerSample_value;
      my_bool valuesPerSample_null;

      // defaultMapping
      //
      details::buffer defaultMapping_value;
      unsigned long defaultMapping_size;
      my_bool defaultMapping_null;
    ...
    struct mapping_traits
    {
      ...
      typedef mysql::container_statements< mapping_traits > statements_type;
    ...
    struct sample_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< sample_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Experiment, id_common >:
    public access::object_traits_impl< ::UniPAX::Experiment, id_mysql >
  {
  };
...
#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Experiment-odb.ixx>

#include <odb/post.hxx>

#endif // EXPERIMENT_ODB_HXX
