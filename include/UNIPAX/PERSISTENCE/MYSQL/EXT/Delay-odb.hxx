...
#ifndef DELAY_ODB_HXX
#define DELAY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Delay >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Delay >
  {
    public:
    typedef ::UniPAX::Delay object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Delay > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Delay root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Delay, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Delay, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Delay, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Delay, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::Delay, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Delay, id_mysql >:
    public access::object_traits< ::UniPAX::Delay >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Delay, id_common >:
    public access::object_traits_impl< ::UniPAX::Delay, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Delay, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Delay, id_mysql, A >:
    query_columns_base< ::UniPAX::Delay, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Delay, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Delay, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Delay, id_mysql, A >::math_type_
  query_columns< ::UniPAX::Delay, id_mysql, A >::
  math (A::table_name, "`math`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Delay-odb.ixx>
