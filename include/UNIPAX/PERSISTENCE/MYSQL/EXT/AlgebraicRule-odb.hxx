...
#ifndef ALGEBRAIC_RULE_ODB_HXX
#define ALGEBRAIC_RULE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::AlgebraicRule >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::AlgebraicRule >
  {
    public:
    typedef ::UniPAX::AlgebraicRule object_type;
    typedef ::boost::shared_ptr< ::UniPAX::AlgebraicRule > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >:
    public access::object_traits< ::UniPAX::AlgebraicRule >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::AlgebraicRule, id_common >:
    public access::object_traits_impl< ::UniPAX::AlgebraicRule, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::AlgebraicRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/AlgebraicRule-odb.ixx>

#include <odb/post.hxx>

#endif // ALGEBRAIC_RULE_ODB_HXX
