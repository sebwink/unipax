...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::Constraint >
  {
    ...
    typedef ::UniPAX::Constraint root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::message_type_
  pointer_query_columns< ::UniPAX::Constraint, id_mysql, A >::
  message (A::table_name, "`message`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Constraint, id_mysql >:
    public access::object_traits< ::UniPAX::Constraint >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Constraint, id_common >:
    public access::object_traits_impl< ::UniPAX::Constraint, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Constraint, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Constraint, id_mysql, A >:
    query_columns_base< ::UniPAX::Constraint, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Constraint, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Constraint, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Constraint, id_mysql, A >::math_type_
  query_columns< ::UniPAX::Constraint, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Constraint, id_mysql, A >::message_type_
  query_columns< ::UniPAX::Constraint, id_mysql, A >::
  message (A::table_name, "`message`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Constraint-odb.ixx>
