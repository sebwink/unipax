...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::Parameter >
  {
    ...
    typedef ::UniPAX::Parameter root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::constant_type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  constant (A::table_name, "`constant`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::id_type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::name_type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  name (A::table_name, "`name`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::value_type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  value (A::table_name, "`value`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::units_type_
  pointer_query_columns< ::UniPAX::Parameter, id_mysql, A >::
  units (A::table_name, "`units`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Parameter, id_mysql >:
    public access::object_traits< ::UniPAX::Parameter >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::SBase, id_mysql >::image_type
    {
      ...
      // constant
      //
      signed char constant_value;
      my_bool constant_null;
      ...
      // units
      //
      details::buffer units_value;
      unsigned long units_size;
      my_bool units_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Parameter, id_common >:
    public access::object_traits_impl< ::UniPAX::Parameter, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Parameter, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::constant_type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  constant (A::table_name, "`constant`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::id_type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::name_type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  name (A::table_name, "`name`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::value_type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  value (A::table_name, "`value`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Parameter, id_mysql, A >::units_type_
  query_columns< ::UniPAX::Parameter, id_mysql, A >::
  units (A::table_name, "`units`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Parameter-odb.ixx>
