...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::Trigger >
  {
    ...
    typedef ::UniPAX::Trigger root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::initialValue_type_
  pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::
  initialValue (A::table_name, "`initialValue`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::persistent_type_
  pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::
  persistent (A::table_name, "`persistent`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::Trigger, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Trigger, id_mysql >:
    public access::object_traits< ::UniPAX::Trigger >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::SBase, id_mysql >::image_type
    {
      ...
      my_bool initialValue_null;

      // persistent
      //
      signed char persistent_value;
      my_bool persistent_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Trigger, id_common >:
    public access::object_traits_impl< ::UniPAX::Trigger, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Trigger, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Trigger, id_mysql, A >:
    query_columns_base< ::UniPAX::Trigger, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Trigger, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Trigger, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Trigger, id_mysql, A >::initialValue_type_
  query_columns< ::UniPAX::Trigger, id_mysql, A >::
  initialValue (A::table_name, "`initialValue`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Trigger, id_mysql, A >::persistent_type_
  query_columns< ::UniPAX::Trigger, id_mysql, A >::
  persistent (A::table_name, "`persistent`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Trigger, id_mysql, A >::math_type_
  query_columns< ::UniPAX::Trigger, id_mysql, A >::
  math (A::table_name, "`math`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Trigger-odb.ixx>
