...
#ifndef KINETIC_LAW_ODB_HXX
#define KINETIC_LAW_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::KineticLaw >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::KineticLaw >
  {
    public:
    typedef ::UniPAX::KineticLaw object_type;
    typedef ::boost::shared_ptr< ::UniPAX::KineticLaw > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::KineticLaw root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::KineticLaw, id_mysql, A >:
    pointer_query_columns< ::UniPAX::SBase, id_mysql, A >
  {
    ...
    static const conversion_type_ conversion;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::KineticLaw, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::KineticLaw, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::KineticLaw, id_mysql, A >::conversion_type_
  pointer_query_columns< ::UniPAX::KineticLaw, id_mysql, A >::
  conversion (A::table_name, "`conversion`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::KineticLaw, id_mysql >:
    public access::object_traits< ::UniPAX::KineticLaw >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::SBase, id_mysql >::image_type
    {
      ...
      // conversion
      //
      unsigned long long conversion_value;
      my_bool conversion_null;
    ...
    struct localParameter_traits
    {
      ...
      typedef ::std::vector< ::boost::shared_ptr< ::UniPAX::LocalParameter > > container_type;
      typedef
      ...
      typedef mysql::container_statements< localParameter_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::KineticLaw, id_common >:
    public access::object_traits_impl< ::UniPAX::KineticLaw, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::KineticLaw, id_mysql >
  {
    // conversion
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::KineticLaw, id_mysql, A >:
    query_columns_base< ::UniPAX::KineticLaw, id_mysql >,
    query_columns< ::UniPAX::SBase, id_mysql, A >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        conversion_alias_ > >
    conversion_pointer_type_;

    struct conversion_type_: conversion_pointer_type_, conversion_column_type_
    {
      conversion_type_ (const char* t, const char* c, const char* conv)
        : conversion_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::KineticLaw, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::KineticLaw, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::KineticLaw, id_mysql, A >::conversion_type_
  query_columns< ::UniPAX::KineticLaw, id_mysql, A >::
  conversion (A::table_name, "`conversion`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/KineticLaw-odb.ixx>

#include <odb/post.hxx>

#endif // KINETIC_LAW_ODB_HXX
