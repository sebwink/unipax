...
#ifndef RATE_RULE_ODB_HXX
#define RATE_RULE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::RateRule >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::RateRule >
  {
    public:
    typedef ::UniPAX::RateRule object_type;
    typedef ::boost::shared_ptr< ::UniPAX::RateRule > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::RateRule, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RateRule, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::RateRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RateRule, id_mysql, A >::variable_type_
  pointer_query_columns< ::UniPAX::RateRule, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::RateRule, id_mysql >:
    public access::object_traits< ::UniPAX::RateRule >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::RateRule, id_common >:
    public access::object_traits_impl< ::UniPAX::RateRule, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::RateRule, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::RateRule, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::RateRule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RateRule, id_mysql, A >::variable_type_
  query_columns< ::UniPAX::RateRule, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/RateRule-odb.ixx>

#include <odb/post.hxx>

#endif // RATE_RULE_ODB_HXX
