...
namespace odb
{
  ...
  inline
  access::object_traits< ::UniPAX::UIBase >::id_type
  access::object_traits< ::UniPAX::UIBase >::
...
namespace odb
{
  ...
  inline
  access::object_traits_impl< ::UniPAX::UIBase, id_mysql >::id_type
  access::object_traits_impl< ::UniPAX::UIBase, id_mysql >::
