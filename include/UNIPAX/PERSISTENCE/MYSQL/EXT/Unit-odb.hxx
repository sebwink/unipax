...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Unit >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Unit >
  {
    public:
    typedef ::UniPAX::Unit object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Unit > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Unit root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Unit, id_mysql, A >:
    pointer_query_columns< ::UniPAX::SBase, id_mysql, A >
  {
    ...
    static const exponent_type_ exponent;
    ...
    static const multiplier_type_ multiplier;
    ...
    static const scale_type_ scale;
    ...
    mysql::query_column<
      ...
      mysql::id_ulonglong >
    unitDefinition_type_;

    static const unitDefinition_type_ unitDefinition;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::exponent_type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  exponent (A::table_name, "`exponent`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::kind_type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  kind (A::table_name, "`kind`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::multiplier_type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  multiplier (A::table_name, "`multiplier`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::scale_type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  scale (A::table_name, "`scale`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::unitDefinition_type_
  pointer_query_columns< ::UniPAX::Unit, id_mysql, A >::
  unitDefinition (A::table_name, "`unitDefinition`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Unit, id_mysql >:
    public access::object_traits< ::UniPAX::Unit >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::SBase, id_mysql >::image_type
    {
      ...
      //
      int exponent_value;
      my_bool exponent_null;

      // kind
      //
      details::buffer kind_value;
      unsigned long kind_size;
      my_bool kind_null;

      // multiplier
      //
      double multiplier_value;
      my_bool multiplier_null;
      ...
      // unitDefinition
      //
      unsigned long long unitDefinition_value;
      my_bool unitDefinition_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Unit, id_common >:
    public access::object_traits_impl< ::UniPAX::Unit, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Unit, id_mysql >
  {
    // unitDefinition
    //
    typedef
    odb::alias_traits<
      ...
      id_mysql,
      access::object_traits_impl< ::UniPAX::Unit, id_mysql >::unitDefinition_tag>
    unitDefinition_alias_;
  };

  template <typename A>
  struct query_columns< ::UniPAX::Unit, id_mysql, A >:
    query_columns_base< ::UniPAX::Unit, id_mysql >,
    query_columns< ::UniPAX::SBase, id_mysql, A >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        unitDefinition_alias_ > >
    unitDefinition_pointer_type_;

    struct unitDefinition_type_: unitDefinition_pointer_type_, unitDefinition_column_type_
    {
      unitDefinition_type_ (const char* t, const char* c, const char* conv)
        : unitDefinition_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::exponent_type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  exponent (A::table_name, "`exponent`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::kind_type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  kind (A::table_name, "`kind`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::multiplier_type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  multiplier (A::table_name, "`multiplier`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::scale_type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  scale (A::table_name, "`scale`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Unit, id_mysql, A >::unitDefinition_type_
  query_columns< ::UniPAX::Unit, id_mysql, A >::
  unitDefinition (A::table_name, "`unitDefinition`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Unit-odb.ixx>
