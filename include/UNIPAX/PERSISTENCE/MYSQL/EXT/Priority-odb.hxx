...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::Priority >
  {
    ...
    typedef ::UniPAX::Priority root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Priority, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Priority, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Priority, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Priority, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::Priority, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Priority, id_mysql >:
    public access::object_traits< ::UniPAX::Priority >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Priority, id_common >:
    public access::object_traits_impl< ::UniPAX::Priority, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Priority, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Priority, id_mysql, A >:
    query_columns_base< ::UniPAX::Priority, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Priority, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Priority, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Priority, id_mysql, A >::math_type_
  query_columns< ::UniPAX::Priority, id_mysql, A >::
  math (A::table_name, "`math`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Priority-odb.ixx>
