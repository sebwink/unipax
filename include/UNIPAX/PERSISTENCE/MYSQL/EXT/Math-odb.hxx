...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Math >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Math >
  {
    public:
    typedef ::UniPAX::Math object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Math > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Math root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Math, id_mysql, A >:
    query_columns< ::UniPAX::UPBase, id_mysql, A >
  {
    ...
    static const mathML_type_ mathML;
  };

  template <typename A>
  const typename query_columns< ::UniPAX::Math, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Math, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Math, id_mysql, A >::mathML_type_
  query_columns< ::UniPAX::Math, id_mysql, A >::
  mathML (A::table_name, "`mathML`", 0);

  template <typename A>
  struct pointer_query_columns< ::UniPAX::Math, id_mysql, A >:
    query_columns< ::UniPAX::Math, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::UniPAX::Math, id_mysql >:
    public access::object_traits< ::UniPAX::Math >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Math, id_common >:
    public access::object_traits_impl< ::UniPAX::Math, id_mysql >
  {
  };
...
#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Math-odb.ixx>
