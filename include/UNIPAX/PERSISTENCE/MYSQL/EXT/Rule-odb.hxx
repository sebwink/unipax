...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Rule >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Rule >
  {
    public:
    typedef ::UniPAX::Rule object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Rule > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Rule, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Rule, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Rule, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Rule, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::Rule, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Rule, id_mysql >:
    public access::object_traits< ::UniPAX::Rule >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Rule, id_common >:
    public access::object_traits_impl< ::UniPAX::Rule, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Rule, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Rule, id_mysql, A >:
    query_columns_base< ::UniPAX::Rule, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Rule, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Rule, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Rule, id_mysql, A >::math_type_
  query_columns< ::UniPAX::Rule, id_mysql, A >::
  math (A::table_name, "`math`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/Rule-odb.ixx>
