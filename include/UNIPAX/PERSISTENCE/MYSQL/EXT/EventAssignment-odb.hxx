...
#ifndef EVENT_ASSIGNMENT_ODB_HXX
#define EVENT_ASSIGNMENT_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::EventAssignment >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::EventAssignment >
  {
    public:
    typedef ::UniPAX::EventAssignment object_type;
    typedef ::boost::shared_ptr< ::UniPAX::EventAssignment > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::EventAssignment root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >:
    pointer_query_columns< ::UniPAX::SBase, id_mysql, A >
  {
    ...
    static const variable_type_ variable;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::variable_type_
  pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::math_type_
  pointer_query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  math (A::table_name, "`math`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >:
    public access::object_traits< ::UniPAX::EventAssignment >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::SBase, id_mysql >::image_type
    {
      ...
      // variable
      //
      details::buffer variable_value;
      unsigned long variable_size;
      my_bool variable_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::EventAssignment, id_common >:
    public access::object_traits_impl< ::UniPAX::EventAssignment, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::EventAssignment, id_mysql >
  {
    // math
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::EventAssignment, id_mysql, A >:
    query_columns_base< ::UniPAX::EventAssignment, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::EventAssignment, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::EventAssignment, id_mysql, A >::variable_type_
  query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  variable (A::table_name, "`variable`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::EventAssignment, id_mysql, A >::math_type_
  query_columns< ::UniPAX::EventAssignment, id_mysql, A >::
  math (A::table_name, "`math`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/EXT/EventAssignment-odb.ixx>

#include <odb/post.hxx>

#endif // EVENT_ASSIGNMENT_ODB_HXX
