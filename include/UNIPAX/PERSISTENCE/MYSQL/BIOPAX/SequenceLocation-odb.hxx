...
#ifndef SEQUENCE_LOCATION_ODB_HXX
#define SEQUENCE_LOCATION_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::SequenceLocation >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::SequenceLocation >
  {
    public:
    typedef ::UniPAX::SequenceLocation object_type;
    typedef ::boost::shared_ptr< ::UniPAX::SequenceLocation > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SequenceLocation, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceLocation, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::SequenceLocation, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >:
    public access::object_traits< ::UniPAX::SequenceLocation >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SequenceLocation, id_common >:
    public access::object_traits_impl< ::UniPAX::SequenceLocation, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::SequenceLocation, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SequenceLocation, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::SequenceLocation, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SequenceLocation-odb.ixx>

#include <odb/post.hxx>

#endif // SEQUENCE_LOCATION_ODB_HXX
