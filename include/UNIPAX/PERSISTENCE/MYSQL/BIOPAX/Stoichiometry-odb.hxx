...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::Stoichiometry >
  {
    ...
    typedef ::UniPAX::Stoichiometry root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >:
    pointer_query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    mysql::query_column<
      ...
      mysql::id_ulonglong >
    physicalEntity_type_;

    static const physicalEntity_type_ physicalEntity;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::stoichiometricCoefficient_type_
  pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  stoichiometricCoefficient (A::table_name, "`stoichiometricCoefficient`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::physicalEntity_type_
  pointer_query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  physicalEntity (A::table_name, "`physicalEntity`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >:
    public access::object_traits< ::UniPAX::Stoichiometry >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UtilityClass, id_mysql >::image_type
    {
      ...
      my_bool stoichiometricCoefficient_null;

      // physicalEntity
      //
      unsigned long long physicalEntity_value;
      my_bool physicalEntity_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Stoichiometry, id_common >:
    public access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Stoichiometry, id_mysql >
  {
    // physicalEntity
    //
    typedef
    odb::alias_traits<
      ...
      id_mysql,
      access::object_traits_impl< ::UniPAX::Stoichiometry, id_mysql >::physicalEntity_tag>
    physicalEntity_alias_;
  };

  template <typename A>
  struct query_columns< ::UniPAX::Stoichiometry, id_mysql, A >:
    query_columns_base< ::UniPAX::Stoichiometry, id_mysql >,
    query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        physicalEntity_alias_ > >
    physicalEntity_pointer_type_;

    struct physicalEntity_type_: physicalEntity_pointer_type_, physicalEntity_column_type_
    {
      physicalEntity_type_ (const char* t, const char* c, const char* conv)
        : physicalEntity_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::stoichiometricCoefficient_type_
  query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  stoichiometricCoefficient (A::table_name, "`stoichiometricCoefficient`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::physicalEntity_type_
  query_columns< ::UniPAX::Stoichiometry, id_mysql, A >::
  physicalEntity (A::table_name, "`physicalEntity`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Stoichiometry-odb.ixx>
