...
#ifndef CHEMICAL_STRUCTURE_ODB_HXX
#define CHEMICAL_STRUCTURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::ChemicalStructure >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::ChemicalStructure >
  {
    public:
    typedef ::UniPAX::ChemicalStructure object_type;
    typedef ::boost::shared_ptr< ::UniPAX::ChemicalStructure > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::ChemicalStructure root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >:
    pointer_query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    static const structureData_type_ structureData;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_string >::query_type,
      mysql::id_string >
    structureFormat_type_;

    static const structureFormat_type_ structureFormat;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::structureData_type_
  pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  structureData (A::table_name, "`structureData`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::structureFormat_type_
  pointer_query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  structureFormat (A::table_name, "`structureFormat`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >:
    public access::object_traits< ::UniPAX::ChemicalStructure >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UtilityClass, id_mysql >::image_type
    {
      ...
      // structureData
      //
      details::buffer structureData_value;
      unsigned long structureData_size;
      my_bool structureData_null;

      // structureFormat
      //
      details::buffer structureFormat_value;
      unsigned long structureFormat_size;
      my_bool structureFormat_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::ChemicalStructure, id_common >:
    public access::object_traits_impl< ::UniPAX::ChemicalStructure, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::structureData_type_
  query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  structureData (A::table_name, "`structureData`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::structureFormat_type_
  query_columns< ::UniPAX::ChemicalStructure, id_mysql, A >::
  structureFormat (A::table_name, "`structureFormat`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/ChemicalStructure-odb.ixx>

#include <odb/post.hxx>

#endif // CHEMICAL_STRUCTURE_ODB_HXX
