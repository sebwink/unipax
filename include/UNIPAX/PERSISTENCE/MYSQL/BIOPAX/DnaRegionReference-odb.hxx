...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >:
    pointer_query_columns< ::UniPAX::EntityReference, id_mysql, typename A::base_traits >
  {
    ...
    static const subRegion_type_ subRegion;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_ulonglong >::query_type,
      mysql::id_ulonglong >
    absoluteRegion_type_;

    static const absoluteRegion_type_ absoluteRegion;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::sequence_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::subRegion_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::regionType_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  regionType (A::table_name, "`regionType`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::organism_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::absoluteRegion_type_
  pointer_query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  absoluteRegion (A::table_name, "`absoluteRegion`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >:
    public access::object_traits< ::UniPAX::DnaRegionReference >
  {
    public:
    ...
    struct image_type
    {
      ...
      // subRegion
      //
      unsigned long long subRegion_value;
      my_bool subRegion_null;

      // regionType
      //
      unsigned long long regionType_value;
      my_bool regionType_null;
      ...
      // absoluteRegion
      //
      unsigned long long absoluteRegion_value;
      my_bool absoluteRegion_null;
    ...
    struct subRegion_tag;
    struct regionType_tag;
    struct organism_tag;
    struct absoluteRegion_tag;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::DnaRegionReference, id_common >:
    public access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >
  {
  };
  ...
  struct alias_traits<
    ...
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::subRegion_tag>
  {
    static const char table_name[];
  };
  ...
  struct alias_traits<
    ...
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::regionType_tag>
  {
    static const char table_name[];
  };
  ...
  struct alias_traits<
    ::UniPAX::BioSource,
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::organism_tag>
  {
    static const char table_name[];
  };
  ...
  struct alias_traits<
    ...
    id_mysql,
    access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::absoluteRegion_tag>
  {
    static const char table_name[];
  };

  template <>
  struct query_columns_base< ::UniPAX::DnaRegionReference, id_mysql >
  {
    // subRegion
    //
    typedef
    ...
    odb::alias_traits<
      ...
      id_mysql,
      access::object_traits_impl< ::UniPAX::DnaRegionReference, id_mysql >::absoluteRegion_tag>
    absoluteRegion_alias_;
  };

  template <typename A>
  struct query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >:
    query_columns_base< ::UniPAX::DnaRegionReference, id_mysql >,
    query_columns< ::UniPAX::EntityReference, id_mysql, typename A::base_traits >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        subRegion_alias_ > >
    subRegion_pointer_type_;

    struct subRegion_type_: subRegion_pointer_type_, subRegion_column_type_
    {
      subRegion_type_ (const char* t, const char* c, const char* conv)
        : subRegion_column_type_ (t, c, conv)
      {
      }
    };
    ...
    {
      regionType_type_ (const char* t, const char* c, const char* conv)
        : regionType_column_type_ (t, c, conv)
      {
      }
    };
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        absoluteRegion_alias_ > >
    absoluteRegion_pointer_type_;

    struct absoluteRegion_type_: absoluteRegion_pointer_type_, absoluteRegion_column_type_
    {
      absoluteRegion_type_ (const char* t, const char* c, const char* conv)
        : absoluteRegion_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::sequence_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::subRegion_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::regionType_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  regionType (A::table_name, "`regionType`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::organism_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::absoluteRegion_type_
  query_columns< ::UniPAX::DnaRegionReference, id_mysql, A >::
  absoluteRegion (A::table_name, "`absoluteRegion`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/DnaRegionReference-odb.ixx>
