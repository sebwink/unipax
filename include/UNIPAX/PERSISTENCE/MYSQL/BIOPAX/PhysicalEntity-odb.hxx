...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::cellularLocation_type_
  pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::
  cellularLocation (A::table_name, "`cellularLocation`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >:
    public access::object_traits< ::UniPAX::PhysicalEntity >
  {
    public:
    ...
    struct image_type
    {
      ...
      // cellularLocation
      //
      unsigned long long cellularLocation_value;
      my_bool cellularLocation_null;
    ...
    struct feature_traits
    {
      ...
      typedef ::std::vector< ::boost::shared_ptr< ::UniPAX::EntityFeature > > container_type;
      typedef
      ...
      typedef mysql::container_statements< feature_traits > statements_type;
    ...
    //
    struct memberPhysicalEntity_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< memberPhysicalEntity_traits > statements_type;
    ...
    struct notFeature_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< notFeature_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::PhysicalEntity, id_common >:
    public access::object_traits_impl< ::UniPAX::PhysicalEntity, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::PhysicalEntity, id_mysql >
  {
    // cellularLocation
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >:
    query_columns_base< ::UniPAX::PhysicalEntity, id_mysql >,
    query_columns< ::UniPAX::Entity, id_mysql, typename A::base_traits >
  {
    ...
    {
      cellularLocation_type_ (const char* t, const char* c, const char* conv)
        : cellularLocation_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::cellularLocation_type_
  query_columns< ::UniPAX::PhysicalEntity, id_mysql, A >::
  cellularLocation (A::table_name, "`cellularLocation`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/PhysicalEntity-odb.ixx>
