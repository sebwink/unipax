...
#ifndef SMALL_MOLECULE_ODB_HXX
#define SMALL_MOLECULE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::SmallMolecule >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::SmallMolecule >
  {
    public:
    typedef ::UniPAX::SmallMolecule object_type;
    typedef ::boost::shared_ptr< ::UniPAX::SmallMolecule > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Entity root_type;
    typedef ::UniPAX::PhysicalEntity base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SmallMolecule, id_mysql, A >:
    pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, typename A::base_traits >
  {
    // PhysicalEntity
    //
    typedef pointer_query_columns< ::UniPAX::PhysicalEntity, id_mysql, typename A::base_traits > PhysicalEntity;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SmallMolecule, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::SmallMolecule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SmallMolecule, id_mysql >:
    public access::object_traits< ::UniPAX::SmallMolecule >
  {
    public:
    ...
    struct entityReference_traits
    {
      ...
      typedef mysql::container_statements< entityReference_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SmallMolecule, id_common >:
    public access::object_traits_impl< ::UniPAX::SmallMolecule, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::SmallMolecule, id_mysql, A >:
    query_columns< ::UniPAX::PhysicalEntity, id_mysql, typename A::base_traits >
  {
    // PhysicalEntity
    //
    typedef query_columns< ::UniPAX::PhysicalEntity, id_mysql, typename A::base_traits > PhysicalEntity;
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SmallMolecule, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::SmallMolecule, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SmallMolecule-odb.ixx>

#include <odb/post.hxx>

#endif // SMALL_MOLECULE_ODB_HXX
