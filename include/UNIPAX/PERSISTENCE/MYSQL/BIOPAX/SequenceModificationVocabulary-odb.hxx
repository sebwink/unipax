...
#ifndef SEQUENCE_MODIFICATION_VOCABULARY_ODB_HXX
#define SEQUENCE_MODIFICATION_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::SequenceModificationVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::SequenceModificationVocabulary >
  {
    public:
    typedef ::UniPAX::SequenceModificationVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::SequenceModificationVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::SequenceModificationVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::SequenceModificationVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::SequenceModificationVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SequenceModificationVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // SEQUENCE_MODIFICATION_VOCABULARY_ODB_HXX
