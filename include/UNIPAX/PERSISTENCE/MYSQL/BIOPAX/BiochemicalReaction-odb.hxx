...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::deltaH_type_
  pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  deltaH (A::table_name, "`deltaH`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::deltaS_type_
  pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  deltaS (A::table_name, "`deltaS`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::eCNumber_type_
  pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  eCNumber (A::table_name, "`eCNumber`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::BiochemicalReaction, id_mysql >:
    public access::object_traits< ::UniPAX::BiochemicalReaction >
  {
    public:
    ...
    struct image_type
    {
      ...
      // eCNumber
      //
      details::buffer eCNumber_value;
      unsigned long eCNumber_size;
      my_bool eCNumber_null;
    ...
    struct deltaG_traits
    {
      ...
      typedef mysql::container_statements< deltaG_traits > statements_type;
    ...
    struct kEQ_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< kEQ_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::BiochemicalReaction, id_common >:
    public access::object_traits_impl< ::UniPAX::BiochemicalReaction, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::deltaH_type_
  query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  deltaH (A::table_name, "`deltaH`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::deltaS_type_
  query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  deltaS (A::table_name, "`deltaS`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::eCNumber_type_
  query_columns< ::UniPAX::BiochemicalReaction, id_mysql, A >::
  eCNumber (A::table_name, "`eCNumber`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/BiochemicalReaction-odb.ixx>
