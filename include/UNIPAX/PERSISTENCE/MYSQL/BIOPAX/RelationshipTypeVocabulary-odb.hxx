...
#ifndef RELATIONSHIP_TYPE_VOCABULARY_ODB_HXX
#define RELATIONSHIP_TYPE_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::RelationshipTypeVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::RelationshipTypeVocabulary >
  {
    public:
    typedef ::UniPAX::RelationshipTypeVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::RelationshipTypeVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::RelationshipTypeVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::RelationshipTypeVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::RelationshipTypeVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::RelationshipTypeVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::RelationshipTypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/RelationshipTypeVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // RELATIONSHIP_TYPE_VOCABULARY_ODB_HXX
