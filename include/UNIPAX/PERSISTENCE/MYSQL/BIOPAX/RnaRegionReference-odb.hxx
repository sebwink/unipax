...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::sequence_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::subRegion_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::absoluteRegion_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  absoluteRegion (A::table_name, "`absoluteRegion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::organism_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::regionType_type_
  pointer_query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  regionType (A::table_name, "`regionType`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::RnaRegionReference, id_mysql >:
    public access::object_traits< ::UniPAX::RnaRegionReference >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::RnaRegionReference, id_common >:
    public access::object_traits_impl< ::UniPAX::RnaRegionReference, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::RnaRegionReference, id_mysql >
  {
    // subRegion
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >:
    query_columns_base< ::UniPAX::RnaRegionReference, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::sequence_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::subRegion_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::absoluteRegion_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  absoluteRegion (A::table_name, "`absoluteRegion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::organism_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::regionType_type_
  query_columns< ::UniPAX::RnaRegionReference, id_mysql, A >::
  regionType (A::table_name, "`regionType`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/RnaRegionReference-odb.ixx>
