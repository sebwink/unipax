...
#ifndef CELLULAR_LOCATION_VOCABULARY_ODB_HXX
#define CELLULAR_LOCATION_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::CellularLocationVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::CellularLocationVocabulary >
  {
    public:
    typedef ::UniPAX::CellularLocationVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::CellularLocationVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::CellularLocationVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::CellularLocationVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::CellularLocationVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::CellularLocationVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::CellularLocationVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/CellularLocationVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // CELLULAR_LOCATION_VOCABULARY_ODB_HXX
