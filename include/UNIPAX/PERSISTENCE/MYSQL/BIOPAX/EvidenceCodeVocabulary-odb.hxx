...
#ifndef EVIDENCE_CODE_VOCABULARY_ODB_HXX
#define EVIDENCE_CODE_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::EvidenceCodeVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::EvidenceCodeVocabulary >
  {
    public:
    typedef ::UniPAX::EvidenceCodeVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::EvidenceCodeVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::EvidenceCodeVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::EvidenceCodeVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::EvidenceCodeVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::EvidenceCodeVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::EvidenceCodeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/EvidenceCodeVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // EVIDENCE_CODE_VOCABULARY_ODB_HXX
