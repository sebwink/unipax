...
#ifndef CONTROLLED_VOCABULARY_ODB_HXX
#define CONTROLLED_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::ControlledVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::ControlledVocabulary >
  {
    public:
    typedef ::UniPAX::ControlledVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::ControlledVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >:
    pointer_query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    static const term_type_ term;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::term_type_
  pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::
  term (A::table_name, "`term`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::ControlledVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::ControlledVocabulary >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UtilityClass, id_mysql >::image_type
    {
      ...
      // term
      //
      details::buffer term_value;
      unsigned long term_size;
      my_bool term_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::ControlledVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::ControlledVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::term_type_
  query_columns< ::UniPAX::ControlledVocabulary, id_mysql, A >::
  term (A::table_name, "`term`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/ControlledVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // CONTROLLED_VOCABULARY_ODB_HXX
