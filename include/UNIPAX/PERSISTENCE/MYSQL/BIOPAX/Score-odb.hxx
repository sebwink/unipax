...
#ifndef SCORE_ODB_HXX
#define SCORE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Score >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Score >
  {
    public:
    typedef ::UniPAX::Score object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Score > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::Score root_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Score, id_mysql, A >:
    pointer_query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    static const scoreSource_type_ scoreSource;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Score, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Score, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Score, id_mysql, A >::scoreSource_type_
  pointer_query_columns< ::UniPAX::Score, id_mysql, A >::
  scoreSource (A::table_name, "`scoreSource`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Score, id_mysql, A >::value_type_
  pointer_query_columns< ::UniPAX::Score, id_mysql, A >::
  value (A::table_name, "`value`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Score, id_mysql >:
    public access::object_traits< ::UniPAX::Score >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UtilityClass, id_mysql >::image_type
    {
      ...
      // scoreSource
      //
      unsigned long long scoreSource_value;
      my_bool scoreSource_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Score, id_common >:
    public access::object_traits_impl< ::UniPAX::Score, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Score, id_mysql >
  {
    // scoreSource
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Score, id_mysql, A >:
    query_columns_base< ::UniPAX::Score, id_mysql >,
    query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        scoreSource_alias_ > >
    scoreSource_pointer_type_;

    struct scoreSource_type_: scoreSource_pointer_type_, scoreSource_column_type_
    {
      scoreSource_type_ (const char* t, const char* c, const char* conv)
        : scoreSource_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Score, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Score, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Score, id_mysql, A >::scoreSource_type_
  query_columns< ::UniPAX::Score, id_mysql, A >::
  scoreSource (A::table_name, "`scoreSource`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Score, id_mysql, A >::value_type_
  query_columns< ::UniPAX::Score, id_mysql, A >::
  value (A::table_name, "`value`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Score-odb.ixx>
