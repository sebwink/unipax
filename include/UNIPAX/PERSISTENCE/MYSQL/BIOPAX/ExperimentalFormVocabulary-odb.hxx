...
#ifndef EXPERIMENTAL_FORM_VOCABULARY_ODB_HXX
#define EXPERIMENTAL_FORM_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::ExperimentalFormVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::ExperimentalFormVocabulary >
  {
    public:
    typedef ::UniPAX::ExperimentalFormVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::ExperimentalFormVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::ExperimentalFormVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::ExperimentalFormVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::ExperimentalFormVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::ExperimentalFormVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::ExperimentalFormVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/ExperimentalFormVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // EXPERIMENTAL_FORM_VOCABULARY_ODB_HXX
