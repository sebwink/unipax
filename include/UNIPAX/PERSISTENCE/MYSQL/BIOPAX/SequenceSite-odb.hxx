...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::positionStatus_type_
  pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  positionStatus (A::table_name, "`positionStatus`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::sequencePosition_type_
  pointer_query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  sequencePosition (A::table_name, "`sequencePosition`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >:
    public access::object_traits< ::UniPAX::SequenceSite >
  {
    public:
    ...
    struct image_type
    {
      ...
      // positionStatus
      //
      details::buffer positionStatus_value;
      unsigned long positionStatus_size;
      my_bool positionStatus_null;

      // sequencePosition
      //
      int sequencePosition_value;
      my_bool sequencePosition_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SequenceSite, id_common >:
    public access::object_traits_impl< ::UniPAX::SequenceSite, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::SequenceSite, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SequenceSite, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::SequenceSite, id_mysql, A >::positionStatus_type_
  query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  positionStatus (A::table_name, "`positionStatus`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::SequenceSite, id_mysql, A >::sequencePosition_type_
  query_columns< ::UniPAX::SequenceSite, id_mysql, A >::
  sequencePosition (A::table_name, "`sequencePosition`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SequenceSite-odb.ixx>
