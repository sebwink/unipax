...
#ifndef UNIFICATION_XREF_ODB_HXX
#define UNIFICATION_XREF_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::UnificationXref >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::UnificationXref >
  {
    public:
    typedef ::UniPAX::UnificationXref object_type;
    typedef ::boost::shared_ptr< ::UniPAX::UnificationXref > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::UnificationXref, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::UnificationXref, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::UnificationXref, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >:
    public access::object_traits< ::UniPAX::UnificationXref >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::UnificationXref, id_common >:
    public access::object_traits_impl< ::UniPAX::UnificationXref, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::UnificationXref, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::UnificationXref, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::UnificationXref, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/UnificationXref-odb.ixx>

#include <odb/post.hxx>

#endif // UNIFICATION_XREF_ODB_HXX
