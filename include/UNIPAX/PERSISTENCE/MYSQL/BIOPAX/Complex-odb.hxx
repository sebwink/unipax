...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Complex, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Complex, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::Complex, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Complex, id_mysql >:
    public access::object_traits< ::UniPAX::Complex >
  {
    public:
    ...
    struct component_traits
    {
      ...
      typedef mysql::container_statements< component_traits > statements_type;
    ...
    struct componentStoichiometry_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< componentStoichiometry_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Complex, id_common >:
    public access::object_traits_impl< ::UniPAX::Complex, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Complex, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Complex, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::Complex, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Complex-odb.ixx>
