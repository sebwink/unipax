...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Rna, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Rna, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::Rna, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Rna, id_mysql >:
    public access::object_traits< ::UniPAX::Rna >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Rna, id_common >:
    public access::object_traits_impl< ::UniPAX::Rna, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Rna, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Rna, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::Rna, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Rna-odb.ixx>
