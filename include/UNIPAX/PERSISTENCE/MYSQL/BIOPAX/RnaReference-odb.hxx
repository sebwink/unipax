...
#ifndef RNA_REFERENCE_ODB_HXX
#define RNA_REFERENCE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::RnaReference >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::RnaReference >
  {
    public:
    typedef ::UniPAX::RnaReference object_type;
    typedef ::boost::shared_ptr< ::UniPAX::RnaReference > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::sequence_type_
  pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::subRegion_type_
  pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::organism_type_
  pointer_query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >:
    public access::object_traits< ::UniPAX::RnaReference >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::RnaReference, id_common >:
    public access::object_traits_impl< ::UniPAX::RnaReference, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::RnaReference, id_mysql >
  {
    // subRegion
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::RnaReference, id_mysql, A >:
    query_columns_base< ::UniPAX::RnaReference, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::RnaReference, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaReference, id_mysql, A >::sequence_type_
  query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  sequence (A::table_name, "`sequence`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaReference, id_mysql, A >::subRegion_type_
  query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  subRegion (A::table_name, "`subRegion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::RnaReference, id_mysql, A >::organism_type_
  query_columns< ::UniPAX::RnaReference, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/RnaReference-odb.ixx>

#include <odb/post.hxx>

#endif // RNA_REFERENCE_ODB_HXX
