...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >:
    public access::object_traits< ::UniPAX::GeneticInteraction >
  {
    public:
    ...
    struct phenotype_traits
    {
      ...
      typedef mysql::container_statements< phenotype_traits > statements_type;
    ...
    struct interactionScore_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< interactionScore_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::GeneticInteraction, id_common >:
    public access::object_traits_impl< ::UniPAX::GeneticInteraction, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::GeneticInteraction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/GeneticInteraction-odb.ixx>
