...
#ifndef ENTITY_REFERENCE_TYPE_VOCABULARY_ODB_HXX
#define ENTITY_REFERENCE_TYPE_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::EntityReferenceTypeVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::EntityReferenceTypeVocabulary >
  {
    public:
    typedef ::UniPAX::EntityReferenceTypeVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::EntityReferenceTypeVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::EntityReferenceTypeVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::EntityReferenceTypeVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::EntityReferenceTypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/EntityReferenceTypeVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // ENTITY_REFERENCE_TYPE_VOCABULARY_ODB_HXX
