...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Gene >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Gene >
  {
    public:
    typedef ::UniPAX::Gene object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Gene > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Gene, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Gene, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::Gene, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Gene, id_mysql, A >::organism_type_
  pointer_query_columns< ::UniPAX::Gene, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Gene, id_mysql >:
    public access::object_traits< ::UniPAX::Gene >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Gene, id_common >:
    public access::object_traits_impl< ::UniPAX::Gene, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Gene, id_mysql >
  {
    // organism
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Gene, id_mysql, A >:
    query_columns_base< ::UniPAX::Gene, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Gene, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::Gene, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Gene, id_mysql, A >::organism_type_
  query_columns< ::UniPAX::Gene, id_mysql, A >::
  organism (A::table_name, "`organism`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Gene-odb.ixx>
