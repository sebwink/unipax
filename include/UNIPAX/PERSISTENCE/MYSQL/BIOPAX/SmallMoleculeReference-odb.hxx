...
#ifndef SMALL_MOLECULE_REFERENCE_ODB_HXX
#define SMALL_MOLECULE_REFERENCE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::SmallMoleculeReference >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::SmallMoleculeReference >
  {
    public:
    typedef ::UniPAX::SmallMoleculeReference object_type;
    typedef ::boost::shared_ptr< ::UniPAX::SmallMoleculeReference > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >:
    pointer_query_columns< ::UniPAX::EntityReference, id_mysql, typename A::base_traits >
  {
    ...
    mysql::query_column<
      ...
      mysql::id_string >
    chemicalFormula_type_;

    static const chemicalFormula_type_ chemicalFormula;
    ...
    mysql::query_column<
      ...
      mysql::id_double >
    molecularWeight_type_;

    static const molecularWeight_type_ molecularWeight;
    ...
    static const structure_type_ structure;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::chemicalFormula_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  chemicalFormula (A::table_name, "`chemicalFormula`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::molecularWeight_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  molecularWeight (A::table_name, "`molecularWeight`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::structure_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  structure (A::table_name, "`structure`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >:
    public access::object_traits< ::UniPAX::SmallMoleculeReference >
  {
    public:
    ...
    struct image_type
    {
      ...
      // chemicalFormula
      //
      details::buffer chemicalFormula_value;
      unsigned long chemicalFormula_size;
      my_bool chemicalFormula_null;

      // molecularWeight
      //
      double molecularWeight_value;
      my_bool molecularWeight_null;

      // structure
      //
      unsigned long long structure_value;
      my_bool structure_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_common >:
    public access::object_traits_impl< ::UniPAX::SmallMoleculeReference, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::SmallMoleculeReference, id_mysql >
  {
    // structure
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >:
    query_columns_base< ::UniPAX::SmallMoleculeReference, id_mysql >,
    query_columns< ::UniPAX::EntityReference, id_mysql, typename A::base_traits >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        structure_alias_ > >
    structure_pointer_type_;

    struct structure_type_: structure_pointer_type_, structure_column_type_
    {
      structure_type_ (const char* t, const char* c, const char* conv)
        : structure_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::chemicalFormula_type_
  query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  chemicalFormula (A::table_name, "`chemicalFormula`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::molecularWeight_type_
  query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  molecularWeight (A::table_name, "`molecularWeight`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::structure_type_
  query_columns< ::UniPAX::SmallMoleculeReference, id_mysql, A >::
  structure (A::table_name, "`structure`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SmallMoleculeReference-odb.ixx>

#include <odb/post.hxx>

#endif // SMALL_MOLECULE_REFERENCE_ODB_HXX
