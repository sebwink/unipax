...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::BiochemicalPathwayStep >
  {
    ...
    typedef ::UniPAX::PathwayStep root_type;
    typedef ::UniPAX::PathwayStep base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >:
    pointer_query_columns< ::UniPAX::PathwayStep, id_mysql, typename A::base_traits >
  {
    // PathwayStep
    //
    typedef pointer_query_columns< ::UniPAX::PathwayStep, id_mysql, typename A::base_traits > PathwayStep;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_ulonglong >::query_type,
      mysql::id_ulonglong >
    stepConversion_type_;

    static const stepConversion_type_ stepConversion;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::stepDirection_type_
  pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  stepDirection (A::table_name, "`stepDirection`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::stepConversion_type_
  pointer_query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  stepConversion (A::table_name, "`stepConversion`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::BiochemicalPathwayStep, id_mysql >:
    public access::object_traits< ::UniPAX::BiochemicalPathwayStep >
  {
    public:
    ...
    struct image_type
    {
      ...
      // stepDirection
      //
      details::buffer stepDirection_value;
      unsigned long stepDirection_size;
      my_bool stepDirection_null;

      // stepConversion
      //
      unsigned long long stepConversion_value;
      my_bool stepConversion_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::BiochemicalPathwayStep, id_common >:
    public access::object_traits_impl< ::UniPAX::BiochemicalPathwayStep, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::BiochemicalPathwayStep, id_mysql >
  {
    // stepConversion
    //
    typedef
    odb::alias_traits<
      ...
      id_mysql,
      access::object_traits_impl< ::UniPAX::BiochemicalPathwayStep, id_mysql >::stepConversion_tag>
    stepConversion_alias_;
  };

  template <typename A>
  struct query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >:
    query_columns_base< ::UniPAX::BiochemicalPathwayStep, id_mysql >,
    query_columns< ::UniPAX::PathwayStep, id_mysql, typename A::base_traits >
  {
    // PathwayStep
    //
    typedef query_columns< ::UniPAX::PathwayStep, id_mysql, typename A::base_traits > PathwayStep;
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        stepConversion_alias_ > >
    stepConversion_pointer_type_;

    struct stepConversion_type_: stepConversion_pointer_type_, stepConversion_column_type_
    {
      stepConversion_type_ (const char* t, const char* c, const char* conv)
        : stepConversion_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::stepDirection_type_
  query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  stepDirection (A::table_name, "`stepDirection`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::stepConversion_type_
  query_columns< ::UniPAX::BiochemicalPathwayStep, id_mysql, A >::
  stepConversion (A::table_name, "`stepConversion`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/BiochemicalPathwayStep-odb.ixx>
