...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Control, id_mysql, A >:
    pointer_query_columns< ::UniPAX::Interaction, id_mysql, typename A::base_traits >
  {
    ...
    static const controlled_type_ controlled;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Control, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::Control, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Control, id_mysql, A >::controlType_type_
  pointer_query_columns< ::UniPAX::Control, id_mysql, A >::
  controlType (A::table_name, "`controlType`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Control, id_mysql, A >::controlled_type_
  pointer_query_columns< ::UniPAX::Control, id_mysql, A >::
  controlled (A::table_name, "`controlled`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Control, id_mysql >:
    public access::object_traits< ::UniPAX::Control >
  {
    public:
    ...
    struct image_type
    {
      ...
      // controlType
      //
      details::buffer controlType_value;
      unsigned long controlType_size;
      my_bool controlType_null;

      // controlled
      //
      unsigned long long controlled_value;
      my_bool controlled_null;
    ...
    struct controller_traits
    {
      ...
      typedef mysql::container_statements< controller_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Control, id_common >:
    public access::object_traits_impl< ::UniPAX::Control, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::Control, id_mysql >
  {
    // controlled
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::Control, id_mysql, A >:
    query_columns_base< ::UniPAX::Control, id_mysql >,
    query_columns< ::UniPAX::Interaction, id_mysql, typename A::base_traits >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        controlled_alias_ > >
    controlled_pointer_type_;

    struct controlled_type_: controlled_pointer_type_, controlled_column_type_
    {
      controlled_type_ (const char* t, const char* c, const char* conv)
        : controlled_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Control, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::Control, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Control, id_mysql, A >::controlType_type_
  query_columns< ::UniPAX::Control, id_mysql, A >::
  controlType (A::table_name, "`controlType`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Control, id_mysql, A >::controlled_type_
  query_columns< ::UniPAX::Control, id_mysql, A >::
  controlled (A::table_name, "`controlled`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Control-odb.ixx>
