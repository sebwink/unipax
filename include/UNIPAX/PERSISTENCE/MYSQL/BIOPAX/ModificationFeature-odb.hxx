...
#ifndef MODIFICATION_FEATURE_ODB_HXX
#define MODIFICATION_FEATURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::ModificationFeature >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::ModificationFeature >
  {
    public:
    typedef ::UniPAX::ModificationFeature object_type;
    typedef ::boost::shared_ptr< ::UniPAX::ModificationFeature > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::EntityFeature root_type;
    typedef ::UniPAX::EntityFeature base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::ModificationFeature, id_mysql, A >:
    pointer_query_columns< ::UniPAX::EntityFeature, id_mysql, typename A::base_traits >
  {
    // EntityFeature
    //
    typedef pointer_query_columns< ::UniPAX::EntityFeature, id_mysql, typename A::base_traits > EntityFeature;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::modificationType_type_
  pointer_query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::
  modificationType (A::table_name, "`modificationType`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >:
    public access::object_traits< ::UniPAX::ModificationFeature >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::ModificationFeature, id_common >:
    public access::object_traits_impl< ::UniPAX::ModificationFeature, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::UniPAX::ModificationFeature, id_mysql >
  {
    // modificationType
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::UniPAX::ModificationFeature, id_mysql, A >:
    query_columns_base< ::UniPAX::ModificationFeature, id_mysql >,
    query_columns< ::UniPAX::EntityFeature, id_mysql, typename A::base_traits >
  {
    // EntityFeature
    //
    typedef query_columns< ::UniPAX::EntityFeature, id_mysql, typename A::base_traits > EntityFeature;
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::modificationType_type_
  query_columns< ::UniPAX::ModificationFeature, id_mysql, A >::
  modificationType (A::table_name, "`modificationType`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/ModificationFeature-odb.ixx>

#include <odb/post.hxx>

#endif // MODIFICATION_FEATURE_ODB_HXX
