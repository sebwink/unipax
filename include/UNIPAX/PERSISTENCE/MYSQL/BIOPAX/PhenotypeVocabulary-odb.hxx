...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::PhenotypeVocabulary >
  {
    ...
    typedef ::UniPAX::ControlledVocabulary root_type;
    typedef ::UniPAX::ControlledVocabulary base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >:
    pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, typename A::base_traits >
  {
    // ControlledVocabulary
    //
    typedef pointer_query_columns< ::UniPAX::ControlledVocabulary, id_mysql, typename A::base_traits > ControlledVocabulary;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::patoData_type_
  pointer_query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::
  patoData (A::table_name, "`patoData`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::PhenotypeVocabulary >
  {
    public:
    ...
    struct image_type
    {
      ...
      // patoData
      //
      details::buffer patoData_value;
      unsigned long patoData_size;
      my_bool patoData_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::PhenotypeVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >:
    query_columns< ::UniPAX::ControlledVocabulary, id_mysql, typename A::base_traits >
  {
    // ControlledVocabulary
    //
    typedef query_columns< ::UniPAX::ControlledVocabulary, id_mysql, typename A::base_traits > ControlledVocabulary;
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::patoData_type_
  query_columns< ::UniPAX::PhenotypeVocabulary, id_mysql, A >::
  patoData (A::table_name, "`patoData`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/PhenotypeVocabulary-odb.ixx>
