...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Xref >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Xref >
  {
    public:
    typedef ::UniPAX::Xref object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Xref > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Xref, id_mysql, A >:
    pointer_query_columns< ::UniPAX::UtilityClass, id_mysql, A >
  {
    ...
    static const idVersion_type_ idVersion;
    ...
    static const dbVersion_type_ dbVersion;
    ...
    static const db_type_ db;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::idVersion_type_
  pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::
  idVersion (A::table_name, "`idVersion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::id_type_
  pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::dbVersion_type_
  pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::
  dbVersion (A::table_name, "`dbVersion`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::db_type_
  pointer_query_columns< ::UniPAX::Xref, id_mysql, A >::
  db (A::table_name, "`db`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Xref, id_mysql >:
    public access::object_traits< ::UniPAX::Xref >
  {
    public:
    ...
    struct image_type: object_traits_impl< ::UniPAX::UtilityClass, id_mysql >::image_type
    {
      ...
      // idVersion
      //
      details::buffer idVersion_value;
      unsigned long idVersion_size;
      my_bool idVersion_null;
      ...
      // dbVersion
      //
      details::buffer dbVersion_value;
      unsigned long dbVersion_size;
      my_bool dbVersion_null;

      // db
      //
      details::buffer db_value;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Xref, id_common >:
    public access::object_traits_impl< ::UniPAX::Xref, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Xref, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Xref, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::Xref, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Xref, id_mysql, A >::idVersion_type_
  query_columns< ::UniPAX::Xref, id_mysql, A >::
  idVersion (A::table_name, "`idVersion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Xref, id_mysql, A >::id_type_
  query_columns< ::UniPAX::Xref, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Xref, id_mysql, A >::dbVersion_type_
  query_columns< ::UniPAX::Xref, id_mysql, A >::
  dbVersion (A::table_name, "`dbVersion`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::Xref, id_mysql, A >::db_type_
  query_columns< ::UniPAX::Xref, id_mysql, A >::
  db (A::table_name, "`db`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Xref-odb.ixx>
