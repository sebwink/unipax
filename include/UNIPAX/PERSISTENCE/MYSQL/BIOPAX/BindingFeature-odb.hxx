...
#ifndef BINDING_FEATURE_ODB_HXX
#define BINDING_FEATURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::BindingFeature >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::BindingFeature >
  {
    public:
    typedef ::UniPAX::BindingFeature object_type;
    typedef ::boost::shared_ptr< ::UniPAX::BindingFeature > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, A >:
    pointer_query_columns< ::UniPAX::EntityFeature, id_mysql, typename A::base_traits >
  {
    ...
    mysql::query_column<
      ...
      mysql::id_tiny >
    intraMolecular_type_;

    static const intraMolecular_type_ intraMolecular;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, A >::intraMolecular_type_
  pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, A >::
  intraMolecular (A::table_name, "`intraMolecular`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >:
    public access::object_traits< ::UniPAX::BindingFeature >
  {
    public:
    ...
    struct image_type
    {
      ...
      // intraMolecular
      //
      signed char intraMolecular_value;
      my_bool intraMolecular_null;
    ...
    struct bindsTo_traits
    {
      ...
      typedef ::std::vector< ::boost::shared_ptr< ::UniPAX::BindingFeature > > container_type;
      typedef
      ...
      typedef mysql::container_statements< bindsTo_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::BindingFeature, id_common >:
    public access::object_traits_impl< ::UniPAX::BindingFeature, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::BindingFeature, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::BindingFeature, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::BindingFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::BindingFeature, id_mysql, A >::intraMolecular_type_
  query_columns< ::UniPAX::BindingFeature, id_mysql, A >::
  intraMolecular (A::table_name, "`intraMolecular`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/BindingFeature-odb.ixx>

#include <odb/post.hxx>

#endif // BINDING_FEATURE_ODB_HXX
