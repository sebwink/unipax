...
#ifndef COVALENT_BINDING_FEATURE_ODB_HXX
#define COVALENT_BINDING_FEATURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::CovalentBindingFeature >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::CovalentBindingFeature >
  {
    public:
    typedef ::UniPAX::CovalentBindingFeature object_type;
    typedef ::boost::shared_ptr< ::UniPAX::CovalentBindingFeature > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::UniPAX::EntityFeature root_type;
    typedef ::UniPAX::BindingFeature base_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >:
    pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, typename A::base_traits >
  {
    // BindingFeature
    //
    typedef pointer_query_columns< ::UniPAX::BindingFeature, id_mysql, typename A::base_traits > BindingFeature;
    ...
    mysql::query_column<
      mysql::value_traits<
        ...
        mysql::id_ulonglong >::query_type,
      mysql::id_ulonglong >
    modificationType_type_;

    static const modificationType_type_ modificationType;
  };

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename pointer_query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::modificationType_type_
  pointer_query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::
  modificationType (A::table_name, "`modificationType`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >:
    public access::object_traits< ::UniPAX::CovalentBindingFeature >
  {
    public:
    ...
    struct image_type
    {
      ...
      // modificationType
      //
      unsigned long long modificationType_value;
      my_bool modificationType_null;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_common >:
    public access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >
  {
  };
  ...
  template <>
  struct alias_traits<
    ::UniPAX::SequenceModificationVocabulary,
    id_mysql,
    access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::modificationType_tag>
  {
  ...
  template <>
  struct query_columns_base< ::UniPAX::CovalentBindingFeature, id_mysql >
  {
    // modificationType
    //
    typedef
    odb::alias_traits<
      ...
      id_mysql,
      access::object_traits_impl< ::UniPAX::CovalentBindingFeature, id_mysql >::modificationType_tag>
    modificationType_alias_;
  };

  template <typename A>
  struct query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >:
    query_columns_base< ::UniPAX::CovalentBindingFeature, id_mysql >,
    query_columns< ::UniPAX::BindingFeature, id_mysql, typename A::base_traits >
  {
    // BindingFeature
    //
    typedef query_columns< ::UniPAX::BindingFeature, id_mysql, typename A::base_traits > BindingFeature;
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        modificationType_alias_ > >
    modificationType_pointer_type_;

    struct modificationType_type_: modificationType_pointer_type_, modificationType_column_type_
    {
      modificationType_type_ (const char* t, const char* c, const char* conv)
        : modificationType_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <typename A>
  const typename query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::modificationType_type_
  query_columns< ::UniPAX::CovalentBindingFeature, id_mysql, A >::
  modificationType (A::table_name, "`modificationType`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/CovalentBindingFeature-odb.ixx>

#include <odb/post.hxx>

#endif // COVALENT_BINDING_FEATURE_ODB_HXX
