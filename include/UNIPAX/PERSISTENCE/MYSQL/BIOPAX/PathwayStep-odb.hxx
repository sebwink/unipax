...
#ifndef PATHWAY_STEP_ODB_HXX
#define PATHWAY_STEP_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::PathwayStep >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::PathwayStep >
  {
    public:
    typedef ::UniPAX::PathwayStep object_type;
    typedef ::boost::shared_ptr< ::UniPAX::PathwayStep > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::PathwayStep, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::PathwayStep, id_mysql, A >::typeid__type_
  pointer_query_columns< ::UniPAX::PathwayStep, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::PathwayStep, id_mysql >:
    public access::object_traits< ::UniPAX::PathwayStep >
  {
    public:
    ...
    struct stepProcess_traits
    {
      ...
      typedef mysql::container_statements< stepProcess_traits > statements_type;
    ...
    struct nextStep_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< nextStep_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::PathwayStep, id_common >:
    public access::object_traits_impl< ::UniPAX::PathwayStep, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::PathwayStep, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::PathwayStep, id_mysql, A >::typeid__type_
  query_columns< ::UniPAX::PathwayStep, id_mysql, A >::
  typeid_ (A::table_name, "`typeid`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/PathwayStep-odb.ixx>

#include <odb/post.hxx>

#endif // PATHWAY_STEP_ODB_HXX
