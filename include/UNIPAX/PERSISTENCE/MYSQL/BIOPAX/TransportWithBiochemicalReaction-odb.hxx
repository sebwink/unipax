...
namespace odb
{
  ...
  class access::object_traits< ::UniPAX::TransportWithBiochemicalReaction >
  {
    ...
    typedef ::UniPAX::BiochemicalReaction base_type;
    ...
    static const std::size_t depth = 5UL;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >:
    pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, typename A::base_traits >
  {
    // BiochemicalReaction
    //
    typedef pointer_query_columns< ::UniPAX::BiochemicalReaction, id_mysql, typename A::base_traits > BiochemicalReaction;
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >:
    public access::object_traits< ::UniPAX::TransportWithBiochemicalReaction >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_common >:
    public access::object_traits_impl< ::UniPAX::TransportWithBiochemicalReaction, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >:
    query_columns< ::UniPAX::BiochemicalReaction, id_mysql, typename A::base_traits >
  {
    // BiochemicalReaction
    //
    typedef query_columns< ::UniPAX::BiochemicalReaction, id_mysql, typename A::base_traits > BiochemicalReaction;
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::TransportWithBiochemicalReaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/TransportWithBiochemicalReaction-odb.ixx>
