...
#ifndef INTERACTION_ODB_HXX
#define INTERACTION_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Interaction >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::Interaction >
  {
    public:
    typedef ::UniPAX::Interaction object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Interaction > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::Interaction, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::Interaction, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::Interaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::Interaction, id_mysql >:
    public access::object_traits< ::UniPAX::Interaction >
  {
    public:
    ...
    struct participant_traits
    {
      ...
      typedef mysql::container_statements< participant_traits > statements_type;
    ...
    struct interactionType_traits
    {
      ...
      typedef ::std::vector< ::boost::shared_ptr< ::UniPAX::InteractionVocabulary > > container_type;
      typedef
      odb::access::container_traits<container_type>
      container_traits_type;
      typedef container_traits_type::index_type index_type;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef mysql::container_statements< interactionType_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::Interaction, id_common >:
    public access::object_traits_impl< ::UniPAX::Interaction, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::Interaction, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::Interaction, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::Interaction, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/Interaction-odb.ixx>

#include <odb/post.hxx>

#endif // INTERACTION_ODB_HXX
