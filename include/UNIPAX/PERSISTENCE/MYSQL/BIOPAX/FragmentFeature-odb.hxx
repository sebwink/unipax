...
#ifndef FRAGMENT_FEATURE_ODB_HXX
#define FRAGMENT_FEATURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::FragmentFeature >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::FragmentFeature >
  {
    public:
    typedef ::UniPAX::FragmentFeature object_type;
    typedef ::boost::shared_ptr< ::UniPAX::FragmentFeature > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::FragmentFeature, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::FragmentFeature, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::FragmentFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >:
    public access::object_traits< ::UniPAX::FragmentFeature >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::FragmentFeature, id_common >:
    public access::object_traits_impl< ::UniPAX::FragmentFeature, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::FragmentFeature, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::FragmentFeature, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::FragmentFeature, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/FragmentFeature-odb.ixx>

#include <odb/post.hxx>

#endif // FRAGMENT_FEATURE_ODB_HXX
