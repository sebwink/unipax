...
#ifndef SEQUENCE_REGION_VOCABULARY_ODB_HXX
#define SEQUENCE_REGION_VOCABULARY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::SequenceRegionVocabulary >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UniPAX::SequenceRegionVocabulary >
  {
    public:
    typedef ::UniPAX::SequenceRegionVocabulary object_type;
    typedef ::boost::shared_ptr< ::UniPAX::SequenceRegionVocabulary > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >::unipaxId_type_
  pointer_query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);

  template <>
  class access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >:
    public access::object_traits< ::UniPAX::SequenceRegionVocabulary >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_common >:
    public access::object_traits_impl< ::UniPAX::SequenceRegionVocabulary, id_mysql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >:
  ...
  template <typename A>
  const typename query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >::unipaxId_type_
  query_columns< ::UniPAX::SequenceRegionVocabulary, id_mysql, A >::
  unipaxId (A::table_name, "`unipaxId`", 0);
}

#include <UNIPAX/PERSISTENCE/MYSQL/BIOPAX/SequenceRegionVocabulary-odb.ixx>

#include <odb/post.hxx>

#endif // SEQUENCE_REGION_VOCABULARY_ODB_HXX
