...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Delay, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Delay, table >::math_type_
  pointer_query_columns< ::UniPAX::Delay, table >::math (table, "\"math\"", 20);
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::Delay >
  {
    // math
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::Delay, table >:
    query_columns_base< ::UniPAX::Delay >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Delay, table >::math_type_
  query_columns< ::UniPAX::Delay, table >::math (table, "\"math\"", 20);

  struct access::object_traits< ::UniPAX::Delay >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Delay, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/Delay-odb.ixx>
