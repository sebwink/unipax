...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::InitialAssignment, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::InitialAssignment, table >::symbol_type_
  pointer_query_columns< ::UniPAX::InitialAssignment, table >::symbol (table, "\"symbol\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::InitialAssignment, table >::math_type_
  pointer_query_columns< ::UniPAX::InitialAssignment, table >::math (table, "\"math\"", 20);
  ...
  class access::object_traits< ::UniPAX::InitialAssignment >
  {
    ...
    struct image_type: object_traits< ::UniPAX::SBase >::image_type
    {
      // symbol
      //
      char symbol_value[512];
      ub2 symbol_size;
      sb2 symbol_indicator;
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::InitialAssignment >
  {
    // math
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::InitialAssignment, table >:
    query_columns_base< ::UniPAX::InitialAssignment >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::InitialAssignment, table >::symbol_type_
  query_columns< ::UniPAX::InitialAssignment, table >::symbol (table, "\"symbol\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::InitialAssignment, table >::math_type_
  query_columns< ::UniPAX::InitialAssignment, table >::math (table, "\"math\"", 20);

  struct access::object_traits< ::UniPAX::InitialAssignment >::query_type:
    query_base_type,
    query_columns< ::UniPAX::InitialAssignment, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/InitialAssignment-odb.ixx>
