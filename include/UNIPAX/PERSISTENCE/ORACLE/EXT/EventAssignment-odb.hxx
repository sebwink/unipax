...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::EventAssignment, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::EventAssignment, table >::variable_type_
  pointer_query_columns< ::UniPAX::EventAssignment, table >::variable (table, "\"variable\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::EventAssignment, table >::math_type_
  pointer_query_columns< ::UniPAX::EventAssignment, table >::math (table, "\"math\"", 20);
  ...
  class access::object_traits< ::UniPAX::EventAssignment >
  {
    ...
    struct image_type: object_traits< ::UniPAX::SBase >::image_type
    {
      // variable
      //
      char variable_value[512];
      ub2 variable_size;
      sb2 variable_indicator;
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::EventAssignment >
  {
    // math
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::EventAssignment, table >:
    query_columns_base< ::UniPAX::EventAssignment >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::EventAssignment, table >::variable_type_
  query_columns< ::UniPAX::EventAssignment, table >::variable (table, "\"variable\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::EventAssignment, table >::math_type_
  query_columns< ::UniPAX::EventAssignment, table >::math (table, "\"math\"", 20);

  struct access::object_traits< ::UniPAX::EventAssignment >::query_type:
    query_base_type,
    query_columns< ::UniPAX::EventAssignment, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/EventAssignment-odb.ixx>
