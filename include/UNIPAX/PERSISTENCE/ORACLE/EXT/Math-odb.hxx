...
namespace odb
{
  ...
  struct query_columns< ::UniPAX::Math, table >: query_columns< ::UniPAX::UPBase, table >
  {
    // UPBase
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Math, table >::mathML_type_
  query_columns< ::UniPAX::Math, table >::mathML (table, "\"mathML\"", 512);

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Math, table >:
    query_columns< ::UniPAX::Math, table >
  {
  };
  ...
  class access::object_traits< ::UniPAX::Math >
  {
    ...
    struct image_type: object_traits< ::UniPAX::UPBase >::image_type
    {
      // mathML
      //
      char mathML_value[512];
      ub2 mathML_size;
      sb2 mathML_indicator;
  ...
  // Math
  //
  struct access::object_traits< ::UniPAX::Math >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Math, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/Math-odb.ixx>
