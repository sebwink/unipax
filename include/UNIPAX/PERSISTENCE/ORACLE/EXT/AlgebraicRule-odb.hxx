...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::AlgebraicRule, table >: pointer_query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::AlgebraicRule, table >: query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
  ...
  struct access::object_traits< ::UniPAX::AlgebraicRule >::query_type:
    query_base_type,
    query_columns< ::UniPAX::AlgebraicRule, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/AlgebraicRule-odb.ixx>
