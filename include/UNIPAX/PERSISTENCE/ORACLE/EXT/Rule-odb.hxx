...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Rule, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Rule, table >::math_type_
  pointer_query_columns< ::UniPAX::Rule, table >::math (table, "\"math\"", 20);
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::Rule >
  {
    // math
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::Rule, table >:
    query_columns_base< ::UniPAX::Rule >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Rule, table >::math_type_
  query_columns< ::UniPAX::Rule, table >::math (table, "\"math\"", 20);

  struct access::object_traits< ::UniPAX::Rule >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Rule, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/Rule-odb.ixx>
