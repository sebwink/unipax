...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::RateRule, table >: pointer_query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::RateRule, table >::variable_type_
  pointer_query_columns< ::UniPAX::RateRule, table >::variable (table, "\"variable\"", 512);
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::RateRule, table >: query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::RateRule, table >::variable_type_
  query_columns< ::UniPAX::RateRule, table >::variable (table, "\"variable\"", 512);

  struct access::object_traits< ::UniPAX::RateRule >::query_type:
    query_base_type,
    query_columns< ::UniPAX::RateRule, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/RateRule-odb.ixx>
