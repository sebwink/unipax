...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::AssignmentRule, table >: pointer_query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
    typedef pointer_query_columns< ::UniPAX::Rule, table > Rule;
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::AssignmentRule, table >::variable_type_
  pointer_query_columns< ::UniPAX::AssignmentRule, table >::variable (table, "\"variable\"", 512);
  ...
  class access::object_traits< ::UniPAX::AssignmentRule >
  {
    ...
    struct image_type: object_traits< ::UniPAX::Rule >::image_type
    {
      // variable
      //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::AssignmentRule, table >: query_columns< ::UniPAX::Rule, table >
  {
    // Rule
    //
    typedef query_columns< ::UniPAX::Rule, table > Rule;
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::AssignmentRule, table >::variable_type_
  query_columns< ::UniPAX::AssignmentRule, table >::variable (table, "\"variable\"", 512);

  struct access::object_traits< ::UniPAX::AssignmentRule >::query_type:
    query_base_type,
    query_columns< ::UniPAX::AssignmentRule, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/AssignmentRule-odb.ixx>
