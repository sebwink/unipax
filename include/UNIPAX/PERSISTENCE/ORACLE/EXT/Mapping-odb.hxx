...
#include <UNIPAX/KERNEL/EXT/Mapping.h>
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Mapping >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct query_columns< ::UniPAX::Mapping, table >: query_columns< ::UniPAX::UPBase, table >
  {
    // UPBase
    //
    ...
    static const idType_type_ idType;
    ...
    static const mapping_type_ mapping;
  };

  template <const char* table>
  const typename query_columns< ::UniPAX::Mapping, table >::idType_type_
  query_columns< ::UniPAX::Mapping, table >::idType (table, "\"idType\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::Mapping, table >::mapping_type_
  query_columns< ::UniPAX::Mapping, table >::mapping (table, "\"mapping\"", 512);

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Mapping, table >:
    query_columns< ::UniPAX::Mapping, table >
  {
  };

  template <>
  class access::object_traits< ::UniPAX::Mapping >
  {
    public:
    typedef ::UniPAX::Mapping object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Mapping > pointer_type;
    ...
    struct image_type: object_traits< ::UniPAX::UPBase >::image_type
    {
      // idType
      //
      char idType_value[512];
      ub2 idType_size;
      sb2 idType_indicator;

      // mapping
      //
      char mapping_value[512];
      ub2 mapping_size;
      sb2 mapping_indicator;
  ...
  // Mapping
  //
  struct access::object_traits< ::UniPAX::Mapping >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Mapping, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/Mapping-odb.ixx>
