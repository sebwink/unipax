...
#ifndef LOCAL_PARAMETER_ODB_HXX
#define LOCAL_PARAMETER_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::LocalParameter >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::LocalParameter, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, table >::id_type_
  pointer_query_columns< ::UniPAX::LocalParameter, table >::id (table, "\"id\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, table >::name_type_
  pointer_query_columns< ::UniPAX::LocalParameter, table >::name (table, "\"name\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, table >::value_type_
  pointer_query_columns< ::UniPAX::LocalParameter, table >::value (table, "\"value\"");

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::LocalParameter, table >::unit_type_
  pointer_query_columns< ::UniPAX::LocalParameter, table >::unit (table, "\"unit\"", 512);

  template <>
  class access::object_traits< ::UniPAX::LocalParameter >
  {
    public:
    typedef ::UniPAX::LocalParameter object_type;
    typedef ::boost::shared_ptr< ::UniPAX::LocalParameter > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::LocalParameter, table >: query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::LocalParameter, table >::id_type_
  query_columns< ::UniPAX::LocalParameter, table >::id (table, "\"id\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::LocalParameter, table >::name_type_
  query_columns< ::UniPAX::LocalParameter, table >::name (table, "\"name\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::LocalParameter, table >::value_type_
  query_columns< ::UniPAX::LocalParameter, table >::value (table, "\"value\"");

  template <const char* table>
  const typename query_columns< ::UniPAX::LocalParameter, table >::unit_type_
  query_columns< ::UniPAX::LocalParameter, table >::unit (table, "\"unit\"", 512);

  struct access::object_traits< ::UniPAX::LocalParameter >::query_type:
    query_base_type,
    query_columns< ::UniPAX::LocalParameter, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/LocalParameter-odb.ixx>
