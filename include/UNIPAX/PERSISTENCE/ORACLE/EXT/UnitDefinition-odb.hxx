...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::UnitDefinition, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::UnitDefinition, table >::id_type_
  pointer_query_columns< ::UniPAX::UnitDefinition, table >::id (table, "\"id\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::UnitDefinition, table >::name_type_
  pointer_query_columns< ::UniPAX::UnitDefinition, table >::name (table, "\"name\"", 512);
  ...
  class access::object_traits< ::UniPAX::UnitDefinition >
  {
    ...
    struct unit_traits
    {
      ...
      typedef oracle::container_statements< unit_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::UnitDefinition, table >: query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::UnitDefinition, table >::id_type_
  query_columns< ::UniPAX::UnitDefinition, table >::id (table, "\"id\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::UnitDefinition, table >::name_type_
  query_columns< ::UniPAX::UnitDefinition, table >::name (table, "\"name\"", 512);

  struct access::object_traits< ::UniPAX::UnitDefinition >::query_type:
    query_base_type,
    query_columns< ::UniPAX::UnitDefinition, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/UnitDefinition-odb.ixx>
