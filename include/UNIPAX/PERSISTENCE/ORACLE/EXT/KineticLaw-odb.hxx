...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::KineticLaw, table >: pointer_query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
    ...
    static const id_conversion_type_ id_conversion;
  };

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::KineticLaw, table >::id_conversion_type_
  pointer_query_columns< ::UniPAX::KineticLaw, table >::id_conversion (table, "\"id_conversion\"", 20);
  ...
  class access::object_traits< ::UniPAX::KineticLaw >
  {
    ...
    struct image_type: object_traits< ::UniPAX::SBase >::image_type
    {
      // id_conversion
      //
      char id_conversion_value[12];
      ub2 id_conversion_size;
      sb2 id_conversion_indicator;
    ...
    struct localParameter_traits
    {
      ...
      typedef oracle::container_statements< localParameter_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::KineticLaw, table >: query_columns< ::UniPAX::SBase, table >
  {
    // SBase
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::KineticLaw, table >::id_conversion_type_
  query_columns< ::UniPAX::KineticLaw, table >::id_conversion (table, "\"id_conversion\"", 20);

  struct access::object_traits< ::UniPAX::KineticLaw >::query_type:
    query_base_type,
    query_columns< ::UniPAX::KineticLaw, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/EXT/KineticLaw-odb.ixx>
