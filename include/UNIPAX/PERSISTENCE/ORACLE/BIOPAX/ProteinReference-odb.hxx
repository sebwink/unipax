...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::ProteinReference, table >: pointer_query_columns< ::UniPAX::EntityReference, table >
  {
    // EntityReference
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::ProteinReference, table >::sequence_type_
  pointer_query_columns< ::UniPAX::ProteinReference, table >::sequence (table, "\"sequence\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::ProteinReference, table >::organism_type_
  pointer_query_columns< ::UniPAX::ProteinReference, table >::organism (table, "\"organism\"", 20);
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::ProteinReference >
  {
    // organism
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::ProteinReference, table >:
    query_columns_base< ::UniPAX::ProteinReference >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::ProteinReference, table >::sequence_type_
  query_columns< ::UniPAX::ProteinReference, table >::sequence (table, "\"sequence\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::ProteinReference, table >::organism_type_
  query_columns< ::UniPAX::ProteinReference, table >::organism (table, "\"organism\"", 20);

  struct access::object_traits< ::UniPAX::ProteinReference >::query_type:
    query_base_type,
    query_columns< ::UniPAX::ProteinReference, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/ProteinReference-odb.ixx>
