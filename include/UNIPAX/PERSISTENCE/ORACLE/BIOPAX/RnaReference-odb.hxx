...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::RnaReference, table >: pointer_query_columns< ::UniPAX::EntityReference, table >
  {
    // EntityReference
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::RnaReference, table >::sequence_type_
  pointer_query_columns< ::UniPAX::RnaReference, table >::sequence (table, "\"sequence\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::RnaReference, table >::id_subRegion_type_
  pointer_query_columns< ::UniPAX::RnaReference, table >::id_subRegion (table, "\"id_subRegion\"", 20);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::RnaReference, table >::organism_type_
  pointer_query_columns< ::UniPAX::RnaReference, table >::organism (table, "\"organism\"", 20);
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::RnaReference >
  {
    // organism
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::RnaReference, table >:
    query_columns_base< ::UniPAX::RnaReference >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::RnaReference, table >::sequence_type_
  query_columns< ::UniPAX::RnaReference, table >::sequence (table, "\"sequence\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::RnaReference, table >::id_subRegion_type_
  query_columns< ::UniPAX::RnaReference, table >::id_subRegion (table, "\"id_subRegion\"", 20);

  template <const char* table>
  const typename query_columns< ::UniPAX::RnaReference, table >::organism_type_
  query_columns< ::UniPAX::RnaReference, table >::organism (table, "\"organism\"", 20);

  struct access::object_traits< ::UniPAX::RnaReference >::query_type:
    query_base_type,
    query_columns< ::UniPAX::RnaReference, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/RnaReference-odb.ixx>
