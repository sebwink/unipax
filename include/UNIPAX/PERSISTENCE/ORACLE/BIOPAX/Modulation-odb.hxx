...
#ifndef MODULATION_ODB_HXX
#define MODULATION_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Modulation >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Modulation, table >: pointer_query_columns< ::UniPAX::Control, table >
  {
    // Control
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::Modulation >
  {
    public:
    typedef ::UniPAX::Modulation object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Modulation > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Modulation, table >: query_columns< ::UniPAX::Control, table >
  {
    // Control
    //
  ...
  struct access::object_traits< ::UniPAX::Modulation >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Modulation, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Modulation-odb.ixx>
