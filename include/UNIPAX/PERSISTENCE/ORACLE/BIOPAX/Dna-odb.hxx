...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Dna >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Dna, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::Dna >
  {
    public:
    typedef ::UniPAX::Dna object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Dna > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Dna, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::Dna >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Dna, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Dna-odb.ixx>
