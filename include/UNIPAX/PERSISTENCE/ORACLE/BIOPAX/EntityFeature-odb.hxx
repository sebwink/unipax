...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::EntityFeature, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  class access::object_traits< ::UniPAX::EntityFeature >
  {
    ...
    // id_memberFeature
    //
    struct id_memberFeature_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< id_memberFeature_traits > statements_type;
    ...
    // id_featureLocation
    //
    struct id_featureLocation_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< id_featureLocation_traits > statements_type;
    ...
    struct featureLocationType_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< featureLocationType_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::EntityFeature, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  struct access::object_traits< ::UniPAX::EntityFeature >::query_type:
    query_base_type,
    query_columns< ::UniPAX::EntityFeature, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/EntityFeature-odb.ixx>
