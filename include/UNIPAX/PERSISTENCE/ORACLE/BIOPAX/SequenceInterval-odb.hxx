...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::SequenceInterval, table >: pointer_query_columns< ::UniPAX::SequenceLocation, table >
  {
    // SequenceLocation
    //
    typedef pointer_query_columns< ::UniPAX::SequenceLocation, table > SequenceLocation;
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalBegin_type_
  pointer_query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalBegin (table, "\"sequenceIntervalBegin\"", 20);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalEnd_type_
  pointer_query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalEnd (table, "\"sequenceIntervalEnd\"", 20);
  ...
  class access::object_traits< ::UniPAX::SequenceInterval >
  {
    ...
    struct image_type: object_traits< ::UniPAX::SequenceLocation >::image_type
    {
      // sequenceIntervalBegin
      //
      char sequenceIntervalBegin_value[12];
      ub2 sequenceIntervalBegin_size;
      sb2 sequenceIntervalBegin_indicator;

      // sequenceIntervalEnd
      //
      char sequenceIntervalEnd_value[12];
      ub2 sequenceIntervalEnd_size;
      sb2 sequenceIntervalEnd_indicator;
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::SequenceInterval >
  {
    // sequenceIntervalBegin
    //
    static const char sequenceIntervalBegin_alias_[];

    // sequenceIntervalEnd
    //
    static const char sequenceIntervalEnd_alias_[];
  };

  template <const char* table>
  struct query_columns< ::UniPAX::SequenceInterval, table >:
    query_columns_base< ::UniPAX::SequenceInterval >,
    query_columns< ::UniPAX::SequenceLocation, table >
  {
    // SequenceLocation
    //
    typedef query_columns< ::UniPAX::SequenceLocation, table > SequenceLocation;
    ...
    {
      sequenceIntervalBegin_type_ (const char* t,
                                   const char* c,
                                   unsigned short p = 0xFFF,
                                   short s = 0xFFF)
        : sequenceIntervalBegin_column_type_ (t, c, p, s)
      {
      }
    };
    ...
    {
      sequenceIntervalEnd_type_ (const char* t,
                                 const char* c,
                                 unsigned short p = 0xFFF,
                                 short s = 0xFFF)
        : sequenceIntervalEnd_column_type_ (t, c, p, s)
      {
      }
    };
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalBegin_type_
  query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalBegin (table, "\"sequenceIntervalBegin\"", 20);

  template <const char* table>
  const typename query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalEnd_type_
  query_columns< ::UniPAX::SequenceInterval, table >::sequenceIntervalEnd (table, "\"sequenceIntervalEnd\"", 20);

  struct access::object_traits< ::UniPAX::SequenceInterval >::query_type:
    query_base_type,
    query_columns< ::UniPAX::SequenceInterval, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/SequenceInterval-odb.ixx>
