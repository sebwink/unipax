...
#ifndef PROTEIN_ODB_HXX
#define PROTEIN_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Protein >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Protein, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::Protein >
  {
    public:
    typedef ::UniPAX::Protein object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Protein > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Protein, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::Protein >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Protein, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Protein-odb.ixx>
