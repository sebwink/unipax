...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::PathwayStep, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  class access::object_traits< ::UniPAX::PathwayStep >
  {
    ...
    struct id_stepProcess_traits
    {
      ...
      typedef oracle::container_statements< id_stepProcess_traits > statements_type;
    ...
    struct id_nextStep_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< id_nextStep_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::PathwayStep, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  struct access::object_traits< ::UniPAX::PathwayStep >::query_type:
    query_base_type,
    query_columns< ::UniPAX::PathwayStep, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/PathwayStep-odb.ixx>
