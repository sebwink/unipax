...
#ifndef COMPLEX_ODB_HXX
#define COMPLEX_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Complex >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Complex, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::Complex >
  {
    public:
    typedef ::UniPAX::Complex object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Complex > pointer_type;
    ...
    struct id_component_traits
    {
      ...
      typedef oracle::container_statements< id_component_traits > statements_type;
    ...
    //
    struct componentStoichiometry_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< componentStoichiometry_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Complex, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::Complex >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Complex, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Complex-odb.ixx>
