...
#ifndef CONTROL_ODB_HXX
#define CONTROL_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Control >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Control, table >: pointer_query_columns< ::UniPAX::Interaction, table >
  {
    // Interaction
    //
    ...
    static const controlType_type_ controlType;
    ...
    static const id_controlled_type_ id_controlled;
  };

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Control, table >::controlType_type_
  pointer_query_columns< ::UniPAX::Control, table >::controlType (table, "\"controlType\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Control, table >::id_controlled_type_
  pointer_query_columns< ::UniPAX::Control, table >::id_controlled (table, "\"id_controlled\"", 20);

  template <>
  class access::object_traits< ::UniPAX::Control >
  {
    public:
    typedef ::UniPAX::Control object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Control > pointer_type;
    ...
    struct image_type: object_traits< ::UniPAX::Interaction >::image_type
    {
      // controlType
      //
      char controlType_value[512];
      ub2 controlType_size;
      sb2 controlType_indicator;

      // id_controlled
      //
      char id_controlled_value[12];
      ub2 id_controlled_size;
      sb2 id_controlled_indicator;
    ...
    struct id_controller_traits
    {
      ...
      typedef oracle::container_statements< id_controller_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Control, table >: query_columns< ::UniPAX::Interaction, table >
  {
    // Interaction
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Control, table >::controlType_type_
  query_columns< ::UniPAX::Control, table >::controlType (table, "\"controlType\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::Control, table >::id_controlled_type_
  query_columns< ::UniPAX::Control, table >::id_controlled (table, "\"id_controlled\"", 20);

  struct access::object_traits< ::UniPAX::Control >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Control, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Control-odb.ixx>
