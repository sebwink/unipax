...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::ExperimentalForm, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  class access::object_traits< ::UniPAX::ExperimentalForm >
  {
    ...
    //
    struct id_experimentalFormEntity_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef oracle::container_statements< id_experimentalFormEntity_traits > statements_type;
    ...
    //
    struct id_experimentalFeature_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< id_experimentalFeature_traits > statements_type;
    ...
    struct experimentalFormDescription_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< experimentalFormDescription_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::ExperimentalForm, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  struct access::object_traits< ::UniPAX::ExperimentalForm >::query_type:
    query_base_type,
    query_columns< ::UniPAX::ExperimentalForm, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/ExperimentalForm-odb.ixx>
