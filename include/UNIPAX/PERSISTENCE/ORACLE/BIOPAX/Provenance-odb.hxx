...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Provenance, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Provenance, table >::standardName_type_
  pointer_query_columns< ::UniPAX::Provenance, table >::standardName (table, "\"standardName\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Provenance, table >::displayName_type_
  pointer_query_columns< ::UniPAX::Provenance, table >::displayName (table, "\"displayName\"", 512);
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Provenance, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Provenance, table >::standardName_type_
  query_columns< ::UniPAX::Provenance, table >::standardName (table, "\"standardName\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::Provenance, table >::displayName_type_
  query_columns< ::UniPAX::Provenance, table >::displayName (table, "\"displayName\"", 512);

  struct access::object_traits< ::UniPAX::Provenance >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Provenance, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Provenance-odb.ixx>
