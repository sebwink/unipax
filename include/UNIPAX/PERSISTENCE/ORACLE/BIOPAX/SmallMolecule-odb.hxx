...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::SmallMolecule, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::SmallMolecule, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::SmallMolecule >::query_type:
    query_base_type,
    query_columns< ::UniPAX::SmallMolecule, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/SmallMolecule-odb.ixx>
