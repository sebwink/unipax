...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Gene, table >: pointer_query_columns< ::UniPAX::Entity, table >
  {
    // Entity
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Gene, table >::organism_type_
  pointer_query_columns< ::UniPAX::Gene, table >::organism (table, "\"organism\"", 20);
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::Gene >
  {
    // organism
    //
  ...
  template <const char* table>
  struct query_columns< ::UniPAX::Gene, table >:
    query_columns_base< ::UniPAX::Gene >,
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Gene, table >::organism_type_
  query_columns< ::UniPAX::Gene, table >::organism (table, "\"organism\"", 20);

  struct access::object_traits< ::UniPAX::Gene >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Gene, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Gene-odb.ixx>
