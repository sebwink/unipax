...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::Rna >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::Rna, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::Rna >
  {
    public:
    typedef ::UniPAX::Rna object_type;
    typedef ::boost::shared_ptr< ::UniPAX::Rna > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Rna, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::Rna >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Rna, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Rna-odb.ixx>
