...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Score, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Score, table >::scoreSource_type_
  pointer_query_columns< ::UniPAX::Score, table >::scoreSource (table, "\"scoreSource\"", 20);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::Score, table >::value_type_
  pointer_query_columns< ::UniPAX::Score, table >::value (table, "\"value\"", 512);
  ...
  class access::object_traits< ::UniPAX::Score >
  {
    ...
    struct image_type: object_traits< ::UniPAX::UtilityClass >::image_type
    {
      // scoreSource
      //
      char scoreSource_value[12];
      ub2 scoreSource_size;
      sb2 scoreSource_indicator;
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::Score >
  {
    // scoreSource
    //
    static const char scoreSource_alias_[];
  };

  template <const char* table>
  struct query_columns< ::UniPAX::Score, table >:
    query_columns_base< ::UniPAX::Score >,
    query_columns< ::UniPAX::UtilityClass, table >
  {
    ...
    {
      scoreSource_type_ (const char* t,
                         const char* c,
                         unsigned short p = 0xFFF,
                         short s = 0xFFF)
        : scoreSource_column_type_ (t, c, p, s)
      {
      }
    };
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::Score, table >::scoreSource_type_
  query_columns< ::UniPAX::Score, table >::scoreSource (table, "\"scoreSource\"", 20);

  template <const char* table>
  const typename query_columns< ::UniPAX::Score, table >::value_type_
  query_columns< ::UniPAX::Score, table >::value (table, "\"value\"", 512);

  struct access::object_traits< ::UniPAX::Score >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Score, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Score-odb.ixx>
