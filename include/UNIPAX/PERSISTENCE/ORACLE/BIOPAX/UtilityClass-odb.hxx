...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::UtilityClass, table >: pointer_query_columns< ::UniPAX::Thing, table >
  {
    // Thing
    //
  ...
  class access::object_traits< ::UniPAX::UtilityClass >
  {
    ...
    struct comment_traits
    {
      ...
      typedef oracle::container_statements< comment_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::UtilityClass, table >: query_columns< ::UniPAX::Thing, table >
  {
    // Thing
    //
  ...
  struct access::object_traits< ::UniPAX::UtilityClass >::query_type:
    query_base_type,
    query_columns< ::UniPAX::UtilityClass, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/UtilityClass-odb.ixx>
