...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::SequenceLocation, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::SequenceLocation, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  struct access::object_traits< ::UniPAX::SequenceLocation >::query_type:
    query_base_type,
    query_columns< ::UniPAX::SequenceLocation, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/SequenceLocation-odb.ixx>
