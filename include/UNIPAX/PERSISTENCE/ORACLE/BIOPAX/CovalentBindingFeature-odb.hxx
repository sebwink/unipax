...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::CovalentBindingFeature, table >: pointer_query_columns< ::UniPAX::BindingFeature, table >
  {
    // BindingFeature
    //
    typedef pointer_query_columns< ::UniPAX::BindingFeature, table > BindingFeature;
  };
  ...
  class access::object_traits< ::UniPAX::CovalentBindingFeature >
  {
    ...
    struct image_type: object_traits< ::UniPAX::BindingFeature >::image_type
    {
      std::size_t version;
    ...
    // id_bindsTo
    //
    struct id_bindsTo_traits: access::object_traits< ::UniPAX::BindingFeature >::id_bindsTo_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::CovalentBindingFeature, table >: query_columns< ::UniPAX::BindingFeature, table >
  {
    // BindingFeature
    //
    typedef query_columns< ::UniPAX::BindingFeature, table > BindingFeature;
  };

  struct access::object_traits< ::UniPAX::CovalentBindingFeature >::query_type:
    query_base_type,
    query_columns< ::UniPAX::CovalentBindingFeature, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/CovalentBindingFeature-odb.ixx>
