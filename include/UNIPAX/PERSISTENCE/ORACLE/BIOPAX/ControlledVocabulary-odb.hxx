...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::ControlledVocabulary, table >: pointer_query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::ControlledVocabulary, table >::term_type_
  pointer_query_columns< ::UniPAX::ControlledVocabulary, table >::term (table, "\"term\"", 512);
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::ControlledVocabulary, table >: query_columns< ::UniPAX::UtilityClass, table >
  {
    // UtilityClass
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::ControlledVocabulary, table >::term_type_
  query_columns< ::UniPAX::ControlledVocabulary, table >::term (table, "\"term\"", 512);

  struct access::object_traits< ::UniPAX::ControlledVocabulary >::query_type:
    query_base_type,
    query_columns< ::UniPAX::ControlledVocabulary, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/ControlledVocabulary-odb.ixx>
