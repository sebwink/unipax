...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::FragmentFeature, table >: pointer_query_columns< ::UniPAX::EntityFeature, table >
  {
    // EntityFeature
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::FragmentFeature, table >: query_columns< ::UniPAX::EntityFeature, table >
  {
    // EntityFeature
    //
  ...
  struct access::object_traits< ::UniPAX::FragmentFeature >::query_type:
    query_base_type,
    query_columns< ::UniPAX::FragmentFeature, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/FragmentFeature-odb.ixx>
