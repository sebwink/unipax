...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >: pointer_query_columns< ::UniPAX::EntityReference, table >
  {
    // EntityReference
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::chemicalFormula_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::chemicalFormula (table, "\"chemicalFormula\"", 512);

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::molecularWeight_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::molecularWeight (table, "\"molecularWeight\"");

  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::structure_type_
  pointer_query_columns< ::UniPAX::SmallMoleculeReference, table >::structure (table, "\"structure\"", 20);
  ...
  class access::object_traits< ::UniPAX::SmallMoleculeReference >
  {
    ...
    struct image_type: object_traits< ::UniPAX::EntityReference >::image_type
    {
      // chemicalFormula
      //
      char chemicalFormula_value[512];
      ub2 chemicalFormula_size;
      sb2 chemicalFormula_indicator;

      // molecularWeight
      //
      double molecularWeight_value;
      sb2 molecularWeight_indicator;

      // structure
      //
      char structure_value[12];
      ub2 structure_size;
      sb2 structure_indicator;
  ...
  //
  template <>
  struct query_columns_base< ::UniPAX::SmallMoleculeReference >
  {
    // structure
    //
    static const char structure_alias_[];
  };

  template <const char* table>
  struct query_columns< ::UniPAX::SmallMoleculeReference, table >:
    query_columns_base< ::UniPAX::SmallMoleculeReference >,
    query_columns< ::UniPAX::EntityReference, table >
  {
    ...
    {
      structure_type_ (const char* t,
                       const char* c,
                       unsigned short p = 0xFFF,
                       short s = 0xFFF)
        : structure_column_type_ (t, c, p, s)
      {
      }
    };
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, table >::chemicalFormula_type_
  query_columns< ::UniPAX::SmallMoleculeReference, table >::chemicalFormula (table, "\"chemicalFormula\"", 512);

  template <const char* table>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, table >::molecularWeight_type_
  query_columns< ::UniPAX::SmallMoleculeReference, table >::molecularWeight (table, "\"molecularWeight\"");

  template <const char* table>
  const typename query_columns< ::UniPAX::SmallMoleculeReference, table >::structure_type_
  query_columns< ::UniPAX::SmallMoleculeReference, table >::structure (table, "\"structure\"", 20);

  struct access::object_traits< ::UniPAX::SmallMoleculeReference >::query_type:
    query_base_type,
    query_columns< ::UniPAX::SmallMoleculeReference, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/SmallMoleculeReference-odb.ixx>
