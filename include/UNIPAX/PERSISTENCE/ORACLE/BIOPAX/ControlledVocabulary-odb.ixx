...
namespace odb
{
  ...
  inline
  access::object_traits< ::UniPAX::ControlledVocabulary >::id_type
  ...
  callback (database& db, object_type& x, callback_event e)
  {
    ...
    static_cast< ::UniPAX::ControlledVocabulary& > (x).init (e, db);
  }
  ...
  inline
  access::object_traits< ::UniPAX::ControlledVocabulary >::query_type::
  query_type ()
  {
  }
