...
#ifndef TRANSPORT_WITH_BIOCHEMICAL_REACTION_ODB_HXX
#define TRANSPORT_WITH_BIOCHEMICAL_REACTION_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::TransportWithBiochemicalReaction >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::TransportWithBiochemicalReaction, table >: pointer_query_columns< ::UniPAX::BiochemicalReaction, table >
  {
    // BiochemicalReaction
    //
    typedef pointer_query_columns< ::UniPAX::BiochemicalReaction, table > BiochemicalReaction;
  };

  template <>
  class access::object_traits< ::UniPAX::TransportWithBiochemicalReaction >
  {
    public:
    typedef ::UniPAX::TransportWithBiochemicalReaction object_type;
    typedef ::boost::shared_ptr< ::UniPAX::TransportWithBiochemicalReaction > pointer_type;
    ...
    struct image_type: object_traits< ::UniPAX::BiochemicalReaction >::image_type
    {
      std::size_t version;
    ...
    // deltaG
    //
    struct deltaG_traits: access::object_traits< ::UniPAX::BiochemicalReaction >::deltaG_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
    ...
    // kEQ
    //
    struct kEQ_traits: access::object_traits< ::UniPAX::BiochemicalReaction >::kEQ_traits
    {
      static const std::size_t id_column_count = 1UL;
      static const std::size_t cond_column_count = 1UL;
      static const std::size_t data_column_count = 3UL;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::TransportWithBiochemicalReaction, table >: query_columns< ::UniPAX::BiochemicalReaction, table >
  {
    // BiochemicalReaction
    //
    typedef query_columns< ::UniPAX::BiochemicalReaction, table > BiochemicalReaction;
  };

  struct access::object_traits< ::UniPAX::TransportWithBiochemicalReaction >::query_type:
    query_base_type,
    query_columns< ::UniPAX::TransportWithBiochemicalReaction, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/TransportWithBiochemicalReaction-odb.ixx>
...
#endif // TRANSPORT_WITH_BIOCHEMICAL_REACTION_ODB_HXX
