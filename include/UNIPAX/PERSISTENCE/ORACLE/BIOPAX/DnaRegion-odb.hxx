...
#ifndef DNA_REGION_ODB_HXX
#define DNA_REGION_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UniPAX::DnaRegion >
  {
    static const class_kind kind = class_object;
  };

  template <const char* table>
  struct pointer_query_columns< ::UniPAX::DnaRegion, table >: pointer_query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  template <>
  class access::object_traits< ::UniPAX::DnaRegion >
  {
    public:
    typedef ::UniPAX::DnaRegion object_type;
    typedef ::boost::shared_ptr< ::UniPAX::DnaRegion > pointer_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::DnaRegion, table >: query_columns< ::UniPAX::PhysicalEntity, table >
  {
    // PhysicalEntity
    //
  ...
  struct access::object_traits< ::UniPAX::DnaRegion >::query_type:
    query_base_type,
    query_columns< ::UniPAX::DnaRegion, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/DnaRegion-odb.ixx>
