...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::TissueVocabulary, table >: pointer_query_columns< ::UniPAX::ControlledVocabulary, table >
  {
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::TissueVocabulary, table >: query_columns< ::UniPAX::ControlledVocabulary, table >
  {
    // ControlledVocabulary
    //
  ...
  struct access::object_traits< ::UniPAX::TissueVocabulary >::query_type:
    query_base_type,
    query_columns< ::UniPAX::TissueVocabulary, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/TissueVocabulary-odb.ixx>
