...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Interaction, table >: pointer_query_columns< ::UniPAX::Entity, table >
  {
    // Entity
    //
  ...
  class access::object_traits< ::UniPAX::Interaction >
  {
    ...
    struct id_participant_traits
    {
      ...
      typedef oracle::container_statements< id_participant_traits > statements_type;
    ...
    struct interactionType_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef oracle::container_statements< interactionType_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Interaction, table >: query_columns< ::UniPAX::Entity, table >
  {
    // Entity
    //
  ...
  struct access::object_traits< ::UniPAX::Interaction >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Interaction, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Interaction-odb.ixx>
