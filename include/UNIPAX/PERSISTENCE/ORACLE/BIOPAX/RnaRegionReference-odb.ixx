...
namespace odb
{
  ...
  inline
  access::object_traits< ::UniPAX::RnaRegionReference >::id_type
  ...
  callback (database& db, object_type& x, callback_event e)
  {
    ...
    static_cast< ::UniPAX::RnaRegionReference& > (x).init (e, db);
  }
  ...
  inline
  access::object_traits< ::UniPAX::RnaRegionReference >::query_type::
  query_type ()
  {
  }
