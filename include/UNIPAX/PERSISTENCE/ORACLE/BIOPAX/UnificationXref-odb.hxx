...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::UnificationXref, table >: pointer_query_columns< ::UniPAX::Xref, table >
  {
    // Xref
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::UnificationXref, table >: query_columns< ::UniPAX::Xref, table >
  {
    // Xref
    //
  ...
  struct access::object_traits< ::UniPAX::UnificationXref >::query_type:
    query_base_type,
    query_columns< ::UniPAX::UnificationXref, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/UnificationXref-odb.ixx>
