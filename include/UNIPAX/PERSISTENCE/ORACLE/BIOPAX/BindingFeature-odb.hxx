...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::BindingFeature, table >: pointer_query_columns< ::UniPAX::EntityFeature, table >
  {
    // EntityFeature
    //
  ...
  template <const char* table>
  const typename pointer_query_columns< ::UniPAX::BindingFeature, table >::intraMolecular_type_
  pointer_query_columns< ::UniPAX::BindingFeature, table >::intraMolecular (table, "\"intraMolecular\"", 1);
  ...
  class access::object_traits< ::UniPAX::BindingFeature >
  {
    ...
    struct image_type: object_traits< ::UniPAX::EntityFeature >::image_type
    {
      // intraMolecular
      //
      unsigned int intraMolecular_value;
      sb2 intraMolecular_indicator;
    ...
    struct id_bindsTo_traits
    {
      ...
      typedef oracle::container_statements< id_bindsTo_traits > statements_type;
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::BindingFeature, table >: query_columns< ::UniPAX::EntityFeature, table >
  {
    // EntityFeature
    //
  ...
  template <const char* table>
  const typename query_columns< ::UniPAX::BindingFeature, table >::intraMolecular_type_
  query_columns< ::UniPAX::BindingFeature, table >::intraMolecular (table, "\"intraMolecular\"", 1);

  struct access::object_traits< ::UniPAX::BindingFeature >::query_type:
    query_base_type,
    query_columns< ::UniPAX::BindingFeature, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/BindingFeature-odb.ixx>
