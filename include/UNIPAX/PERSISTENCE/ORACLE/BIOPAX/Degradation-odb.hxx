...
namespace odb
{
  ...
  struct pointer_query_columns< ::UniPAX::Degradation, table >: pointer_query_columns< ::UniPAX::Conversion, table >
  {
    // Conversion
    //
  ...
  //
  template <const char* table>
  struct query_columns< ::UniPAX::Degradation, table >: query_columns< ::UniPAX::Conversion, table >
  {
    // Conversion
    //
  ...
  struct access::object_traits< ::UniPAX::Degradation >::query_type:
    query_base_type,
    query_columns< ::UniPAX::Degradation, table_name >
  {
    query_type ();
    query_type (bool);
...
#include <UNIPAX/PERSISTENCE/ORACLE/BIOPAX/Degradation-odb.ixx>
