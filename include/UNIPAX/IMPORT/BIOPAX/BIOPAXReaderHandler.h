...
#ifndef UNIPAX_IMPORT_BIOPAX_BIOPAXREADERHANDLER_H
#define UNIPAX_IMPORT_BIOPAX_BIOPAXREADERHANDLER_H
...
namespace UniPAX
{
  ...
  /** \brief Handler class for the BioPAX level 3 format.
      ...
      \ingroup Importer
  */
	class UNIPAX_EXPORT BIOPAXReaderHandler : public QXmlDefaultHandler {
	...
	public:
		...
		BIOPAXReaderHandler(const BIOPAXReaderHandler & arg);

		BIOPAXReaderHandler & operator =(const BIOPAXReaderHandler & arg);
		//@}
